...
var xmlMatcher = {
  toBeEquivalentXml: function(util, customEqualityTesters) {
    return {
      compare: function(doc1, doc2) {
...
describe("Health Care Form", function() {
  beforeEach(function(done){
    ...
    fixtureFrame.onload = done;
    document.body.appendChild(fixtureFrame);
    jasmine.addMatchers(xmlMatcher);
  });

  afterEach(function(){
//    document.getElementById("fixture-frame").remove();
  });
  ...
  it("Builds a valid XML doc that reflects the form inputs.", function(done) {
    ...
    $.get('/base/spec/fixtures/javascripts/health-care/anonymous-submission.xml')
      .done(function(data) {
        ...
        expect(data).toBeEquivalentXml(xmlDoc);
      }).fail(function() {
