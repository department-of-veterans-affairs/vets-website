...
export const ConsentLabel = (
  <span>I understand the above information and agree to join.</span>
);
export const ConsentError = (
  <span>You must accept the concent policy before continuing</span>
);
export const ConsentNotice = (
  <span>
    ...
    <p>
      ...
      you understand important information about joining this list. Please read
      below and then check the box to confirm you understand and agree to join.
    </p>{' '}
    <ul>
      <li>
      ...
      <li>
        Voluntary participation: It’s always your choice to answer any questions
        we may ask or to join a study. You can also leave a study at any time.
        Your decision to join or not join a study won’t affect your VA health
        care or any of your VA benefits or services in any way.
      </li>{' '}
      <li>
