...
import { useBreadcrumbFocus } from '@department-of-veterans-affairs/mhv/exports';
...
const SmBreadcrumbs = () => {
  ...
  const getComposeFlowMap = useCallback(() => {
    ...
    const map = {
      ...
      [Constants.Paths
        .CARE_TEAM_HELP]: `${Constants.Paths.COMPOSE}${Constants.Paths.SELECT_CARE_TEAM}`,
      // Start message goes back to select care team
      [`${Constants.Paths.COMPOSE}${Constants.Paths.START_MESSAGE}`]: `${Constants.Paths.COMPOSE}${Constants.Paths.SELECT_CARE_TEAM}`,
    };
