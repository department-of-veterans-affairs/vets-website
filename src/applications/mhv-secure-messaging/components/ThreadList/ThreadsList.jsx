  ...
  return (
    <>
      ...
      <div className="thread-list vads-l-row vads-u-flex-direction--column">
        ...
        {threadList?.length > 0 && (
          <div className="xsmall-screen:vads-l-grid-container mobile:vads-u-max-width--10">
            <div className="xsmall-screen:vads-l-row mobile:vads-u-max-width--10">
              <div className="xsmall-screen:vads-u-margin-left--neg2 xsmall-screen:vads-l-col--12 xsmall-screen:vads-u-padding-left--0 mobile:vads-u-max-width--10">
                <VaPagination
