...
export const Locators = {
  ...
  BUTTONS: {
    ...
    CREATE_NEW_FOLDER_DATA_TEST_ID: 'create-new-folder',
    DELETE_DRAFT: '[data-testid="delete-draft-button"]',
    EDIT_FOLDER: '[data-testid="edit-folder-button"]',
    EDIT_FOLDER_DATA_TEST_ID: 'edit-folder-button',
    DELETE_FOLDER: '[data-testid="remove-folder-button"]',
    DELETE_FOLDER_DATA_TEST_ID: 'remove-folder-button',
    ...
    CREATE_FOLDER_DATA_TEST_ID: 'create-folder-button',
  ...
  ALERTS: {
    ...
    CREATE_NEW_MESSAGE: '[data-testid="compose-message-link"]',
    CREATE_NEW_FOLDER: '[data-testid="create-new-folder"]',
    CREATE_FOLDER_SUCCESS_DATA_TEST_ID: 'create-folder-success-alert',
  ...
  FIELDS: {
    ...
    FOLDER_NAME_DATA_TEST_ID: 'folder-name',
  },
  INFO: {
