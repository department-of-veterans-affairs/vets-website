    ...
    return (
      <div>
        ...
        <div className="confirmation-guidance-container">
          ...
          <p>
            If you’re eligible for vocational counseling benefits, we’ll invite
            you to meet with a Vocational Rehabilitation Counselor (VRC). Your
            VRC will work with you to map out a career path.
          </p>
        </div>
        <p>Please print this page for your records.</p>
        <div className="inset">
          <h4 className="confirmation-page-inset-title">
            Vocational Counseling Claim{' '}
        ...
        <div className="confirmation-guidance-container">
          ...
          <p className="confirmation-guidance-message">
            ...
            <a href="tel:800-827-1000">800-827-1000</a>, Monday &#8211; Friday,
            8:00 a.m. &#8211; 9:00 p.m. ET. Please have your Social Security
            number or VA file number ready. For Telecommunication Relay
