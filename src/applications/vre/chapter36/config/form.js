...
const previousBenefitApplicationsUI = {
  'ui:title':
    'Have you ever applied for any of the following VA benefits? (Check all that apply.)',
  'ui:options': {
    showFieldLabel: true,
  },
  chapter31: {
...
const formConfig = {
  ...
  savedFormMessages: {
    ...
    noAuth:
      'Please sign in again to resume your application for vocational counseling.',
  },
      ...
      pages: {
        ...
        dependentInformation: {
          ...
          uiSchema: {
            ...
            seekingRestorativeTraining: {
              'ui:title':
                'Are you a child who is at least 14 years old, a spouse, or a surviving spouse with a disability and looking for special restorative training?',
              'ui:widget': 'yesNo',
            },
            seekingVocationalTraining: {
              'ui:title':
                'Are you a child, a spouse, or a surviving spouse with a disability and looking for special vocational training',
              'ui:widget': 'yesNo',
            },
            receivedPamphlet: {
              'ui:title':
                'Have you received a pamphlet explaining survivors’ and dependents’ educational assistance benefits?',
              'ui:widget': 'yesNo',
            },
          },
          schema: {
        ...
        veteranInformation: createVeteranInfoPage(fullSchema36, {
          uiSchema: {
            veteranDateOfDeathMIAPOW: _.merge(
              currentOrPastDateUI(
                'Date of Veteran’s death or date listed as missing in action or POW',
              ),
              {
                'ui:options': {
                  hideIf: isVeteran,
        ...
        additionalInformation: {
          ...
          uiSchema: {
            ...
            divorceOrAnnulmentPending: {
              'ui:title':
                'If you are the spouse of a disabled Veteran is a divorce or annulment pending?',
              'ui:widget': 'yesNo',
              'ui:options': {
                hideIf: ({ applicantRelationshipToVeteran }) =>
          ...
          schema: {
            ...
            properties: {
              ...
              previousBenefitApplications,
              previousVeteranBenefitsFullName: _.unset('required', fullName),
        ...
        militaryHistory: {
          ...
          uiSchema: {
            'view:hasMilitaryHistory': {
              'ui:title':
                'Have you served on active duty in the Armed Forces? (This can include active duty for training for 3 months or more, or subsequent periods of active duty for training of 6 months or more.)',
              'ui:widget': 'yesNo',
            },
    ...
    contactInformation: {
      ...
      pages: {
        applicantAddress: {
          ...
          uiSchema: {
            applicantAddress: address.uiSchema(
              'Please provide a mailing address where we could reach you in the next 30 to 60 days.',
            ),
          },
          schema: {
            type: 'object',
