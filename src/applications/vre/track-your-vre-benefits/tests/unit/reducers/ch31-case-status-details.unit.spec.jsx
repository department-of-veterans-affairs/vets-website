...
describe('ch31CaseStatusDetails reducer', () => {
  ...
  it('handles CH31_CASE_STATUS_DETAILS_FETCH_STARTED', () => {
  ...
  it('handles CH31_CASE_STATUS_DETAILS_FETCH_SUCCEEDED', () => {
    const payload = {
      id: '',
      type: 'ch31_case_details',
      attributes: { res_case_id: 123456 },
    };
    const prev = {
      ...initialState,
      loading: true,
  ...
  it('handles CH31_CASE_STATUS_DETAILS_FETCH_FAILED', () => {
