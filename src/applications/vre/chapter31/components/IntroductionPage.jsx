  ...
  render() {
    return (
      <div className="schemaform-intro">
        ...
        <p>
          Equal to VA Form 28-1900 (Disabled Veterans Application for Vocational
          Rehabilitation).
        </p>
        <SaveInProgressIntro
        ...
        <div className="process schemaform-process schemaform-process-sip">
          <h4>
            Follow the steps below to apply for vocational rehabilitiation
            benefits.
          </h4>
          <ol>
            <li className="process-step list-one">
              ...
              <p>
                <strong>
                  What if I don’t yet have a service connected disability
                  rating?
                </strong>
                <br />
