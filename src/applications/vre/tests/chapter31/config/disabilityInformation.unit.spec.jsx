...
describe('VRE chapter 31 disability information', () => {
  const {
    schema,
    uiSchema,
  } = formConfig.chapters.disabilityInformation.pages.disabilityInformation;
  ...
  it('should fill in hospital information', () => {
    ...
    fillData(
      form,
      'input[id="root_view:hospital_hospitalName"]',
      'Local hospital',
    );
    fillData(
      form,
      'input[id="root_view:hospital_hospitalAddress_street"]',
      'Hospital Street',
    );
    fillData(
      form,
      'input[id="root_view:hospital_hospitalAddress_city"]',
      'Hospital City',
    );
    fillData(
      form,
      'select[id="root_view:hospital_hospitalAddress_state"]',
      'NY',
    );
    fillData(
      form,
      'input[id="root_view:hospital_hospitalAddress_postalCode"]',
      '23423',
    );
