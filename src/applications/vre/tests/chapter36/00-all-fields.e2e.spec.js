...
const runTest = E2eHelpers.createE2eTest(client => {
  ...
  client.waitForElementPresent(
    'input[name="root_view:isVeteran"]',
    Timeouts.normal,
  );
  ...
  client.waitForElementPresent(
    'input[name="root_divorceOrAnnulmentPending"]',
    Timeouts.normal,
  );
  client.assert.cssClassPresent(
  ...
  client.waitForElementPresent(
    'input[name="root_view:hasMilitaryHistory"]',
    Timeouts.normal,
  );
  client.assert.cssClassPresent(
  ...
  client.waitForElementPresent(
    'select[name="root_applicantAddress_country"]',
    Timeouts.normal,
  );
  client.assert.cssClassPresent(
