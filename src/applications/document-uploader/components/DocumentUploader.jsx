    ...
    return (
      <div className="document-uploader">
        ...
        <div className="va-introtext">
          <p>
            {' '}
            You can send a document using our new <b>Digital Mail</b> feature.
            It's the same as faxing or mailing a document to the VA, just{' '}
            <i>easier</i> and <i>faster</i>.{' '}
          </p>
        </div>
        <hr />
        <h2>Digital Mail</h2>
        ...
        {this.props.veteran.regarding && (
          <div>
            ...
            />
            <DocumentUploaderMetadata {...this.props} />
          </div>
        )}
      </div>
    );
