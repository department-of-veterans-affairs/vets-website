...
import backgroundInformationDetails from '../helpers/backgroundInformationDetails';
...
export default {
  ...
  pages: {
    ...
    convictionDetails: backgroundInformationDetails({
    ...
    courtMartialDetails: backgroundInformationDetails({
    ...
    underChargesDetails: backgroundInformationDetails({
    ...
    resignedFromEducationDetails: backgroundInformationDetails({
    ...
    withdrawnFromEducationDetails: backgroundInformationDetails({
    ...
    disciplinedForDishonestyDetails: backgroundInformationDetails({
    ...
    resignedForDishonestyDetails: backgroundInformationDetails({
    ...
    repForAgencyDetails: backgroundInformationDetails({
    ...
    reprimandedInAgencyDetails: backgroundInformationDetails({
    ...
    resignedFromAgencyDetails: backgroundInformationDetails({
    ...
    appliedForVaAccreditationDetails: backgroundInformationDetails({
    ...
    terminatedByVSOrgDetails: backgroundInformationDetails({
    ...
    conditionThatAffectsRepresentationDetails: backgroundInformationDetails({
    ...
    conditionThatAffectsExaminationDetails: backgroundInformationDetails({
