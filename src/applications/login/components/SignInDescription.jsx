...
export default function SignInDescription({ loginGovEnabled }) {
  const loginGovText = loginGovEnabled && `Login.gov`;
  return (
    <div className="usa-width-one-half columns small-12">
      <div className="explanation-content vads-u-padding-x--1 medium-screen:vads-u-padding--0">
        ...
        <p>
          ...
          you wanted most &mdash; one easy-to-use place to:
        </p>
        <ul>
