// To Do: Refactor src/platform/utilities/real-user-monitoring.jsx to be reusable
...
// CONSTANTS
const APP_UUID = '88a7f64b-7f8c-4e26-bef8-55954cab8973';
const APP_DASHBOARD_NAME = 'benefits-burial';
const TOKEN_ID = 'pub2261e01d7a3f40a23796d0b4c256c5bd';
const VERSION = '1.0.0';
...
/**
 * Get conditional sample rate based on whether the user agent is a bot
 * @returns {number} 0 if bot detected, 100 if not
 */
const getConditionalSampleRate = () => {
  if (typeof navigator === 'undefined' || !navigator.userAgent) {
    return 100; // Default to full sampling if navigator is not available
  }
  return botRegex.test(navigator.userAgent) ? 0 : 100;
};
...
const initializeRealUserMonitoring = () => {
  ...
  if (isProductionEnv()) {
    datadogRum.init({
      ...
      sessionSampleRate: getConditionalSampleRate(),
