        ...
        >
          <div className="rs-form-radio-buttons vads-u-display--flex vads-u-flex-direction--column medium-screen:vads-u-display--block">
            <VaRadio
              ...
              uswds
            >
              <div className="medium-screen:vads-u-display--inline-block small-screen:vads-u-display--block vads-u-margin-right--2 desktop:vads-u-margin-top--1 medium-screen:vads-u-margin-top--0">
                <va-radio-option
                  onChange={event => {
          ...
          <p className="desktop:vads-u-margin-top--2 medium-screen:vads-u-margin-top--1 vads-u-margin-bottom--0p5">
