...
import {
  ...
  openModal,
} from 'platform/user/profile/vap-svc/actions/index';
import recordEvent from 'platform/monitoring/record-event';
import { isVAPatient } from 'platform/user/selectors';
import {
  focusElement,
  waitForRenderThenFocus,
} from 'platform/utilities/ui/index';
import prefixUtilityClasses from 'platform/utilities/prefix-utility-classes';

// local level imports

import * as VAP_SERVICE from 'platform/user/profile/vap-svc/constants/index';
import {
  ACTIVE_EDIT_VIEWS,
  FIELD_NAMES,
} from 'platform/user/profile/vap-svc/constants/index';
...
import CannotEditModal from 'platform/user/profile/vap-svc/components/ContactInformationFieldInfo/CannotEditModal';
import ConfirmCancelModal from 'platform/user/profile/vap-svc/components/ContactInformationFieldInfo/ConfirmCancelModal';
import ConfirmRemoveModal from 'platform/user/profile/vap-svc/components/ContactInformationFieldInfo/ConfirmRemoveModal';
...
import getProfileInfoFieldAttributes from '../utils/getProfileInfoFieldAttributes';
import { getInitialFormValues } from '../utils/formValues';
