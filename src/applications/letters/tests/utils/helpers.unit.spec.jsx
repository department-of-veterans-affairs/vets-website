...
describe('Letters helpers: ', () => {
  describe('getBenefitOptionText', () => {
    ...
    test('should be defined for both veterans and dependents', () => {
      _.forEach(option => {
    ...
    test('should only be defined for veterans', () => {
      _.forEach(option => {
        expect(getBenefitOptionText(option, true, true)).not.to.be.undefined;
    ...
    test('should only be defined for dependents', () => {
      _.forEach(option => {
    ...
    test('should only be defined for veterans if value is true', () => {
      _.forEach(option => {
        expect(getBenefitOptionText(option, true, true)).not.to.be.undefined;
    ...
    test('should only be defined for dependents if value is true', () => {
      _.forEach(option => {
        expect(getBenefitOptionText(option, true, false)).not.to.be.undefined;
    ...
    test('should be defined whether value is true or false', () => {
    ...
    test('should only be defined if value is valid', () => {
      _.forEach(option => {
    ...
    test(
      'should include the awardEffectiveDate in the text for monthlyAward',
      () => {
  ...
  describe('inferAddressType', () => {
    test('should set the type to international if USA isn\'t selected', () => {
    ...
    test(
      'should set the type to military if a military stateCode is chosen',
      () => {
    ...
    test('should set the type to domestic if none of the above are true', () => {
      expect(inferAddressType(address).type).to.equal(ADDRESS_TYPES.domestic);
    });
  });

  describe('resetDisallowedAddressFields', () => {
    test('should clear state and zipCode for international addresses', () => {
  ...
  describe('stripEmpties', () => {
    ...
    test('should only remove all zero-length properties from an object', () => {
