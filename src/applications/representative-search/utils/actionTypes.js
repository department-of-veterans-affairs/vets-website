...
export const SEARCH_QUERY_COMMITED = 'SEARCH_QUERY_COMMITED';
...
export const REPORT_CANCELLED = 'REPORT_CANCELLED';
...
export const FETCH_ORGANIZATIONS_DONE = 'FETCH_ORGANIZATIONS_DONE';
