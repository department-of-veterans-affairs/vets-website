...
const runTest = E2eHelpers.createE2eTest(client => {
  ...
  client.waitForElementVisible(
    'label[for="root_application_claimant_desiredCemetery"]',
    Timeouts.normal,
  );
  client.assert.cssClassPresent(
  ...
  client.waitForElementVisible(
    'label[for="root_application_preneedAttachments"]',
    Timeouts.normal,
  );
  client.assert.cssClassPresent(
    '.progress-bar-segmented div.progress-segment:nth-child(1)',
  ...
  client.waitForElementVisible(
    'select[name="root_application_claimant_address_country"]',
    Timeouts.normal,
  );
  client.assert.cssClassPresent(
  ...
  PageHelpers.completeClaimantContactInformation(
    client,
    testData.data.application.claimant,
  );
  client.axeCheck('.main').click('.form-panel .usa-button-primary');
  ...
  client.waitForElementVisible(
    'select[name="root_application_veteran_address_country"]',
    Timeouts.normal,
  );
  client.assert.cssClassPresent(
    '.progress-bar-segmented div.progress-segment:nth-child(5)',
  ...
  PageHelpers.completeVeteranContactInformation(
    client,
    testData.data.application.veteran,
  );
  client.axeCheck('.main').click('.form-panel .usa-button-primary');
  ...
  PageHelpers.completeApplicantContactInformation(
    client,
    testData.data.application.applicant,
  );
  client.axeCheck('.main').click('.form-panel .usa-button-primary');
