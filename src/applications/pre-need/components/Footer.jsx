  ...
  <div className="row">
    {currentLocation.pathname === '/introduction' && (
      <p className="usa-width-two-thirds medium-8">
        ...
        is voluntary and not required to obtain or retain benefits to which you
        may be entitled. Send comments concerning the accuracy of this burden
        ...
        Send Send claims for, or correspondence regarding benefits to this
        address.
      </p>
    )}
