...
export default function SupportingDocumentsDescription(props) {
  ...
  if (isVeteran(props.formData)) {
    desc = (
      <p>
        To apply, you’ll need a copy of your DD214 or other separation papers.
        This will help us figure out if you qualify for burial in a VA national
        cemetery based on your military status and service history. If you don’t
        have these documents, you can still apply — and we’ll request the
        documents for you.
      </p>
    );
    ...
    desc = (
      <div>
        <p>
          To apply, you’ll need a copy of your sponsor’s DD214 or other
          separation papers. This will help us figure out if you qualify for
          burial in a VA national cemetery based on your sponsor’s military
          status and service history. If you don’t have these documents, you can
          still apply — and we’ll request the documents for you.
        </p>
    ...
    desc = (
      <p>
        To apply, you’ll need a copy of your sponsor’s DD214 or other separation
        papers. This will help us figure out if you qualify for burial in a VA
        national cemetery based on your sponsor’s military status and service
        history. If you don’t have these documents, you can still apply — and
        we’ll request the documents for you.
      </p>
    );
  }
    ...
    <div id="supporting-documents-description">
      ...
      <AdditionalInfo triggerText="What kinds of documents should I provide?">
        ...
        <p>
          ...
          supporting documents or an affidavit showing that you’re:
        </p>
        <ul>
          <li>
          ...
          <li>
            An attorney or agent acting on behalf of the applicant under a
            durable power of attorney, <strong>or</strong>
          </li>
          <li>
