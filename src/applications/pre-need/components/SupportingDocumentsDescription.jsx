    ...
    <div>
      <div>
        ...
        <va-additional-info trigger="What kinds of documents should I provide?">
          ...
          <br />
          <p>
            You'll need a copy of your {sponsorOrVet} DD214 or other separation
            papers. This will help us figure out if you qualify for burial in a
            VA national cemetery based on your {sponsorOrVet} military status
            and service history. If you don't have these documents, you can
          ...
          <p>
            ...
            written statement of facts confirmed by an oath or affirmation)
            showing that you're:
          </p>
          <ul>
            <li>
          ...
          <br />
          <p>
            You’ll need to provide supporting documents with information about
            the adult child’s disability. The Veteran or guardian of the child
            should also ask the child’s current doctor to verify the documents.
            These documents should include all of the following information:
          </p>
          <ul>
            <li>
