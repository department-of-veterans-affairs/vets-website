...
import AppointmentColumnLayout from './AppointmentColumnLayoutV2';
  ...
  return keys.map((key, i) => {
    ...
    return hashTable[key].map(appt => {
      ...
      return (
        ...
        >
          <AppointmentFlexGrid idClickable={idClickable} link={appt.link}>
            <AppointmentRow
              className={classNames(
                'mobile:vads-u-flex-direction--row',
                'mobile:vads-u-margin-x--0p5',
            ...
            >
              <AppointmentColumnLayout first data={appt} link={appt.link} />
            </AppointmentRow>
          </AppointmentFlexGrid>
        </AppointmentListItem>
      );
