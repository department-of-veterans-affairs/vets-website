...
const ConfirmedAppointmentDetailsPageStub = Sinon.stub(
  ConfirmedAppointmentDetailsPage,
  'default',
).returns(<div>Mock Page</div>);
const RequestedAppointmentDetailsPageStub = Sinon.stub(
  RequestedAppointmentDetailsPage,
  'default',
).returns(<div>Mock Page</div>);
const AppointmentsPageStub = Sinon.stub(AppointmentsPage, 'default').returns(
  <div>Mock Page</div>,
);
