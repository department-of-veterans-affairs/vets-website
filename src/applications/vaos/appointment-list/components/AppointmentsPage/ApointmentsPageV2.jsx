...
function AppointmentsPageV2({
  ...
  function onChange(e) {
    if (e.currentTarget.value === 'upcoming') {
      updateAppointmentListFilter('upcoming');
    } else if (e.currentTarget.value === 'requested') {
      updateAppointmentListFilter('requested');
      ...
      updateAppointmentListFilter('past');
    } else if (e.currentTarget.value === 'cancelled') {
      updateAppointmentListFilter('cancelled');
    }
  }
...
const mapDispatchToProps = {
  ...
  updateAppointmentListFilter: actions.updateAppointmentListFilter,
};
