...
export default function VideoLink({ appointment }) {
  const { location, url } = appointment;
  //   const { clinicPhone, clinicPhoneExtension, facilityPhone } = useSelector(
  //     state => selectConfirmedAppointmentData(state, appointment),
  //     shallowEqual,
  //   );
  const displayVideoLink = appointment.displayLink;
          ...
          <div className="vads-u-margin-y--1">
            ...
            >
              ...
              <ClinicOrFacilityPhone
                clinicPhone={location.clinicPhone}
                clinicPhoneExtension={location.clinicPhoneExtension}
                facilityPhone={location.facilityPhone}
              />
            </va-alert>
          </div>
        )}
