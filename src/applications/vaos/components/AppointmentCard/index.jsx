  ...
  return (
    <>
      {featureAppointmentDetailsRedesign && (
        <div
          className="vaos-appts__appointment-details--container vads-u-margin-top--4 vads-u-border--2px vads-u-border-color--gray-lighter vads-u-padding-x--2p5 vads-u-padding-top--5 vads-u-padding-bottom--3"
