  ...
  return (
    <div className="vads-u-margin-top--9 vads-u-margin-bottom--3">
      ...
      <p className="vads-u-margin-top--0">
        ...
        call <a href="tel:711" aria-label="TTY. 7 1 1.">TTY: 711</a>). We’re here Monday &ndash; Friday, 8:00 a.m. to 8:00 p.m.
        ET.
      </p>
      <p className="vads-u-margin-top--0">
        ...
        call <a href="tel:711" aria-label="TTY. 7 1 1.">TTY: 711</a>). We’re here Monday &ndash; Saturday, 7:00 a.m. to 11:00
        p.m. ET.
      </p>
      <p className="vads-u-margin-top--0">
        <a
