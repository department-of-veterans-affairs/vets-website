...
import InPersonLayout from './InPersonLayoutV2';
import AppointmentVA from '../../services/appointment/AppointmentVA';
...
describe('VAOS Component: InPersonLayout', () => {
  ...
  describe('When viewing upcoming appointment details', () => {
    it('should display in-person layout', async () => {
      ...
      const appointment = new AppointmentVA(response.attributes);
      //   const nullAttributes = {
      //     type: 'VA',
      //     modality: 'vaInPerson',
      //     isCerner: false,
