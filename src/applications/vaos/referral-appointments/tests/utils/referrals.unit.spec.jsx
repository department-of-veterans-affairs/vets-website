...
describe('VAOS referral generator', () => {
  ...
  describe('createReferrals', () => {
    ...
    it('Creates each referral on day later', () => {
      const referrals = referralUtil.createReferrals(2, '2025-10-11');
      expect(referrals[0].expirationDate).to.equal('2026-04-11');
      expect(referrals[1].expirationDate).to.equal('2026-04-12');
    });
  });
  ...
  describe('filterReferrals', () => {
    let referrals = referralUtil.createReferrals(1, '2025-10-11');
    ...
    it('Filters out non-physical therapy referrals', () => {
      ...
      expect(filteredReferrals[0].categoryOfCare).to.equal('Physical Therapy');
    });
  });
