import { ELIGIBILITY_CODES_VAOS } from '../../utils/constants';
/**
...
export default class MockEligibilityResponse {
  ...
  static DIRECT_DISABLED = ELIGIBILITY_CODES_VAOS.DIRECT_SCHEDULING_DISABLED;

  static REQUEST_DISABLED = ELIGIBILITY_CODES_VAOS.REQUEST_SCHEDULING_DISABLED;
