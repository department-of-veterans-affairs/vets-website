 ...
 * @param {Array<VARSlot>} arguments.response The list of slots to return from the mock
 * @param {boolean} [arguments.responseCode=200] The response code to return from the mock api call.
 *
 * @return {string} Return mock API URL. This is useful for debugging.
 */
