  ...
  describe('And direct scheduling not enabled', () => {
    ...
    it('should display choose provider page with request option', () => {
      ...
      ProviderPageObject.assertUrl()
        ...
        // })
        .assertText({ text: /Type of care:/ })
        .assertText({ text: /Facility:/ })
        .assertText({ text: /Doe, John D, MD/ })
        .assertText({ text: /Your last appointment was on/ })
        .assertHeading({
          level: 2,
          name: /If you want to schedule with a different provider/,
        });
