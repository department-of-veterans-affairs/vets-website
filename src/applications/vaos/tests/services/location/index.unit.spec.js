...
describe('VAOS Location service', () => {
  ...
  describe('getCommunityProvidersByTypeOfCare', () => {
    it('should make request to facilities api using correct bounding box', async () => {
      ...
      expect(global.fetch.firstCall.args[0]).to.contain(
        '/v1/facilities/ccp?address=123 big sky st,Bozeman,MT,59715,United States&per_page=10&page=1&bbox[]=-73.598&bbox[]=39.194&bbox[]=-71.862&bbox[]=45.046&specialties[]=133N00000X&type=provider&trim=true',
      );
