...
export const REQUIRED_FILES = {
  ...
  applicantMedicarePartAPartBCardFront: 'Medicare Card front (Parts A/B)',
  applicantMedicarePartAPartBCardBack: 'Medicare Card back (Parts A/B)',
  applicantMedicarePartDCardFront: 'Medicare Card front (Part D)',
