  ...
  return (
    <div id="backendErrorMessage" className="row">
      <div className="medium-8 columns">
        ...
        <p>
          We’re having trouble finding your Post-9/11 GI Bill statements of
          benefits right now.
        </p>
        <p>
          <strong>This could be for 1 of 2 reasons:</strong>
        </p>
        <ul>
          <li>
            Your application is still being processed. We usually process
            applications within 30 days. If you applied after {date}, please
            check back again in a few days.
          </li>
          <li>
            The name on your Vets.gov account might not exactly match the name
            we have in our Post-9/11 GI Bill records. To check the name we have
            in our records, please call the number below.
          </li>
        </ul>
        <p>
