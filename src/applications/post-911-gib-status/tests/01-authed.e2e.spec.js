...
module.exports = E2eHelpers.createE2eTest(client => {
  ...
  Auth.logIn(token, client, '/education/gi-bill/post-9-11/ch-33-benefit', 3)
    ...
    .axeCheck('.main')
    .assert.title('Check your Post-9/11 GI Bill benefits status | Veterans Affairs')
  ...
  client.expect
    .element('#enrollment-0 h4')
    .text.to.contain('11/01/2012 to 12/01/2012 at Purdue University');
