...
class History extends React.Component {
  ...
  scrollToTop = () => { scroller.scrollTo('history', getScrollOptions()); }
  ...
  renderContent = () => {
    ...
    if (!items) {
      return (
        <p className="rx-tab-explainer rx-loading-error">
          ...
          Please refresh this page or try again later. If this problem continues, please call the VA.gov Help Desk
          at <a href="tel:8555747286">1-855-574-7286</a>, TTY: <a href="tel:18008778339">1-800-877-8339</a>, Monday &#8211; Friday, 8:00 a.m. &#8211; 8:00 p.m. (ET).
        </p>
      );
    }
    ...
    if (!items.length) {
      const content = (
        <p>It looks like you don’t have any active VA prescriptions. If you’re taking a medicine that you don’t see listed here—or if you have any questions about your current medicines—please contact your VA health care team. If you need more help, please call the VA.gov Help Desk at <a href="tel:8555747286">1-855-574-7286</a> (TTY: <a href="tel:18008778339">1-800-877-8339</a>). We’re here Monday–Friday, 8:00 a.m.–8:00 p.m. (ET). We’re here Monday–Friday, 8:00 a.m.–8:00 p.m. (ET).</p>
      );
