...
module.exports = E2eHelpers.createE2eTest(client => {
  ...
  client.expect.element('.rx-table-list').to.be.visible;
  ...
  client.click('.va-modal-close').expect.element('#rx-glossary-modal').to.not.be
    .present;
  client
  ...
  client
    ...
    .expect.element('#rx-confirm-refill')
    .to.not.be.present.after(Timeouts.normal);

  // Ensure refill request is submitted
  client.expect
    .element('.rx-prescription-card:nth-of-type(2) button.rx-trigger')
    .text.to.equal('Submitted');
  ...
  client
    ...
    .axeCheck('.main')
    .expect.element('#rx-prescription h1')
    .text.to.equal('ACETAMINOPHEN 325MG TAB');

  // Assert existence of correct message provider link
  client.expect
    .element('a.rx-message-provider-link')
    .to.have.attribute('href')
    .which.contains('/health-care/messaging/compose');
  ...
  client.expect
    .element('.rx-detail-history tr:nth-of-type(1) a.rx-track-package-link')
    .text.to.equal('657068347564');
  client.expect
    .element('.rx-detail-history tr:nth-of-type(2) a.rx-track-package-link')
    .text.to.equal('345787647659');
  client.expect
    .element('.rx-detail-history tr:nth-of-type(3) a.rx-track-package-link')
    .text.to.equal('345787647654');
  client.expect
    .element('.rx-detail-history tr:nth-of-type(2) div:nth-of-type(1)')
    .text.to.equal('ACETAMINOPHEN 325MG TAB');
  client.expect
    .element('.rx-detail-history tr:nth-of-type(2) div:nth-of-type(2)')
    .text.to.equal('ETHAMBUTOL HCL 100MG TAB');
  client.expect
    .element('.rx-detail-history tr:nth-of-type(2) div:nth-of-type(3)')
    .text.to.equal('PROBUCOL 250MG TAB');
  ...
  client
    .click('.form-radio-buttons:first-of-type input')
