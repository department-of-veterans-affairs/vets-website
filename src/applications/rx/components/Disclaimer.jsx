...
class Disclaimer extends React.Component {
  render() {
    ...
    const buttonText = this.props.isOpen
      ? 'Hide this message'
      : 'Show this message';

    return (
      <div className={disclaimerClass} aria-expanded={this.props.isOpen}>
        <div className="usa-alert-body">
          <h4 className="usa-alert-heading">
            This list includes only your active VA prescriptions
          </h4>
          <div className="usa-alert-text" hidden={!this.props.isOpen}>
            <p>
              If you’re taking a medicine that you don’t see on this list — or
              if you have any questions about your current medicines — please
