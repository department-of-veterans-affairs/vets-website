    ...
    >
      <ul>
        <li>
          ...
          Management Center by calling{' '}
          <va-telephone contact="8008270648" uswds /> (or{' '}
          <va-telephone contact="6127136415" international uswds /> from
          overseas) to request temporary financial relief or via Ask VA at{' '}
        ...
        <li>
          ...
          <va-telephone contact="8664001213" uswds />(
          <va-telephone tty contact="711" uswds />
