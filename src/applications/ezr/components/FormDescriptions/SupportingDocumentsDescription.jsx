...
import TipsForUploading, { TipsForUploadingTeraOnly } from './TipsForUploading';

const ToxicExposureDescription = ({ ezrServiceHistoryEnabled }) =>
  ezrServiceHistoryEnabled ? (
    ...
    <>
      ...
      <p>
        ...
        But they may help us confirm certain details about your service history
        and process your form faster.
      </p>
      ...
      <TipsForUploadingTeraOnly />
      <p>Upload supporting document</p>
    </>
  );
export default ToxicExposureDescription;
ToxicExposureDescription.propTypes = {
  ezrServiceHistoryEnabled: PropTypes.bool,
};
