  ...
  return (
    <>
      ...
      <p>
        ...
        personal, financial, and insurance information after you’re enrolled in
        VA health care.
      </p>
      ...
      <ul>
        ...
        <li>
          Income information from {lastYear} for you, your spouse (if you’re
          married), and any dependents you may have
        </li>
        <li>You or your spouse’s deductible expenses from {lastYear}</li>
      </ul>

      <p>
        We’ll use this information to determine if you’ll need to pay a copay
        for non-service-connected care or prescription medicines. We’ll also
        determine if you’re eligible for travel pay reimbursement.
      </p>
