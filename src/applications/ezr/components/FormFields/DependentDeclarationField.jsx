  ...
  if (hasList) {
    return {
      labels: {
        ...
        N: content['household-dependent-report-yes-addtl'],
      },
    };
  }
  return {
    ...
    >
      ...
      >
        ...
        <p className="usa-hint">
          ...
          years old, between 18 and 23 years old and enrolled in school in 2023,
          or they’re living with a permanent disability that happened before
