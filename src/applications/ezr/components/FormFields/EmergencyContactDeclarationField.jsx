...
const EmergencyContactDeclarationField = ({
  defaultValue,
  error,
  hasList,
  onChange,
...
EmergencyContactDeclarationField.propTypes = {
...
EmergencyContactDeclarationField.defaultProps = {
  defaultValue: null,
  error: false,
};

export default EmergencyContactDeclarationField;
