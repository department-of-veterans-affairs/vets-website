...
describe('ezr disability rating reducer', () => {
  let state;
  let reducedState;
  let action;
  ...
  describe('when `FETCH_DISABILITY_RATING_STARTED` executes', () => {
  ...
  describe('when `FETCH_DISABILITY_RATING_FAILED` executes', () => {
  ...
  describe('when `FETCH_DISABILITY_RATING_SUCCEEDED` executes', () => {
