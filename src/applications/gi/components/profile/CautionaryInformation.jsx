  ...
  const renderCautionFlags = () => {
    ...
    return (
      <div>
        ...
        <p>
          If any cautionary warnings have been issued, they will appear below.
        ...
        <p>
          ...
          location will be closing, it will appear below. Once the closing date
          passes, we remove the institution from the Comparison Tool during the
          next system update.
        </p>
