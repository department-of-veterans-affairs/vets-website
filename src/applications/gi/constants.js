...
export const ariaLabels = Object.freeze({
  learnMore: {
    ...
    publicSchool: 'Learn more about Public school',
    privateSchool: 'Learn more about Private school',
    proprietarySchool: 'Learn more about Proprietary school',
    foreignSchool: 'Learn more about Foreign school',
