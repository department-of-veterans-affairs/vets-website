    ...
    return (
      <span>
        ...
        <Modal onClose={this.props.hideModal} visible={this.shouldDisplayModal('yribbon')}>
          ...
          <p>
            Veterans, Fry Scholarship, and Purple Heart recipients are entitled to the maximum benefit
    ...
    return (
      <span>
        ...
        <Modal onClose={this.props.hideModal} visible={this.shouldDisplayModal('calcYr')}>
          ...
          <p>
            Veterans, Fry Scholarship, and Purple Heart recipients are entitled to the maximum benefit rate or their designated transferees can receive this funding. Active duty Servicemembers and their spouses are not eligible for this program (child transferees of active duty Servicemembers may be eligible if the servicemember is qualified at the 100% rate). This information will be updated quarterly.
          </p>
        </Modal>
