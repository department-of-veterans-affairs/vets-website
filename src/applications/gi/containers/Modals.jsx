    ...
    return (
      <span>
        ...
        >
          ...
          <ul>
            <li>
              A main campus: the location where the primary teaching facilities
              of an educational institution are located
            </li>
            <li>
              A branch campus: the location of an educational institution that
              is geographically apart from and operationally independent of the
              main campus of the educational institution
            </li>
            <li>
              An extension campus: the location that is geographically apart
              from the main or branch campus but is operationally dependent on
              that campus for the performance of administrative tasks
            </li>
          </ul>
          <p>
