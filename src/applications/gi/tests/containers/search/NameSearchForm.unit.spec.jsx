  ...
  describe('specialMissions', () => {
    ...
    it('should remove public school type when PUBLIC checkbox is unchecked ', async () => {
      ...
      expect(fetchUrl).to.include(
        `${expectedBaseUrl}?name=${newValue}&page=1&exclude_employers=true&exclude_vettec=true&excluded_school_types%5B%5D=FOR-PROFIT&excluded_school_types%5B%5D=PRIVATE&excluded_school_types%5B%5D=FOREIGN&excluded_school_types%5B%5D=FLIGHT&excluded_school_types%5B%5D=CORRESPONDENCE&excluded_school_types%5B%5D=HIGH%20SCHOOL`,
      );
    });
    ...
    it('should add special-mission-hbcuall when button is clicked ', async () => {
      ...
      expect(fetchUrl.startsWith(expectedBaseUrl)).to.be.true;
      expect(fetchUrl).to.include(
        `${expectedBaseUrl}?name=${newValue}&page=1&special_mission_hbcu=true&exclude_schools=true&exclude_employers=true&exclude_vettec=true&excluded_school_types%5B%5D=PUBLIC&excluded_school_types%5B%5D=FOR-PROFIT&excluded_school_types%5B%5D=PRIVATE&excluded_school_types%5B%5D=FOREIGN&excluded_school_types%5B%5D=FLIGHT&excluded_school_types%5B%5D=CORRESPONDENCE&excluded_school_types%5B%5D=HIGH%20SCHOOL`,
      );
    });
    it('should add specialMissionMenonly when button is clicked ', async () => {
      ...
      expect(fetchUrl.startsWith(expectedBaseUrl)).to.be.true;
      expect(fetchUrl).to.include(
        `${expectedBaseUrl}?name=${newValue}&page=1&special_mission_menonly=true&exclude_schools=true&exclude_employers=true&exclude_vettec=true&excluded_school_types%5B%5D=PUBLIC&excluded_school_types%5B%5D=FOR-PROFIT&excluded_school_types%5B%5D=PRIVATE&excluded_school_types%5B%5D=FOREIGN&excluded_school_types%5B%5D=FLIGHT&excluded_school_types%5B%5D=CORRESPONDENCE&excluded_school_types%5B%5D=HIGH%20SCHOOL`,
      );
    });
    it('should add special-mission-womenonly when button is clicked ', async () => {
      ...
      expect(fetchUrl.startsWith(expectedBaseUrl)).to.be.true;
      expect(fetchUrl).to.include(
        `${expectedBaseUrl}?name=${newValue}&page=1&special_mission_womenonly=true&exclude_schools=true&exclude_employers=true&exclude_vettec=true&excluded_school_types%5B%5D=PUBLIC&excluded_school_types%5B%5D=FOR-PROFIT&excluded_school_types%5B%5D=PRIVATE&excluded_school_types%5B%5D=FOREIGN&excluded_school_types%5B%5D=FLIGHT&excluded_school_types%5B%5D=CORRESPONDENCE&excluded_school_types%5B%5D=HIGH%20SCHOOL`,
      );
    });
    it('should add exclude-caution-flags when button is clicked ', async () => {
      ...
      expect(fetchUrl.startsWith(expectedBaseUrl)).to.be.true;
      expect(fetchUrl).to.include(
        `${expectedBaseUrl}?name=${newValue}&page=1&exclude_caution_flags=true&exclude_schools=true&exclude_employers=true&exclude_vettec=true&excluded_school_types%5B%5D=PUBLIC&excluded_school_types%5B%5D=FOR-PROFIT&excluded_school_types%5B%5D=PRIVATE&excluded_school_types%5B%5D=FOREIGN&excluded_school_types%5B%5D=FLIGHT&excluded_school_types%5B%5D=CORRESPONDENCE&excluded_school_types%5B%5D=HIGH%20SCHOOL`,
      );
    });
    it('should remove employers when button is clicked ', async () => {
      ...
      expect(fetchUrl.startsWith(expectedBaseUrl)).to.be.true;
      expect(fetchUrl).to.include(
        `${expectedBaseUrl}?name=${newValue}&page=1&exclude_schools=true&exclude_vettec=true&excluded_school_types%5B%5D=PUBLIC&excluded_school_types%5B%5D=FOR-PROFIT&excluded_school_types%5B%5D=PRIVATE&excluded_school_types%5B%5D=FOREIGN&excluded_school_types%5B%5D=FLIGHT&excluded_school_types%5B%5D=CORRESPONDENCE&excluded_school_types%5B%5D=HIGH%20SCHOOL`,
      );
    });
    it('should call url when apply filters button is clicked ', async () => {
      ...
      expect(fetchUrl.startsWith(expectedBaseUrl)).to.be.true;
      expect(fetchUrl).to.include(
        `${expectedBaseUrl}?name=&page=1&exclude_schools=true&exclude_vettec=true&excluded_school_types%5B%5D=PUBLIC&excluded_school_types%5B%5D=FOR-PROFIT&excluded_school_types%5B%5D=PRIVATE&excluded_school_types%5B%5D=FOREIGN&excluded_school_types%5B%5D=FLIGHT&excluded_school_types%5B%5D=CORRESPONDENCE&excluded_school_types%5B%5D=HIGH%20SCHOOL`,
      );
    });
  });
});
