        ...
        applicantInformation: {
          ...
          uiSchema: {
            'view:applicantInformation': {
              'ui:field': ApplicantIdentityView,
            },
          },
          schema: {
            type: 'object',
                ...
                'ui:description': (
                  ...
                  >
                    <p className="vads-u-margin-y--0">
                      ...
                      select. VA will review your eligibility for each
                      selection. For any sponsors you do not select, you may
                      impact your ability to use those benefits in the future.
                      You can reapply for those sponsors using this application.
                    </p>
                  </va-additional-info>
                ),
              },
              ...
              'view:noSponsorWarning': {
                'ui:description': (
                  ...
                  >
                    ...
                    <p>
                      If you think this is incorrect, reach out to your sponsor
                      so they can{' '}
                ...
                'ui:description': (
                  ...
                  >
                    <p className="vads-u-margin-top--0">
                      Though unlikely, you may need to consider differences in
                      the amount of benefits each sponsor offers and when they
                      expire. Benefits from other sponsors can be used after
                      your first sponsor’s benefits expire.
                    </p>
                  ...
                  <>
                    ...
                    >
                      ...
                      <div>
                        ...
                        sponsor, please include information about your high
                        school education.
                      </div>
                    </va-alert>
                ...
                'ui:description': (
                  <>
                    ...
                    <p>
                      ...
                      notice any errors, please correct them now. Any updates
              ...
              'view:subHeadings': {
                'ui:description': (
                  <>
                    ...
                    <p>
                      We have this mailing address on file for you. If you
                      notice any errors, please correct them now. Any updates
                      you make will change the information for your education
                      benefits only.
                    </p>
                ...
                'ui:description': (
                  <>
                    <div className="toe-form-page-only">
                      ...
                      <p>
                        We recommend that you opt into text message
                        notifications about your benefits. These include
                        notifications that prompt you to verify your enrollment
                        so you’ll receive your education payments. This is an
                        easy way to verify your monthly enrollment.
                      </p>
                      <div className="meb-list-label">
                      ...
                      <p>
                        <strong>Note</strong>: At this time, we can only send
                        text messages to U.S. mobile phone numbers.
                      </p>
                    </div>
                  </>
                ),
              ...
              'view:internationalTextMessageAlert': {
                'ui:description': (
                  <va-alert status="warning">
                    <>
                      You can’t choose to get text notifications because you
                      have an international mobile phone number. At this time,
                      we can send text messages about your education benefits
                      only to U.S. mobile phone numbers.
                    </>
                  </va-alert>
                ),
                'ui:options': {
              ...
              'view:learnMore': {
                'ui:description': (
                  <>
                    ...
                    />
                    <p key="learn-more-title">
                      Where can I find these numbers?
                    </p>
                    <p key="learn-more-description">
                      The bank routing number is the first 9 digits on the
                      bottom left corner of a printed check. Your account number
                      is the second set of numbers on the bottom of a printed
                      check, just to the right of the bank routing number.
                    </p>
                    <va-additional-info
                      key="learn-more-btn"
                      trigger="Learn More"
