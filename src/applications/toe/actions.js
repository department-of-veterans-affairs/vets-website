...
const CLAIM_STATUS_RESPONSE_IN_PROGRESS = 'CLAIM_STATUS_RESPONSE_IN_PROGRESS';
const FETCH_CLAIM_STATUS = 'FETCH_CLAIM_STATUS';
const FETCH_CLAIM_STATUS_SUCCESS = 'FETCH_CLAIM_STATUS_SUCCESS';
const FETCH_CLAIM_STATUS_FAILURE = 'FETCH_CLAIM_STATUS_FAILURE';
