...
const YellowRibbonProgramDescription = () => {
      ...
      <ul className="vads-u-width--full">
        {isUsaSchool ? (
          <>
            ...
            {isUsaSchool && <li className="vads-u-margin-bottom--1 vads-u-margin-left--1 vads-u-padding-left--2p5">
              The maximum annual contribution amount per student, or the amount to 
              pay toward remaining tuition that the Post-9/11 GI Bill doesn't cover 
              (unlimited). Enter the total amount your school plans to contribute each year, 
              not by term or credit hour. If the amount entered is over $99,999, the
            ...
            {!isUsaSchool && <li className="vads-u-margin-bottom--1 vads-u-margin-left--1 vads-u-padding-left--2p5">
              ...
              pay toward remaining tuition that the Post-9/11 GI Bill doesn't cover 
              (unlimited). Enter the total amount your school plans to contribute each year
              in your institution's official billing currency, not by term or credit hour.
              If the amount entered is over $99,999 USD, the system will treat is as an
  ...
  return (
    <div className="yellow-ribbon-program-description">
      ...
      </p> : <p>You may add more entries if your school offers different contributions
        based on degree level or other factors.
      </p>}
      {!isUsaSchool && (
