...
const PrivacyActStatement = ({ ombNumber = '2900-0262' }) => {
  return (
    <>
      <p data-testid="respondent-burden">
        ...
        08/31/2027. Public reporting burden for this collection of information
        is estimated to average 10 minutes per respondent, per year, including
        ...
        not send your completed VA Form 22-8794 to this email address.
      </p>
      ...
      <p data-testid="privacy-act-notice">
        ...
        respond is required to obtain or retain education benefits. VA cannot
        recognize you as the proper certifying official unless the information
        is furnished as required by existing law (38 U.S.C. 3680(g)). The
        responses you submit are considered confidential (38 U.S.C. 5701). Any
