/*
  When ready for production delete the following envoronment toggles
    1- Line 21 - environment import
    2- Lines 38 - 47 isProduction statement && Lines 48, 57 else statement
    3- Lines 144 - 161 isProduction statement && Lines 162, 178 esle statement
    4- Lines 183 - 585 isProduction statement && Lines 586, 933 esle statement
...
class EducationWizard extends React.Component {
  ...
  recordWizardValues = () => {
    ...
    // isProduction environment toggle
    if(environment.isProduction()){
      recordEvent({
            ...
            <div className="wizard-content-inner">
              ...
              {serviceBenefitBasedOn === 'own' && (
                <RadioButtons
                  ...
                  onValueChange={({ value }) =>
                    this.answerQuestion('nationCallToService', value)
                  }
