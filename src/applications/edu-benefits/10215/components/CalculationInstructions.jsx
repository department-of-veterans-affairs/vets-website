  ...
  return (
    <div className="vads-l-grid-container vads-u-margin-top--4">
      ...
      <div className="bottom-border">
        ...
        <ul className="vads-u-margin-left--2 list-style">
          ...
          <li>
            ...
            <a href="https://www.govinfo.gov/content/pkg/CFR-2008-title38-vol2/pdf/CFR-2008-title38-vol2-sec21-4201.pdf">
              38 CFR §21.4201(f)(2)
            </a>
            .
          </li>
      ...
      <div className="bottom-border">
        ...
        <ul className="vads-u-margin-left--2 list-style">
          <li>
            The student is not using GI Bill benefits under Ttile 10 or Title 38
            (chapter 30, 31, 33, 35, 36, 1606); <strong>AND</strong>
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            Any student receiving Tuitition Assistance through the Department of
            Defense.
          </li>
          <li>
            Any student receiving non-institutional aid (scholarship, grants, or
            other types of aid offered by third-party entity not affiliated with
            the school).
          </li>
        </ul>
      </div>
