...
import page from '../../pages/isUsingTeachoutAgreement';
...
describe('22-0989 teachout page', () => {
  it('renders page title', () => {
    const { container } = renderPage();
    expect(container.textContent).to.contain('Teach out program details');
  });
  ...
  it('accepts any valid option without error', () => {
    ...
    const utils2 = renderPage({
      isUsingTeachoutAgreement: false,
    });
