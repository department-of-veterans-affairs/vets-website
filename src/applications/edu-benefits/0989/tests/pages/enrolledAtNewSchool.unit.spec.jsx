...
import page from '../../pages/enrolledAtNewSchool';
...
describe('22-0989 enrolled at new school page', () => {
  it('renders page title', () => {
    const { container } = renderPage();
    expect(container.textContent).to.contain('New school enrollment');
  });
  ...
  it('renders the radio group with the correct label', () => {
    ...
    expect(vaRadio.getAttribute('label')).to.equal(
      'Are you enrolled in a course of study at a new school?',
    );
  });
