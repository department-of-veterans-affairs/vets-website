...
import page from '../../pages/wasOnApprovedLeave';
...
describe('22-0989 was on approved leave page', () => {
  it('renders page title', () => {
    const { container } = renderPage();
    expect(container.textContent).to.contain('Leave of absence');
  });
