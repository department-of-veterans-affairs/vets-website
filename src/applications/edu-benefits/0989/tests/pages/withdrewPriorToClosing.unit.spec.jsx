...
import page from '../../pages/withdrewPriorToClosing';
...
describe('22-0989 withdrew prior to closing page', () => {
  it('renders page title', () => {
    const { container } = renderPage();
    expect(container.textContent).to.contain('Withdrawal details');
  });
  ...
  it('renders the radio group with the correct label', () => {
    ...
    expect(vaRadio.getAttribute('label')).to.equal(
      'Did you withdraw from the school prior to closing?',
    );
  });
