...
describe('Edu 5490 employmentHistory', () => {
  ...
  it('should render expanded', () => {
    ...
    const hasEmploymentYes = Array.from(formDOM.querySelectorAll('input')).find(
      input => input.id.startsWith('root_view:hasNonMilitaryJobs'),
    );
  ...
  it('should add another', () => {
    ...
    ReactTestUtils.Simulate.change(
      formDOM.querySelector('#root_nonMilitaryJobs_0_name'),
      {
        target: {
          value: 'A job title',
        },
