...
describe('the Edu-Benefit 1990E Introduction Page', () => {
  ...
  beforeEach(() => {
    defaultProps = {
      shouldEduBenefits1990NWizardShow: true,
      route: {
        formConfig: {},
      },
      saveInProgress: {
  ...
  it('should show the wizard on initial render if shouldEduBenefits1990NWizardShow is set to true', () => {
  ...
  it('should show the subway map on initial render if shouldEduBenefits1990NWizardShow is set to false', () => {
    const props = {
      ...defaultProps,
      shouldEduBenefits1990NWizardShow: false,
    };
