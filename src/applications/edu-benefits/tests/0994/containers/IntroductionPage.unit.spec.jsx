...
describe('the Edu-Benefit 0994 Introduction Page', () => {
  ...
  beforeEach(() => {
    defaultProps = {
      shouldEduBenefits0994WizardShow: true,
      route: {
        formConfig: {},
      },
      saveInProgress: {
  ...
  it('should show the wizard on initial render if shouldEduBenefits0994WizardShow is set to true', () => {
  ...
  it('should show the subway map on initial render if shouldEduBenefits0994WizardShow is set to false', () => {
    const props = {
      ...defaultProps,
      shouldEduBenefits0994WizardShow: false,
    };
