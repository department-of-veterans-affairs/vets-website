...
module.exports = E2eHelpers.createE2eTest(client => {
  ...
  client
    ...
    .assert.title('How to Apply for Education Benefits: VA.gov')
  ...
  client
    ...
    .waitForElementVisible(
      'label[for="serviceBenefitBasedOn-0"]',
      Timeouts.normal,
    )
    // Select veteran
    .click('input[id="serviceBenefitBasedOn-0"]')
    .waitForElementVisible(
      'label[for="nationalCallToService-0"]',
      Timeouts.normal,
    )
  ...
  client.expect
    .element('#apply-now-link')
    .to.have.attribute('href')
    .which.contains('/education/apply-for-education-benefits/application/5490');
  ...
  client.waitForElementVisible(
    'label[for="sponsorTransferredBenefits-0"]',
    Timeouts.normal,
  );
  ...
  client.click('#newBenefit-1').expect.element('#apply-now-link').not.to.be
    .present;

  client.waitForElementVisible(
    'label[for="transferredEduBenefits-0"]',
    Timeouts.normal,
  );
  ...
  client.expect
    .element('#apply-now-link')
    .to.have.attribute('href')
    .which.contains('/education/apply-for-education-benefits/application/5495');
  ...
  client.expect
    .element('#apply-now-link')
    .to.have.attribute('href')
    .which.contains('/education/apply-for-education-benefits/application/1995');
