...
describe('<SchoolSelectField>', () => {
  test('should render initial search view', () => {
  ...
  test('should render institution results view', () => {
    const institutions = [{
      address1: 'testStreet',
      address2: 'testStreet',
      address3: 'testStreet',
  ...
  test('should only render available institution information', () => {
    const institutions = [{
      city: '',
      facilitycode: 'test',
      name: 'testname',
  ...
  test('should render institutions loading view', () => {
    const tree = mount(<SchoolSelectField
      formData={{}}
      formContext={{}}
      currentPageNumber={1}
  ...
  test('should render pagination loading view', () => {
    const tree = mount(<SchoolSelectField
      formData={{}}
      formContext={{}}
      currentPageNumber={1}
  ...
  test('should render an error view', () => {
    const tree = mount(<SchoolSelectField
      formData={{}}
      errorMessages={[]}
      formContext={{}}
  ...
  test(
    'should render no results or loading views when showSearchResults is false',
    () => {
      const institutions = [{
        city: '',
        facilitycode: 'test',
  ...
  test('should call onChange props on when manual entry is toggled', () => {
  ...
  test('should call searchInputChange prop on input change', () => {
  ...
  // handleSearchClick
  test(
    'should call searchSchools and onChange props when search button clicked',
    (done) => {
  ...
  describe('handleOptionClick', () => {
    ...
    test(
      'should call `selectInstitution` and `onChange` props properly when domestic institution selected',
      () => {
    ...
    test(
      'should call `selectInstitution` and `onChange` props properly when non-domestic institution selected',
      () => {
  ...
  // handleStartOver
  test(
    'should call onChange and clearSearch props when start over is clicked',
    () => {
      const onChange = sinon.spy();
