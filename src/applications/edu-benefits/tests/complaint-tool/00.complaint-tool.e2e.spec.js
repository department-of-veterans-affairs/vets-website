...
module.exports = E2eHelpers.createE2eTest((client) => {
  ...
  client.waitForElementPresent('input[name="root_onBehalfOf"][value="Myself"]', Timeouts.normal)
    .axeCheck('.main');
  ...
  client.waitForElementVisible('input[name="root_fullName_first"]', Timeouts.normal)
    .axeCheck('.main');
  ...
  // Service information
  client.waitForElementVisible('select[name="root_serviceBranch"]', Timeouts.normal)
    .axeCheck('.main');
  ...
  // Contact information
  client.waitForElementVisible('select[name="root_address_country"]', Timeouts.normal)
    .axeCheck('.main');
  ...
  // Issue information
  client.waitForElementPresent('input[name="root_issue_recruiting"]', Timeouts.normal)
    .axeCheck('.main');
