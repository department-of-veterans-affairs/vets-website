...
const uiSchema = {
    ...
    ...descriptionUI(<><strong>Note: </strong>You can apply for reimbursement after your prep course has started.</>),
    prepCourseStartDate: {
        ...currentOrPastDateUI({
            ...
            errorMessages: { pattern: 'Enter a valid date', required: 'Enter a start date' },
        }),
        'ui:validations': [validateCurrentOrPastMemorableDate, validatePrepCourseStartDate],
    },
    prepCourseEndDate: {
        ...currentOrPastDateUI({
            ...
            'ui:description':
                'Enter 1 or 2 digits for the month and day and 4 digits for the year.',
            errorMessages: { pattern: 'Enter a valid date', required: 'Enter an end date' },
        }),
    },
};
