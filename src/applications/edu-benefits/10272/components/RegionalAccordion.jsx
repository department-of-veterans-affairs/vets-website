...
const RegionalAccordion = () => (
  <va-accordion>
    <va-accordion-item header="Eastern region" id="easter_region">
      <p className="va-address-block vads-u-margin-top--0">
        VA Regional Office
        <br />
        P.O. Box 4616
        <br />
    ...
    <va-accordion-item header="Western region" id="western_region">
      ...
      <p>
        ...
        Alaska, Arizona, Arkansas, California, Florida, Georgia, Hawaii, Idaho,
        Louisiana, Mississippi, New Mexico, Nevada, Oklahoma, Oregon, South
