      ...
      'ui:description': (
        <div>
          <ul>
            ...
            <li>
              Institution will not impose any penalty, including the assessment
              of late fees, the denial of access to classes, or other
              institutional facilities, or require that VA students borrow funds
              due to VA-delayed disbursement of funding.
            </li>
            <li>
              Institution will not engage in advertising and/or enrollment
              practices of any type, which are erroneous, deceptive, or
              misleading ither by actual statements, omission or intimidation.
            </li>
            <li>
              Institutions are prohibited from using “GI Bill” in any manner
              that directly or indirectly implies a relationship affiliation, or
            ...
            <li>
              ...
              22-8794, Designation of Certifying Official, whenever a new
            ...
            <li>
              ...
              amendments, adjustments, or terminations electronically through
              the Enrollment Management (EM) system.
            </li>
          </ul>
        </div>
      ),
