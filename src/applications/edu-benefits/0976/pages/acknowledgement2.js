    ...
    acknowledgement8: {
      ...
      'ui:description': (
        <div>
          <ul>
            <li>
              Maintain sufficient records to show the progress of each VA
              student and to promptly inform VA when the conduct or progress of
              any VA student is not satisfactory in accordance with the
              regularly prescribed standards and practices of the institution.
            </li>
            <li>
              Institution will give appropriate credit for previous education
              and training of VA students and shorten the training program
              appropriately.
            </li>
            <li>
            ...
            <li>
              ...
              tuition, fees and other related miscellaneous amounts for the
              costs of attendance.
            </li>
            <li>
