...
import page from '../../pages/submissionReasonOtherText';
...
describe('22-0976 submission reason update information text page', () => {
  it('renders page title', () => {
    ...
    expect(container.textContent).to.contain('TBD: Other title');
  });
  ...
  it('renders the text input with the correct label', () => {
    ...
    expect(vaText.getAttribute('label')).to.equal('TBD Other subtitle');
  });
