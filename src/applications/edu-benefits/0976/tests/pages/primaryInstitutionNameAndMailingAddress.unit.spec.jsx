...
import page from '../../pages/primaryInstitutionNameAndMailingAddress';
...
describe('22-0976 primary institution name and mailing address page', () => {
  it('renders name and address fields', () => {
    const { container } = renderPage();

    expect(container.querySelector('va-text-input[label="Institution name"]'))
      .to.exist;
    expect(
      container.querySelector(
        'va-checkbox[name="root_primaryInstitutionDetails_differentPhysicalAddress"]',
      ),
    ).to.exist;
