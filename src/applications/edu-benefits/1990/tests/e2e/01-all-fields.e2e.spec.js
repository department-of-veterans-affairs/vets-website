...
const EduHelpers = require('../utils/edu-helpers');
const Edu1990Helpers = require('../utils/edu-1990-helpers');
...
const test = E2eHelpers.createE2eTest(client => {
  ...
  // benefits page
  client.waitForElementVisible(
    'label[for="root_view:selectedBenefits_chapter32"]',
    Timeouts.slow,
  );
  ...
  client.waitForElementVisible(
    'label[for="root_view:benefitsRelinquishedContainer_benefitsRelinquished_0"]',
    Timeouts.slow,
  );
  ...
  client.waitForElementVisible(
    'label[for="root_toursOfDuty_0_serviceBranch"]',
    Timeouts.slow,
  );
  ...
  // military history
  client.waitForElementVisible(
    'label[for="root_serviceAcademyGraduationYear"]',
    Timeouts.slow,
  );
  ...
  // rotc history
  client.waitForElementVisible(
    'label[for="root_seniorRotcScholarshipProgramYes"]',
    Timeouts.slow,
  );
  ...
  client.waitForElementVisible(
    'label[for="root_civilianBenefitsAssistance"]',
    Timeouts.slow,
  );
  ...
  client.waitForElementVisible(
    'label[for="root_highSchoolOrGedCompletionDateMonth"]',
    Timeouts.slow,
  );
  ...
  client.waitForElementVisible(
    'label[for="root_view:hasNonMilitaryJobsYes"]',
    Timeouts.slow,
  );
  ...
  client.waitForElementVisible(
    'label[for="root_secondaryContact_fullName"]',
    Timeouts.slow,
  );
