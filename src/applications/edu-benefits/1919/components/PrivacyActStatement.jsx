  ...
  return (
    <>
      <p data-testid="respondent-burden">
        ...
        control number. The OMB control number for this project is 2900-0657,
        and it expires 03/31/2027. Public reporting burden for this collection
        of information is estimated to average 1 hour per respondent, per year,
      ...
      <p data-testid="privacy-act-notice">
        ...
        of a routine use (e.g., VA sends educational forms or letters Register.
        An example of a routine use (e.g., VA sends educational forms or letters
        with a Veteran's identifying information to the Veteran's school or
        training establishment to (1) assist the Veteran in the completion of
        claims forms or (2) for VA to obtain further information as may be
        necessary from the school for VA to properly process the Veteran's
        education claim or to monitor his or her progress during training). Your
        obligation to respond is required to obtain or retain education
        benefits. The responses you provide are considered confidential (38
        U.S.C. 5701). Any information provided by applicants, recipients, and
        others is subject to verification through computer matching programs
        with other agencies.{' '}
      </p>
    </>
  );
