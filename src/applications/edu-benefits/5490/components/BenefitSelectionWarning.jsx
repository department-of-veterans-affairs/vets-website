  ...
  if (chapter === 'chapter33') {
    ...
    if (relationship === 'child') {
      warningText = (<div>
        ...
        <ul>
          <li>The death of the qualifying individual on this application, and they died before August 1, 2011, or</li>
