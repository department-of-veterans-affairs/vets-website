...
export const selectManualSchoolEntryChecked = state => _.get(state, 'form.data.educationDetails.school.facilityCode.view:manualSchoolEntryChecked');
...
export const selectShowSearchResults = state => _.get(state, 'schoolSelect.showSearchResults');
