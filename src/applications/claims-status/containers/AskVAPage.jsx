      ...
      <div className="vads-l-row vads-u-margin-x--neg1p5 medium-screen:vads-u-margin-x--neg2p5">
        <div className="vads-l-col--12">
          <ClaimsBreadcrumbs>
            ...
            <Link to="../ask-va-to-decide">Ask for your claim decision</Link>
          </ClaimsBreadcrumbs>
        </div>
      </div>
        ...
        <div className="vads-l-col--12 vads-u-padding-x--2p5 medium-screen:vads-l-col--8">
          <div>
            ...
            <p className="first-of-type">
              ...
              don’t have anything more you want to submit, let us know and we’ll
              go ahead and make a decision on your claim.
            </p>
            ...
            <div className="usa-alert usa-alert-info background-color-only claims-alert">
              <Checkbox
                ...
                onValueChange={update => setSubmittedDocs(update)}
            ...
            <button
              ...
              onClick={() => submitRequest(params.id)}
            >
              {buttonMsg}
            </button>
            {!loadingDecisionRequest ? (
