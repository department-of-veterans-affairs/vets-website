...
const ClaimEstimationPage = () => {
  ...
  const crumbs = [
    { href: '../status', label: 'Status details', isRouterLink: true },
    { href: '../claim-estimate', label: 'Estimated decision date', isRouterLink: true },
  ];
      ...
      <div className="usa-width-two-thirds medium-8 columns">
        ...
        <div>
          ...
          <p className="first-of-type">
            We look at every claim carefully before making a decision. Sometimes we can
            decide quickly, but more complex claims take longer to review.
          </p>
          ...
          <p>
            The above reasons sometimes result in your claim needing additional time that
            exceeds the estimated completion date. We are working to process your claim as
            quickly as possible.
          </p>

          <h2 className="claims-paragraph-header">When we don’t give you an estimated decision date:</h2>
          <p>
            Sometimes we can’t estimate the decision date because we don’t have enough
            information. We can give you an estimated decision date after we have gathered
...
/* -------------------------------------------------------------------------- */
/* Redux wiring stays exactly the same — props aren't used here but keeping   */
/* them avoids any breaking changes for parent consumers.                     */
/* -------------------------------------------------------------------------- */
function mapStateToProps(state) {
  const { claimDetail } = state.disability.status;
  return {
