  ...
  <div className="row" id="appealsDownMessage">
    <div className="small-12 columns">
      <div className="react-container">
        ...
        <p>Please refresh this page or try again later. If it still doesn’t work, you can call the VA.gov Help Desk at <a href="tel:+18555747286">1-855-574-7286</a> (TTY: <a href="tel:+18008294833">1-800-829-4833</a>). We’re here Monday–Friday, 8:00 a.m.–8:00 p.m. (ET).</p>
      </div>
    </div>
  </div>
);
  ...
  <div className="row" id="recordsNotFoundMessage">
    <div className="small-12 columns">
      <div className="react-container">
        ...
        <p>If you think they should be here, please try again later or call the VA.gov Help Desk at <a href="tel:+18555747286">1-855-574-7286</a> (TTY: <a href="tel:+18008294833">1-800-829-4833</a>). We’re here Monday–Friday, 8:00 a.m.–8:00 p.m. (ET).</p>
      </div>
    </div>
  </div>
);
