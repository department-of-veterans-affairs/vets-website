...
describe('Claim files', () => {
  ...
  it('should have correct page title, breadcrumbs, and heading', () => {
    cy.setupClaimTest({ claim: createClaim(), tab: 'files' });

    verifyTitleBreadcrumbsHeading({
      title: 'Files for January 1, 2025 Compensation Claim | Veterans Affairs',
      thirdBreadcrumb: {
    ...
    cy.findByText('Request for an exam')
      ...
      .within(() => {
        ...
        cy.findByRole('link', {
          ...
          'have.attr',
          'href',
          '/track-claims/your-claims/123456789/needed-from-others/585393',
        );
      });
    ...
    cy.findByText('Reserve records')
      ...
      .within(() => {
        ...
        cy.findByRole('link', {
          ...
          'have.attr',
          'href',
          '/track-claims/your-claims/123456789/needed-from-others/585394',
        );
      });
