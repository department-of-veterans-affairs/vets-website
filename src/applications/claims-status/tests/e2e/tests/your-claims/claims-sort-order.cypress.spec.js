...
describe('Claims list sort order', () => {
  ...
  context('when list has mixed in-progress and closed claims', () => {
  ...
  context('when list has mixed in-progress and closed appeals', () => {
  ...
  context('when list has a mix of claims and appeals', () => {
    it('should display all in-progress items before all closed items', () => {
      ...
      cy.get('[data-testid="claim-card"]')
        .eq(2)
        .should('contain', 'Step 5 of 5: Closed');
  ...
  context('when list has a STEM claim and an in-progress claim', () => {
  ...
  context('when multiple in-progress claims exist', () => {
    it('should sort by most recently updated first', () => {
  ...
  context('when in-progress claims have documents needed', () => {
