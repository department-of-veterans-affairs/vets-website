...
describe('<ClaimEstimate>', () => {
  test('should render estimated date', () => {
  ...
  test('should render estimated date warning', () => {
  ...
  test('should render no estimate warning', () => {
    const tree = SkinDeep.shallowRender(
      <ClaimEstimate
        maxDate=""/>
    );
  ...
  test('should render no estimate warning with far away date', () => {
