...
describe('<Alert/>', () => {
  ...
  test('should apply warning styling on take_action alert types', () => {
  ...
  test('should apply info styling on info alert types', () => {
  ...
  test('should display a title passed in as a prop', () => {
  ...
  test('should display a description passed in as a prop', () => {
