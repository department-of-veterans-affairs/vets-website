...
describe('<Issues/>', () => {
  ...
  test('should render no panels when no issues passed in', () => {
    // Note: this probably isn't possible in real-world usage
    const wrapper = shallow(<Issues {...emptyIssues}/>);
    expect(wrapper.find('CollapsiblePanel').length).to.equal(0);
  });

  test('should render one panel when only an open issue is passed in', () => {
  ...
  test('should render one panel when only a closed issue is passed in', () => {
  ...
  test(
    'should render two panels when both open *AND* closed issues are passed in',
    () => {
  ...
  test('should render a list of open items when open items exist', () => {
  ...
  test('should render a list of closed items when items exist', () => {
  ...
  test(
    'should pass auto-expand prop to active panel when both active and closed panels present',
    () => {
      const wrapper = shallow(<Issues {...manyIssues}/>);
  ...
  test(
    'should pass auto-expand prop to active panel when only active panel present',
    () => {
      const wrapper = shallow(<Issues {...oneOpenIssue}/>);
  ...
  test(
    'should pass auto-expand prop to closed panel when no active panel present',
    () => {
      const wrapper = shallow(<Issues {...oneClosedIssue}/>);
  ...
  test(
    'should not pass auto-expand prop to closed panel when active panel present',
    () => {
      const wrapper = shallow(<Issues {...manyIssues}/>);
