...
describe('<AppealInfo/>', () => {
  ...
  test('should render LoadingIndicator when appeals loading', () => {
  ...
  test('should render a tabbed navigator', () => {
    const wrapper = shallow(<AppealInfo {...defaultProps}/>);
  ...
  test('should pass appeal as a prop to its children', () => {
    const children = (<span className="test">Child Goes Here</span>);
    const props = merge({}, { children }, defaultProps);
    const wrapper = shallow(<AppealInfo {...props}/>);
  ...
  test('should have access to the appeal id in route params', () => {
    const wrapper = shallow(<AppealInfo {...defaultProps}/>);
    const appealId = wrapper.instance().props.params.id;
    expect(appealId).to.equal(appealIdParam);
  });

  test('should render no records warning when user forbidden', () => {
  ...
  test(
    'should render no records warning when RECORD_NOT_FOUND_ERROR present',
    () => {
  ...
  test('should render system down message when VALIDATION_ERROR present', () => {
  ...
  test(
    'should render system down message when BACKEND_SERVICE_ERROR present',
    () => {
  ...
  test(
    'should render system down message when FETCH_APPEALS_ERROR present',
    () => {
  ...
  test('should render appeals down message when other error present', () => {
