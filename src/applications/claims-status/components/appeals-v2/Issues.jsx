...
const Issues = ({ issues, isAppeal }) => {
  ...
  return (
    <div className="issues-container">
      ...
      >
        <div>
          It may look different than the way you identified the issues on your
          Board Appeal request (VA Form 10182). The ultimate determination of
          which issues are properly on appeal will be made by a Veterans Law
          Judge based on careful review of the record and those issues will be
          clearly identified in the Board decision on your appeal.
        </div>
      </va-additional-info>
