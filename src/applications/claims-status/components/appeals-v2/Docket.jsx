...
function Docket({
  ...
  if (aod) {
    ...
    content = (
      <div>
        <p>
          Your appeal is Advanced on Docket. This could be because you are older
          than 75, because you are suffering a serious illness or are in
          financial distress, or for other sufficient cause.
        </p>
        <p>
          Advanced on Docket appeals are prioritized so that they are always at
          the front of the line. Your appeal will be sent to a judge as soon as
          it is ready for their review.
        </p>
      </div>
    );
    ...
    content = (
      <p>
        ...
        Court Remand appeals are prioritized so that they are always at the
        front of the line. Your appeal will be sent to a judge as soon as it is
    ...
    const yourPlaceText = frontOfDocket ? (
      <p>
        The Board is currently reviewing appeals from {docketMonthFormatted} or
        older. Your appeal is eligible to be sent to a judge when it is ready
        for their review.
      </p>
    ) : (
      <p>
        There are {total.toLocaleString()} appeals on the docket, not including
        Advanced on Docket and Court Remand appeals. Some of these appeals are
        not ready to be sent to a judge. A judge will begin work on your appeal
        when it is among the oldest appeals that are ready for their review. The
        Board is currently reviewing appeals from {docketMonthFormatted} or
        older.
      </p>
    );
    ...
    content = (
      <div>
        <p>
          The Board of Veterans’ Appeals reviews cases in the order they are
          received. When you completed a VA Form 9 in {form9DateFormatted}, your
          appeal was added to the Board’s docket, securing your spot in line.
        </p>
        {yourPlaceText}
        ...
        <p>
          ...
          or for other sufficient cause, you can apply to have your appeal{' '}
          <strong>Advanced on Docket</strong>. If you are older than 75, your
          appeal will receive this status automatically. Advanced on Docket
          appeals are prioritized so that they are always at the front of the
          line.
        </p>
        <p>
          <a
