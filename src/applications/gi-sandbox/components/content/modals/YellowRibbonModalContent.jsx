...
export default function YellowRibbonModalContent() {
  return (
    <div>
      {' '}
      ...
      <p>
        ...
        child using transferred benefits may be eligible if the service member
        is qualified at the 100% rate.) This information will be updated
        quarterly.
      </p>
    </div>
  );
