              ...
              fieldData={[
                {
                  ...
                  mapper: institution =>
                    naIfNull(institution.accreditationType),
                },
                {
                              ...
                              <div className="vads-u-flex--4">
                                <div className="caution-header">
                                  ...
                                  {hasFlags && (
                                    <span>
                                      This school has{' '}
                                      {institution.cautionFlags.length}{' '}
                                      cautionary warning
                                      {institution.cautionFlags.length > 1 &&
                                        's'}
                                    </span>
                                  )}
                                </div>
              ...
              fieldData={[
                {
                  ...
                  mapper: institution =>
                    +institution.complaints.mainCampusRollUp,
                },
              ]}
            />
            ...
            <CompareGrid
              ...
              fieldData={[
                ...
                },
                {
                  ...
                  mapper: institution =>
                    mapBoolField(institution.studentVeteran),
                },
                {
