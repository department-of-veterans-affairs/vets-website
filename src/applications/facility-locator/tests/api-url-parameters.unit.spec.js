...
describe('Locator url and parameters builder', () => {
   ...
   */
  test('With facilityType urgent_care and serviceType NonVAUrgentCare Should build a ccp request', () => {
   ...
   */
  test('With facilityType cc_pharmacy Should build a va ccp request ', () => {
    const result = resolveParamsWithUrl(
   ...
   */
  test('With facilityType health Should build a va request', () => {
   ...
   */
  test('With facilityType urgent_care and service type UrgentCare/undefined Should build a va request', () => {
   ...
   */
  test('With facilityType benefits and serviceType All, ApplyingForBenefits and VAHomeLoanAssistance  Should build a va request', () => {
   ...
   * VA cemeteries
   */
  test('With facilityType cemetery Should build a va request', () => {
    const result = resolveParamsWithUrl(
      undefined,
      'cemetery',
      undefined,
