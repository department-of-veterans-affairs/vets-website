 ...
 * @param {Object} options - Response options
 * @param {Array} options.topics - Array of topic objects with topicId and topicName
 ...
 * @param {Object} options - Response options
 * @param {string} options.appointmentId - Unique identifier for the appointment
 * @param {string} options.startUTC - Start date and time (UTC, ISO8601)
 * @param {string} options.endUTC - End date and time (UTC, ISO8601)
 * @param {string} options.agentId - Unique identifier for the agent
 * @param {string} options.agentNickname - Agent's display name
 * @param {number} options.appointmentStatusCode - Status code for the appointment
 * @param {string} options.appointmentStatus - Human-readable status
 * @param {string} options.cohortStartUtc - Cohort start date (UTC, ISO8601)
 * @param {string} options.cohortEndUtc - Cohort end date (UTC, ISO8601)
 * @returns {Object} Appointment details success response
 */
