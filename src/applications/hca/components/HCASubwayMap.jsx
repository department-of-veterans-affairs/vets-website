    ...
    <div className="process schemaform-process">
      <ol>
        <li className="process-step list-one">
          ...
          <p>
            Make sure you meet our eligibility requirements for enrollment
            before you apply.
          </p>
          <p>
        ...
        <li className="process-step list-two">
          ...
          <ul>
            ...
            <li>
              ...
              through a spouse or significant other. This also includes
          ...
          <ul>
            <li>
              ...
              spouse, and your dependents. This includes income from a job and
              any other sources. Gross household income is your income before
