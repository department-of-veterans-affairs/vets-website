...
const FinancialConfirmation = ({ goBack, goForward }) => (
  <va-alert
    status="info"
  ...
  >
    ...
    <p>
      <strong>If you’re eligible based on enhanced eligibility status,</strong>{' '}
      you don’t have to share your financial information for eligibility. But if
      you don’t share this information, we may not be able to decide if you
