...
const DependentList = ({ labelledBy, list, onDelete }) => {
      ...
      >
        ...
        <span className="vads-u-flex--auto">
          ...
          >
            ...
            />{' '}
            Delete <span className="sr-only">{normalizedFullName}</span>
          </button>
        </span>
      </li>
    );
  ...
  return (
    <>
      ...
      <VaModal
        modalTitle="Are you sure you want to remove this dependent?"
        primaryButtonText="Yes, remove this dependent"
