...
const template = (props, title, content, submissionMessage) => {
  const { name, email, response } = props;
  ...
  return (
    <div className="confirmation-page">
      ...
      <div className="confirmation-guidance-container">
        ...
        <ol className="process-steps">
          ...
          <li className="process-step list-three">
            ...
            <p>
              ...
              the <strong>My VA</strong> link near the top right of any VA.gov
              page. You’ll find your application status information in the{' '}
              <strong>Your Applications</strong> section of you homepage.
            </p>
            <p>
              <strong>Please note: </strong>
              Your application status may take some time to appear on our
              homepage. If you don’t see it there right away, please check back
              later.
            </p>
          </li>
        </ol>
        ...
        <p className="confirmation-guidance-message">
          Please call <a href="tel:+18772228387">877-222-8387</a> and select 2.
