...
function completePersonalInformation(client, data) {
  client
    ...
    .fill(
      'input[name="root_veteranFullName_middle"]',
...
function completeBirthInformation(client, data) {
  client
    ...
    .fill(
      ...
      data['view:placeOfBirth'].cityOfBirth,
    )
    .selectDropdown(
      'root_view:placeOfBirth_stateOfBirth',
      data['view:placeOfBirth'].stateOfBirth,
    );
}
...
function completeDemographicInformation(client, data) {
  client
    ...
    .click(
      'input[name="root_view:demographicCategories_isAmericanIndianOrAlaskanNative"]',
    )
    .click(
      'input[name="root_view:demographicCategories_isBlackOrAfricanAmerican"]',
    )
    .click(
      'input[name="root_view:demographicCategories_isNativeHawaiianOrOtherPacificIslander"]',
    )
    .click('input[name="root_view:demographicCategories_isAsian"]')
    .click('input[name="root_view:demographicCategories_isWhite"]')
    .click(
      'input[name="root_view:demographicCategories_isSpanishHispanicLatino"]',
    );
}
...
function completeVeteranAddress(client, data) {
  client
    ...
    .fill(
      'input[name="root_veteranAddress_street3"]',
      data.veteranAddress.street3,
    )
...
function completeVeteranContactInformation(client, data) {
  client
    ...
    .setValue(
      'input[name="root_view:emailConfirmation"]',
      data['view:emailConfirmation'],
    )
...
function completeVaBenefits(client, data) {
  client.selectRadio('root_vaCompensationType', data.vaCompensationType);
}

function completeFinancialDisclosure(client) {
  client.click('input#root_discloseFinancialInformationYes');
}
...
function completeSpouseInformation(client, data) {
  client
    ...
    .fill(
      'input[name="root_spouseFullName_middle"]',
      data.spouseFullName.middle,
    )
  ...
  client.expect
    .element(
      'label[for="root_view:spouseContactInformation_spouseAddress_country"]',
    )
    .to.be.visible.before(Timeouts.slow);

  client
    .fill(
      'input[name="root_view:spouseContactInformation_spouseAddress_street"]',
      data['view:spouseContactInformation'].spouseAddress.street,
    )
    .fill(
      'input[name="root_view:spouseContactInformation_spouseAddress_street2"]',
      data['view:spouseContactInformation'].spouseAddress.street2,
    )
    .fill(
      'input[name="root_view:spouseContactInformation_spouseAddress_street3"]',
      data['view:spouseContactInformation'].spouseAddress.street3,
    )
    .fill(
      'input[name="root_view:spouseContactInformation_spouseAddress_city"]',
      data['view:spouseContactInformation'].spouseAddress.city,
    )
    .selectDropdown(
      'root_view:spouseContactInformation_spouseAddress_country',
      data['view:spouseContactInformation'].spouseAddress.country,
    )
    .selectDropdown(
      'root_view:spouseContactInformation_spouseAddress_state',
      data['view:spouseContactInformation'].spouseAddress.state,
    )
    .fill(
      'input[name="root_view:spouseContactInformation_spouseAddress_postalCode"]',
      data['view:spouseContactInformation'].spouseAddress.postalCode,
    )
    .click('input#root_cohabitedLastYearNo')
    .click('input#root_provideSupportLastYearYes')
    .fill(
      'input[name="root_view:spouseContactInformation_spousePhone"]',
      data['view:spouseContactInformation'].spousePhone,
    );
}
...
function completeAnnualIncomeInformation(client, data) {
  client
    ...
    .setValue(
      'input[name="root_view:spouseIncome_spouseGrossIncome"]',
      data['view:spouseIncome'].spouseGrossIncome,
    )
    .setValue(
      'input[name="root_view:spouseIncome_spouseNetIncome"]',
      data['view:spouseIncome'].spouseNetIncome,
    )
    .setValue(
      'input[name="root_view:spouseIncome_spouseOtherIncome"]',
      data['view:spouseIncome'].spouseOtherIncome,
    )
    .setValue(
      'input[name="root_dependents_0_grossIncome"]',
      data.dependents[0].grossIncome,
    )
    .setValue(
      'input[name="root_dependents_0_netIncome"]',
      data.dependents[0].netIncome,
    )
    .setValue(
      'input[name="root_dependents_0_otherIncome"]',
      data.dependents[0].otherIncome,
    );
}

function completeDependentInformation(client, data) {
  client.click('input#root_view\\:reportDependentsYes');

  client.expect
    .element('label[for="root_dependents_0_fullName_first"]')
    .to.be.visible.before(Timeouts.normal);
  client
    .selectDropdown(
      'root_dependents_0_dependentRelation',
      data.dependents[0].dependentRelation,
    )
    .fillDate('root_dependents_0_dateOfBirth', data.dependents[0].dateOfBirth)
    .fillDate(
      'root_dependents_0_becameDependent',
      data.dependents[0].becameDependent,
    )
    .setValue(
      'input[name="root_dependents_0_fullName_first"]',
      data.dependents[0].fullName.first,
    )
    .setValue(
      'input[name="root_dependents_0_fullName_middle"]',
      data.dependents[0].fullName.middle,
    )
    .setValue(
      'input[name="root_dependents_0_fullName_last"]',
      data.dependents[0].fullName.last,
    )
    .selectDropdown(
      'root_dependents_0_fullName_suffix',
      data.dependents[0].fullName.suffix,
    )
    .setValue(
      'input[name="root_dependents_0_socialSecurityNumber"]',
      data.dependents[0].socialSecurityNumber,
    )
    .setValue(
      'input[name="root_dependents_0_dependentEducationExpenses"]',
      data.dependents[0].dependentEducationExpenses,
    )
...
function completeDeductibleExpenses(client, data) {
  client
    .setValue(
      'input[name="root_deductibleMedicalExpenses"]',
      data.deductibleMedicalExpenses,
    )
    .setValue(
      'input[name="root_deductibleFuneralExpenses"]',
      data.deductibleFuneralExpenses,
    )
    .setValue(
      'input[name="root_deductibleEducationExpenses"]',
...
function completeInsuranceInformation(client, data) {
  client
    ...
    .setValue(
      'input[name="root_providers_0_insuranceName"]',
      data.providers[0].insuranceName,
    )
    .setValue(
      'input[name="root_providers_0_insurancePolicyHolderName"]',
      data.providers[0].insurancePolicyHolderName,
    )
    .setValue(
      'input[name="root_providers_0_insurancePolicyNumber"]',
      data.providers[0].insurancePolicyNumber,
    )
    .setValue(
      'input[name="root_providers_0_insuranceGroupCode"]',
      data.providers[0].insuranceGroupCode,
    );
}
...
function completeVaInsuranceInformation(client, data) {
  client
    .selectDropdown(
      ...
      data['view:preferredFacility']['view:facilityState'],
    )
    .selectDropdown(
      'root_view:preferredFacility_vaMedicalFacility',
      data['view:preferredFacility'].vaMedicalFacility,
    )
