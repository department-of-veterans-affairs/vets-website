...
const expectedOutputs = {
  [HCA_ENROLLMENT_STATUSES.activeDuty]:
    '<div class="usa-alert usa-alert-warning" role="alert"><div class="usa-alert-body"><div class="usa-alert-text"><div><h2 class="usa-alert-heading">Our records show that you’re an active-duty service member</h2><p><strong>You applied on: </strong>April 24, 2019</p></div></div></div></div>',
  [HCA_ENROLLMENT_STATUSES.canceledDeclined]:
    '<div class="usa-alert usa-alert-warning" role="alert"><div class="usa-alert-body"><div class="usa-alert-text"><div><h2 class="usa-alert-heading">Our records show you chose to cancel or decline VA health care</h2><p><strong>You applied on: </strong>April 24, 2019</p><p>At some time in the past, we offered you enrollment in VA health care, but you declined it. Or you enrolled, but later canceled your enrollment.</p></div></div></div></div>',
  ...
  [HCA_ENROLLMENT_STATUSES.ineligFugitiveFelon]:
    '<div class="usa-alert usa-alert-warning" role="alert"><div class="usa-alert-body"><div class="usa-alert-text"><div><h2 class="usa-alert-heading">We determined that you don’t qualify for VA health care based on your past application</h2><p><strong>You applied on: </strong>April 24, 2019</p></div></div></div></div>',
  ...
  [HCA_ENROLLMENT_STATUSES.nonMilitary]:
    '<div class="usa-alert usa-alert-warning" role="alert"><div class="usa-alert-body"><div class="usa-alert-text"><div><h2 class="usa-alert-heading">We see that you aren’t a Veteran or service member</h2></div></div></div></div>',
  [HCA_ENROLLMENT_STATUSES.pendingMt]:
    '<div class="usa-alert usa-alert-warning" role="alert"><div class="usa-alert-body"><div class="usa-alert-text"><div><h2 class="usa-alert-heading">We need more information to complete our review of your VA health care application</h2><p><strong>You applied on: </strong>April 24, 2019</p><p>We need you to submit a financial disclosure so we can determine if you’re eligible for VA health care based on your income.</p></div></div></div></div>',
  [HCA_ENROLLMENT_STATUSES.pendingOther]:
    '<div class="usa-alert usa-alert-warning" role="alert"><div class="usa-alert-body"><div class="usa-alert-text"><div><h2 class="usa-alert-heading">We’re reviewing your application</h2><p><strong>You applied on: </strong>April 24, 2019</p><p>We’re in the process of verifying your military service. We’ll contact you by mail if we need you to submit supporting documents (like your DD214 or other discharge papers or separation documents).</p></div></div></div></div>',
