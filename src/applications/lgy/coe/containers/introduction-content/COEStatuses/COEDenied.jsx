...
const COEDenied = () => (
  <>
    <va-alert status="info">
      <h3 slot="headline">We denied your request for a COE</h3>
      <div>
    ...
    <div>
      ...
      <a href="#">Learn about VA decison reviews and appeals</a>
    </div>
    <div>
      ...
      <a href="#">Check your VA claim or appeal status</a>
    </div>
    <div className="vads-u-margin-bottom--4">
      ...
      <a href="#">See frequently asked questions about decision reviews</a>
    </div>
  </>
);
