...
Each form has a content widget that controls the "Submit online" link on its Drupal CMS "about" page (e.g., `/find-forms/about-form-21-0779/`). These widgets check feature flags to show or hide the digital form link, preventing broken links when forms are toggled off.
