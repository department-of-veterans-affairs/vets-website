...
/**
 * Schema for claimant's mailing address
 */
export const claimantAddressSchema = z.object({
  street: z
    .string()
...
/**
 * Page schema for claimant address page
 */
export const claimantAddressPageSchema = z.object({
  claimantAddress: claimantAddressSchema,
});
