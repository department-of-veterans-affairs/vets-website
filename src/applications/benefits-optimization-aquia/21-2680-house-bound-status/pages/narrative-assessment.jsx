 ...
 */
const NarrativeAssessmentPage = ({ data, goBack, goForward, updatePage }) => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      <fieldset className="vads-u-margin-y--2">
        ...
        <p>
          Provide a comprehensive narrative assessment and evaluate locomotion
          needs.
        </p>
        ...
        {localData.locomotionOther && (
          <va-text-input
            ...
            onInput={e =>
              handleFieldChange('locomotionOtherDescription', e.target.value)
            }
        ...
        <va-radio
          ...
          onVaValueChange={e => handleFieldChange('prognosis', e.detail.value)}
