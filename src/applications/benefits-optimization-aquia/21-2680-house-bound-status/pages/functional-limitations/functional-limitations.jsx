 ...
 */
export const FunctionalLimitationsPage = ({
  data,
  setFormData,
  goForward,
  goBack,
  ...
  return (
    <PageTemplate
      ...
      goForward={goForward}
      goBack={goBack}
      sectionName="functionalLimitations"
      ...
      defaultData={{
        ...
        assistanceHousekeeping: false,
        assistanceFinancial: false,
        assistanceSupervision: false,
      }}
    >
        ...
        <>
          <fieldset className="vads-u-margin-y--2">
            ...
            >
              ...
              />
              <va-radio-option
                label="No, requires human assistance"
                value="no"
              />
            </va-radio>
