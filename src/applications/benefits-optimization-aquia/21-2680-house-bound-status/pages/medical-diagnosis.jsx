 ...
 */
const MedicalDiagnosisPage = ({ data, goBack, goForward, updatePage }) => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      <fieldset className="vads-u-margin-y--2">
        ...
        <p>
          List all medical conditions affecting the patient’s ability to perform
          activities of daily living or that result in being housebound.
        </p>
        ...
        {localData.requiresNursingHome === 'yes' && (
          <va-alert status="info" show-icon class="vads-u-margin-top--2">
            <p className="vads-u-margin--0">
              <strong>Note:</strong> If nursing home care is required, VA Form
              21-0779 (Request for Nursing Home Information in Connection with
              Claim for Aid and Attendance) must also be completed.
            </p>
          </va-alert>
        )}
      </fieldset>
