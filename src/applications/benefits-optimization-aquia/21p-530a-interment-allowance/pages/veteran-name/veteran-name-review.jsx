...
/**
 * Review page component for veteran name.
 * Displays the deceased Veteran's name information.
 *
 * @component
 ...
 */
export const VeteranNameReviewPage = ({ data, editPage, title }) => {
...
VeteranNameReviewPage.propTypes = {
