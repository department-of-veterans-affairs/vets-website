...
describe('21-0779 App', () => {
  ...
  const appLocation = {
    ...
    action: 'POP',
    key: null,
    basename: '/nursing-home-information-form-21-0779',
    query: '{}',
  };
  ...
  describe('Feature Toggle Loading States', () => {
    ...
    describe('when loading is false (fetch completed)', () => {
      ...
      it('should redirect when formEnabled is false', () => {
        ...
        expect(replaceStub.calledWith('/find-forms/about-form-21-0779/')).to.be
          .true;
      });
      ...
      it('should redirect when formEnabled is undefined (flag missing)', () => {
        ...
        // eslint-disable-next-line camelcase
        storeData.featureToggles.form_0779_enabled = undefined;
