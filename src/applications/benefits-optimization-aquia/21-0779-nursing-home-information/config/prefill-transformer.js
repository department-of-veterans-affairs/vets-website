/**
 * @fileoverview Prefill transformer for VA Form 21-0779 Nursing Home Information
 * @module config/prefill-transformer
 *
 * This module transforms user profile data from the VA.gov user account into
 * structured form data that can be used to prefill the 21-0779 Nursing Home
 * Information form. The transformer extracts personal information, contact details,
 * and mailing address from the user's profile and formats them according to the
 * form's data structure requirements.
 *
 * The form is used by Veterans to provide information about nursing home care
 * and related benefits eligibility.
 */

/**
 * Transforms user profile data into prefilled form data for the 21-0779 form.
 *
...
export default function prefillTransformer(pages, formData, metadata, state) {
  ...
  if (profile.dob || profile.birthDate) {
    // Profile may have birthDate in different formats
