...
```bash
# Watch only this application (faster rebuilds)
yarn watch --env entry=21-4192-employment-information

# Run unit tests
yarn test:unit --app-folder 21-4192-employment-information

# Run Cypress tests
yarn cy:run --spec "src/applications/benefits-optimization-aquia/21-4192-employment-information/tests/*.cypress.spec.js"
```
