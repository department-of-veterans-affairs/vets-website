...
describe('TermsOfUse', () => {
  ...
  it('should call `/decline` when `Decline and sign out button` is clicked', async () => {
    ...
    global.window.location = `https://dev.va.gov/terms-of-use/?ssoeTarget=${redirectUrl}&terms_code=${termsCode}`;
  ...
  it('should redirect to the `ssoeTarget`', async () => {
    const redirectUrl = `https://dev.va.gov/auth/login/callback/?type=idme`;
    global.window.location = `https://dev.va.gov/terms-of-use/?ssoeTarget=${redirectUrl}`;
