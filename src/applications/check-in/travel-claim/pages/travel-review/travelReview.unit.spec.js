  ...
  describe('Review page', () => {
    ...
    it('displays single claimList', () => {
      ...
      expect(component.getByTestId('claim-list')).to.contain.text(
        'Mileage-only reimbursement 1 appointment at test facility',
      );
    });
    it('displays multi claimList', () => {
      ...
      expect(component.getByTestId('claim-list')).to.contain.text(
        'Mileage-only reimbursement 1 appointment at test facility, and 3 appointments at another test facility',
      );
    });
  });
});
