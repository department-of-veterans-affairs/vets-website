        ...
        <DowntimeWindowAlert appTitle="Travel Pay">
          <>
            ...
            <div className="vads-u-margin-bottom--4">
              ...
              />
              <p>
                <strong>Note:</strong> Even if you already set up direct deposit
                for your VA benefits, you’ll need to set up another direct
                deposit for VA travel pay reimbursements.
              </p>
            </div>
            <va-need-help>
              <div slot="content">
