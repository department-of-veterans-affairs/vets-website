...
export default function ClaimStatusExplainer() {
  return (
    <div>
      <main>
        <article className="row">
          <div className="vads-l-row vads-u-margin-x--neg2p5">
            <div className="vads-l-col--8 vads-u-padding-x--2p5 medium-screen:vads-l-col--8">
              ...
              <div>
                <p>
                  VA uses many statuses to track claims from before you submit
                  to after you receive payment. This page provides descriptions
                  for what each status means. If you continue to have questions
                  about your claim, please contact your local VA Medical Center
                  (VAMC) and ask to speak with the Beneficiary Travel
                  department.
                </p>
                <p>
                ...
                <h2>Saved or Incomplete</h2>
                <p>
                  These are claims that the Beneficiary Travel office cannot
                  process. Either you have not submitted the claim, or you
                  submitted a claim without required information. This category
                  of claim statues includes:
                </p>
                <ul>
                  <li>
                    <b>Incomplete — </b>
                    You submitted a claim without required expense information.
                    You must provide the required information for BTSSS to
                    process the claim.
                  </li>
                  <li>
                    <b>Saved — </b>
                    You saved changes to your claim, but you did not submit it
                    to BTSSS for review. Submit the claim so BTSSS can begin
                    processing your claim.
                  </li>
                </ul>

                <h2>Under VA Review</h2>
                <p>
                ...
                <ul>
                  <li>
                    <b>In Process — </b>
                    You submitted a claim, and now BTSSS is reviewing your
                    claim.
                  </li>
                  <li>
                    <b>Claim Submitted — </b>
                  ...
                  <li>
                    ...
                    <ul>
                      ...
                      <li>
                        Your travel does not meet the eligibility requirements
                        for detailed information about your claim, contact your
                        local VAMC and ask for the Beneficiary Travel
                        department.
                      </li>
                    </ul>
                  </li>
                  ...
                  <li>
                    ...
                    your claim on hold and tell you what additional information
                    is required. For more information about your claim, please
                ...
                <ul>
                  <li>
                    ...
                    claim does not qualify for a full reimbursement. Instead,
                    they approved a partial payment and sent a Partial Payment
                  ...
                  <li>
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        the VA clinic you went to did not enter it or you
                  ...
                  <li>
                    ...
                    The Travel Clerk approved your claim for payment. The
                    payment is pending and has not been paid.
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    The Financial Service Center (FSC) rejected payment. You
                    will not be able to appeal this decision. For more detailed
                  ...
                  <li>
                    ...
                    submitter. Note that reimbursements for claims submitted by
                    a Caregiver on behalf of a Veteran claimant are sent to the
