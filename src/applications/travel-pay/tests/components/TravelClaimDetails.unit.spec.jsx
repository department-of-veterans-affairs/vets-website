...
describe('TravelClaimDetails', () => {
  ...
  it('Successfully renders', () => {
    ...
    expect(
      screen.getByText(
        /If you're eligible for reimbursement, we'll deposit your funds in your bank account./i,
      ),
    );
    expect(
      screen.getByText(
        /Even if you already set up direct deposit for your VA benefits, you'll need to set up another direct deposit for VA travel pay./i,
      ),
    );
  });
