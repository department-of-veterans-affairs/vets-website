...
describe('TravelClaimDetailsContent', () => {
  ...
  beforeEach(() => {
    ...
    // Return action objects for the stubs
    getClaimDetailsStub.returns({ type: 'GET_CLAIM_DETAILS' });
    getAppointmentDataByDateTimeStub.returns({
      type: 'GET_APPOINTMENT_DATA_BY_DATETIME',
    });
  });
