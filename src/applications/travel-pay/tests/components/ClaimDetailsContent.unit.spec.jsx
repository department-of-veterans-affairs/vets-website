...
describe('ClaimDetailsContent', () => {
  ...
  describe('Complex claims feature', () => {
    ...
    describe('Must continue with BTSSS', () => {
      it('does not render complete and file link when complexClaimsToggle', () => {
        renderWithStoreAndRouter(
          <ClaimDetailsContent
            {...claimDetailsProps}
            claimStatus="Saved"
      ...
      it('renders the BTSSS link', () => {
        ...
        expect($('va-link[text="Continue and file your claim in BTSSS"]')).to
          .exist;
      });

      it('renders the correct content when the appointment date is out of bounds', () => {
        const screen = renderWithStoreAndRouter(
          <ClaimDetailsContent
            {...claimDetailsProps}
            claimStatus="Incomplete"
      ...
      it('renders the correct content when the appointment date is within bounds', () => {
        const screen = renderWithStoreAndRouter(
          <ClaimDetailsContent
            {...claimDetailsProps}
            claimStatus="Incomplete"
