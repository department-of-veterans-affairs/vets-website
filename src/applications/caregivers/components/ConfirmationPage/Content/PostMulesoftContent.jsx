...
import ConfirmationScreenView from '../ConfirmationScreenView';
import ConfirmationPrintView from '../ConfirmationPrintView';

const PostMulesoftContent = ({ form }) => {
...
PostMulesoftContent.propTypes = {
  form: PropTypes.object,
};

export default PostMulesoftContent;
