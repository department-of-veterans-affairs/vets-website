// responses from fetchFacilities function that formats the facility data

// Facility that does not offer caregiver support and is not a parent facility
...
// Facility that offers caregiver support and is not a parent facility
...
// Facility that offers caregiver support and is a parent facility
...
// Facility with address object with empty strings
const fetchFacilityWithoutAddress = {
  id: 'vha_568PB',
...
// Facility that does not offer caregiver support and is a parent facility
// As of this commit vha_358 is the only known parent facility that does not offer caregiver servies
...
// Facility responses from fetchFacilities with included metadata used for pagination
...
export const mockFetchFacilitiesReponseWithoutAddress = {
  facilities: [fetchFacilityWithoutAddress],
  meta,
};
