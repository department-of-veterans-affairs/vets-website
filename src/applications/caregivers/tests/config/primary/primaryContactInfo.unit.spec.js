...
describe('CG PrimaryCaregiverContactInfo config', () => {
  const middleware = [];
  ...
  it('should not submit empty form', () => {
    ...
    const formDOM = view.container;
    const selectors = {
      street: formDOM.querySelector('#root_primaryAddress_street'),
      city: formDOM.querySelector('#root_primaryAddress_city'),
      state: formDOM.querySelector('#root_primaryAddress_state'),
      postalCode: formDOM.querySelector('#root_primaryAddress_postalCode'),
  ...
  it('should submit with valid data', () => {
    ...
    simulateInputChange(formDOM, '#root_primaryAddress_city', 'Washington');
    simulateInputChange(formDOM, '#root_primaryAddress_state', 'DC');
    simulateInputChange(formDOM, '#root_primaryAddress_postalCode', '20005');
    simulateInputChange(
      formDOM,
      '#root_primaryPrimaryPhoneNumber',
      '8008271000',
    );
    simulateInputChange(formDOM, '#root_primaryVetRelationship', 'Daughter');
