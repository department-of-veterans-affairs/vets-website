...
describe('CG SecondaryTwoCaregiverContactInfo config', () => {
  const middleware = [];
  ...
  it('should not submit empty form', () => {
    ...
    const formDOM = view.container;
    const selectors = {
      street: formDOM.querySelector('#root_secondaryTwoAddress_street'),
      city: formDOM.querySelector('#root_secondaryTwoAddress_city'),
      state: formDOM.querySelector('#root_secondaryTwoAddress_state'),
      postalCode: formDOM.querySelector('#root_secondaryTwoAddress_postalCode'),
  ...
  it('should submit with valid data', () => {
    ...
    simulateInputChange(formDOM, '#root_secondaryTwoAddress_state', 'DC');
    simulateInputChange(
      formDOM,
    ...
    simulateInputChange(
      formDOM,
      '#root_secondaryTwoPrimaryPhoneNumber',
      '8008271000',
    );
    simulateInputChange(formDOM, '#root_secondaryTwoVetRelationship', 'Son');
