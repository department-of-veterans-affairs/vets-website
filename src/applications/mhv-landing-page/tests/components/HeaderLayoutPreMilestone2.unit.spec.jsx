...
import HeaderLayoutPreMilestone2 from '../../components/HeaderLayoutPreMilestone2';

const HeaderLayout = HeaderLayoutPreMilestone2;

describe('MHV Landing Page -- Header Layout (HeaderLayoutPreMilestone2)', () => {
