...
const ledeContent = `Welcome to the new home for My HealtheVet. Now you
  can manage your health care needs in the same place where you manage your
  other VA benefits and services—right here on VA.gov.`;

const HeaderLayoutPreMilestone2 = ({
...
HeaderLayoutPreMilestone2.propTypes = {
