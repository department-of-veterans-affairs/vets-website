...
const HeaderLayout = ({
  ...
  isCerner = false,
  showOhTransitionAlert = false,
}) => {
  // Determine which Cerner/OH content to show:
  // - If showOhTransitionAlert is true AND user has transitional facility, show blue alert
  // - Otherwise if isCerner, show existing inline link
  const showBlueAlert = showOhTransitionAlert && isCerner;
  const showYellowInlineLink = !showOhTransitionAlert && isCerner;
    ...
    <>
      ...
      >
        <div className="vads-l-col medium-screen:vads-l-col--8">
          ...
          {showBlueAlert && <OhTransitionAlert />}
          {showYellowInlineLink && (
...
HeaderLayout.propTypes = {
  ...
  showOhTransitionAlert: PropTypes.bool,
