...
export const pageTitle = 'Medical records';
  ...
  return (
    ...
    >
      ...
      <div className="vads-u-display--flex vads-u-flex-wrap--wrap">
        <h1 className="vads-u-margin-bottom--0">{pageTitle}</h1>
      ...
      >
        Soon, you’ll be able to find, print, and download your medical records
        on VA.gov
      </p>
      ...
      >
        ...
        <p className="vads-u-measure--5 medium-screen:vads-u-margin-bottom--3">
          You still have access to your medical records on the previous version
          of My HealtheVet. You can go back to that site at any time to download
          your VA health records (Blue Button®).
        </p>
        <p>
      ...
      <p className="vads-u-font-size--md vads-u-measure--4">
        We’re working on bringing all your VA medical records together in a
        single tool here on VA.gov. When it’s ready, you’ll be able to quickly
        find, print, or download these types of records:
      </p>
