...
class SaveInProgressIntroLink extends React.Component {
  render = savedForm => {
...
SaveInProgressIntroLink.propTypes = {
...
SaveInProgressIntroLink.defaultProps = {
...
export { SaveInProgressIntroLink };
