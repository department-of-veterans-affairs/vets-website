...
const VeteranInfoBoxReview = ({ data, goToPath, title }) => {
  ...
  return (
    <>
      <ReviewPageHeader title="veteran information" goToPath={onReviewClick} />
...
VeteranInfoBoxReview.propTypes = {
...
export default VeteranInfoBoxReview;
