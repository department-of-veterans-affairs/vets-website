...
import { sumValues, dateFormatter } from '../../utils/helpers';
...
const someInputObject = {
  data: {
    ...
    realEstateRecords: [
      {
        realEstateType: 'Vacation property',
        realEstateAmount: '350000.47',
      },
      {
        realEstateType: 'Single-family home',
        realEstateAmount: '450000.34',
      },
    ],
    additionalIncome: {
      spouse: {
    ...
    socialSecurity: {
      spouse: {
        socialSecAmt: '1400.45',
      },
      socialSecAmt: '1200.65',
    },
    benefits: {
      spouseBenefits: {
        compensationAndPension: '1000.09',
        education: '500.46',
      },
    },
    additionalData: {
    ...
    utilityRecords: [
      {
        ...
        monthlyUtilityAmount: '350.45',
      },
      {
        utilityType: 'Water',
        monthlyUtilityAmount: '75.43',
      },
      {
        utilityType: 'Cable',
        monthlyUtilityAmount: '275.47',
      },
    ],
    personalData: {
      dependents: [
        ...
        veteran: {
          employmentRecords: [
            ...
            },
            {
              ...
              to: '',
              isCurrent: true,
              employerName: 'Veteran Current Two',
            },
            {
              type: 'Full time',
              from: '2016-3-XX',
    ...
    selectedDebts: [
      ...
      },
      {
        ...
        id: 4,
        resolution: {
          resolutionType: 'Extended monthly payments',
          offerToPay: '100.54',
        },
      },
      {
...
describe('fsr transform information', () => {
  const submissionObj = JSON.parse(transform(null, someInputObject));
  describe('personal identification', () => {
