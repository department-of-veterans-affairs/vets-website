...
import * as spouseAdditionalIncome from './income/spouseAdditionalIncome';
import * as spouseBenefits from './income/spouseBenefits';
import * as spouseEmployment from './income/spouseEmployment';
import * as spousePreviousEmployment from './income/spousePreviousEmployment';
import * as dependents from './income/dependents';
import * as spouseInformation from './income/spouseInformation';
import * as spouseSocialSecurity from './income/spouseSocialSecurity';
