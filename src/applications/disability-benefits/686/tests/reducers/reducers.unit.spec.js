...
describe('authorization686 reducer', () => {
  ...
  test('should handle LOAD_30_PERCENT_DISABILITY_RATING_SUCCEEDED with authorization', () => {
    expectedState = {
      isLoading: false,
      isAuthorized: true,
      loadedStatus: true,
  ...
  test('should handle LOAD_30_PERCENT_DISABILITY_RATING_SUCCEEDED without authorization', () => {
    expectedState = {
      isLoading: false,
      isAuthorized: false,
      loadedStatus: true,
