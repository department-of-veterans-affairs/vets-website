    ...
    if (!isLoggedIn || !isVerified) {
      return (
        <div>
          ...
          <p>Please try again. If you have a premium DS Logon or My HealtheVet account, you can try signing in that way, or you can create an ID.me account to complete the verification process.</p>
          <button className="usa-button-primary" onClick={this.redirectToAuthentication}>Verify your Account</button>
        </div>
      );
    }
