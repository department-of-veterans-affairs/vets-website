...
class IntroductionPage extends React.Component {
  ...
  alertContent = () => (
    <div>
      ...
      <p>
        You need to let VA know when something changes in the status of your
        dependents that could affect their eligibility for benefits. Changes in
        status could include in the birth or adoption of a child, if you get
        married or divorced, if your child becomes seriously disabled, or if
        your child is over 18 years old and not attending school.
      </p>
    </div>
  );
  render() {
          ...
          <ol>
            <li className="process-step list-one">
              ...
              <ul>
                ...
                <li>
                  The Veteran's current and previous marriage details. If the
                  Veteran's spouse was married before, please include this
                  information too.
                </li>
                <li>
                  Details about the Veteran's unmarried child, include their
                  name, Social Security number, and date of birth
                </li>
              </ul>
              <p>
                <strong>
                  If you're claiming a dependent who's between the ages of 18
                  and 23 and attending school,
                </strong>{' '}
                you'll also need to fill out and turn in a Request for Approval
                of School Attendance (VA Form 21-764).
              </p>
              <div>
