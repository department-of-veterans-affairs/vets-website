...
import jerryUserData from './data/users/jerryUserData.json';
import noBatteriesData from './data/noBatteries.json';

const testConfig = createTestConfig(
  {
    dataPrefix: 'formData',

    dataSets: ['noBatteries'],
    ...
    setupPerTest: () => {
      cy.login();
      cy.route('GET', '/v0/user', jerryUserData);
      cy.route('GET', '/v0/in_progress_forms/MDOT', noBatteriesData);
