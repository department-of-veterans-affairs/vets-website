...
const alertContent = (
  <>
    <p>
      In most situations, you have one year from the date on your decision
      letter to request a decision review. The deadline to file may be different
      if you have a fiduciary claim, a{' '}
