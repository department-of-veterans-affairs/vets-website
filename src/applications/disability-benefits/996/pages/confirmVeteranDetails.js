...
const veteranDetailsDescription = data => {
  ...
  return (
    <>
      ...
      <br />
      <p>
        <strong>Note:</strong> If you need to update your presonal information,
        please call Veterans Benefits toll free at&nbsp;
        <a className="nowrap" href="tel:+01-800-827-1000">
          800-827-1000
        </a>
