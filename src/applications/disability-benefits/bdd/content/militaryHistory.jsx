...
export const SeparationLocationDescription = (
  <>
    ...
    <AdditionalInfo triggerText="What's this">
      <>
        <p>
          Your place of anticipated separation is th location where you expect
        ...
        Providing us with the separation location allow us to more easily gather
        details to help process your claim (such as the exact date you
        separated).
      </>
    </AdditionalInfo>
  </>
