...
export const privateRecordsChoiceHelp = (
  <AdditionalInfo triggerText="Which should I choose?">
    ...
    <p>
      ...
      computer with a fast Internet connection. The digital file could be
    ...
    <p>
      ...
      some time, and this could mean that it’ll take us longer to make a
      decision on your claim. You’ll need to first fill out an Authorization to
      Disclose Information to the VA (VA Form 21-4142) so we can request your
      records.
    </p>
    <p>
...
const PhoneViewField = ({ formData: phoneNumber = '', name }) => {
  ...
  const phoneString = `${firstPhoneString}-${middlePhoneString}-${
    lastPhoneString
  }`;
  return (
    <p>
