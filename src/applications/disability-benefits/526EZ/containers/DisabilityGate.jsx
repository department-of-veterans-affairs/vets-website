    ...
    return (
      <div className="usa-grid full-page-alert">
        <AlertBox
          isVisible
          headline="We're sorry"
          content="Our records show you don’t have any rated disabilities, so you can’t apply for increased compensation benefits at this time. If you think our records aren’t correct, please call Veterans Benefits Assistance at 800-827-1000, Monday – Friday, 8:00 a.m. to 9:00 p.m. ET."
          status="error"
        />
      </div>
    );
