  ...
  'review-and-submit': ({ afterHook }) => {
    cy.get('@testData').then(data => {
      if (
        ...
        // Verify the provider facility is listed on the review page
        cy.get('div[name="providerFacility"]', { timeout: 10000 })
          .should('be.visible')
          .within(() => {
            cy.contains('Name of private provider or hospital').should('exist');
          });
      }
    });
    afterHook(() => {
