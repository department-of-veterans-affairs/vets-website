...
Cypress.Commands.add('tabToStartForm2', () => {
...
Cypress.Commands.add('tabToContinueForm2', () => {
  ...
  */
  ...
  it('navigate through a maximal form', () => {
    cy.get('@testData').then(({ data }) => {
      ...
      // For some reason using `cy.tabToContinueForm2` here doesn't work. It
      // instead will skip ahead to the following page.
      cy.tabToElementAndPressSpace('button[type="submit"]');
