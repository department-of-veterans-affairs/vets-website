  ...
  describe('contactInformation page', () => {
    ...
    describe('updateFormData function', () => {
      ...
      describe('address line normalization', () => {
        it('should trim leading and trailing spaces from addressLine1', () => {
          const oldData = {
            mailingAddress: {
              'view:livesOnMilitaryBase': false,
              addressLine1: '',
        ...
        it('should collapse multiple consecutive spaces in addressLine1', () => {
          const oldData = {
            mailingAddress: {
              'view:livesOnMilitaryBase': false,
              addressLine1: '',
        ...
        it('should normalize addressLine2', () => {
          const oldData = {
            mailingAddress: {
              'view:livesOnMilitaryBase': false,
              addressLine2: '',
          ...
          expect(result.mailingAddress.addressLine2).to.equal('Apt 456');
        });

        it('should normalize addressLine3', () => {
          const oldData = {
            mailingAddress: {
              'view:livesOnMilitaryBase': false,
              addressLine3: '',
          ...
          expect(result.mailingAddress.addressLine3).to.equal('Building B');
        });

        it('should normalize all address lines simultaneously', () => {
          const oldData = {
            mailingAddress: {
              'view:livesOnMilitaryBase': false,
            },
        ...
        it('should not modify addressLine fields that are empty', () => {
          const oldData = {
            mailingAddress: {
              'view:livesOnMilitaryBase': false,
            },
          ...
          expect(result.mailingAddress.addressLine3).to.equal(undefined);
        });

        it('should handle address normalization with military auto-detection', () => {
          const oldData = {
            mailingAddress: {
              'view:livesOnMilitaryBase': false,
              city: '',
          ...
          // Should both normalize and auto-detect military
          expect(result.mailingAddress.addressLine1).to.equal(
            'PSC 123 Box 456',
          );
          expect(result.mailingAddress['view:livesOnMilitaryBase']).to.be.true;
        });
