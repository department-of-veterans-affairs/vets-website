...
describe('526 All Claims -- Ancillary forms wizard summary', () => {
  describe('depends', () => {
    test(
      'should return true if one of the ancillary forms questions is answered true',
      () => {
    ...
    test(
      'should return false if none of the ancillary forms questions is answered true',
      () => {
