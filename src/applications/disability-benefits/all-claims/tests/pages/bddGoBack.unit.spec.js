...
describe('526 bddGoBack page', () => {
  ...
  test('should show up when the service period confirmation question is not answered', () => {
    expect(depends(formData())).toBe(true);
  });

  test('should show up when the service period confirmation question is answered "no"', () => {
  ...
  test('should not show up when the service period confirmation question is answered "yes"', () => {
