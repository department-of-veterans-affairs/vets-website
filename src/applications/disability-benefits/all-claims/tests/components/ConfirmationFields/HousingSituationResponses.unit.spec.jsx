...
describe('all-claims <HousingSituationResponses>', () => {
  it('should render without errors', () => {
    const result = render(<HousingSituationResponses formData={formData} />);
  ...
  it('should handle missing data gracefully', () => {
    const result = render(<HousingSituationResponses formData={{}} />);
    expect(result.getByTestId('housing-situation-responses')).to.exist;
  });
});
