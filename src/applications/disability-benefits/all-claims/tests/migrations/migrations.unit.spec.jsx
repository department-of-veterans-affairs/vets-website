...
import paperSync4142 from '../../migrations/11-paper-sync-4142';
...
describe('526 v2 migrations', () => {
  ...
  describe('11-paper-sync-4142', () => {
    describe('when feature toggle is enabled and user has acknowledged old 4142', () => {
      it('should redirect to private medical records page and show new 4142 alert', () => {
        const savedData = {
          disability526Enable2024Form4142: true,
          'view:patient_acknowledgement': {
        ...
        const result = paperSync4142(savedData);
      ...
      it('should preserve all original data while adding new properties', () => {
        const savedData = {
          disability526Enable2024Form4142: true,
          'view:patient_acknowledgement': {
            'view:acknowledgement': true,
        ...
        expect(result.formData).to.deep.equal(savedData.formData);
        expect(result.metadata.existingProp).to.equal('value');
        expect(result.showNew4142AuthorizationAlert).to.be.true;
        expect(result.metadata.returnUrl).to.equal(
    ...
    describe('when conditions are not met', () => {
      it('should return original data when feature toggle is disabled', () => {
        const savedData = {
      ...
      it('should return original data when acknowledgement is false', () => {
        const savedData = {
          disability526Enable2024Form4142: true,
          'view:patient_acknowledgement': {
      ...
      it('should return original data when both conditions are false', () => {
        const savedData = {
          disability526Enable2024Form4142: false,
          'view:patient_acknowledgement': {
            'view:acknowledgement': false,
    ...
    describe('edge cases', () => {
      it('should return original data when patient acknowledgement is missing', () => {
        const savedData = {
          disability526Enable2024Form4142: true,
          metadata: {
            returnUrl: '/original-url',
      ...
      it('should return original data when view:acknowledgement property is missing', () => {
        const savedData = {
          disability526Enable2024Form4142: true,
          'view:patient_acknowledgement': {},
          metadata: {
      ...
      it('should handle undefined savedData gracefully', () => {
        expect(() => paperSync4142(undefined)).to.throw();
      });
    });
  });
});
