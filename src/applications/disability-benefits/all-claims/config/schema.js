...
const baseAddressWithOutRequiredDef = {
  type: 'object',
  properties: {
    country: {
      type: 'string',
...
const schema = {
  ...
  definitions: {
    ...
    centralMailAddress: baseAddressWithOutRequiredDef,
    addressWithNoRequires: baseAddressWithOutRequiredDef,
          ...
          properties: {
            ...
            source: {
              ...
              items: {
                ...
                address: {
                  $ref: '#/definitions/addressWithNoRequires',
                },
              },
            },
          },
