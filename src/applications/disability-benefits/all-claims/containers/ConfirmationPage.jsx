...
if (!environment.isProduction() && !environment.isStaging()) {
  // NOTE - to get this to work locally, comment out wizard reset in line 79 in `sessionStorage.removeItem(WIZARD_STATUS);`
  ...
  // mockData = require('../tests/fixtures/data/minimal-test.json');
