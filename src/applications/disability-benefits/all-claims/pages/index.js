...
import {
  uiSchema as recentEarnedIncomeUISchema,
  schema as recentEarnedIncomeSchema,
} from './recentEarnedIncome';
...
export const recentEarnedIncome = {
  uiSchema: recentEarnedIncomeUISchema,
  schema: recentEarnedIncomeSchema,
};
