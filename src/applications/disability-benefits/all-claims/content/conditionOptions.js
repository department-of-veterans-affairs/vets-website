export const conditionObjects = [
  ...
  { option: 'chronic myelogenous leukemia (CML)' },
  ...
  { option: 'frozen shoulder (adhesive capsulitis)', sideOfBody: true },
  { option: 'gallbladder cancer' },
  ...
  { option: 'interstitial lung disease (ILD), pneumonitis, or fibrosis' },
  ...
  { option: 'skin cancer (other than melanoma), extremities or trunk' },
  { option: 'skin cancer (other than melanoma), head or neck' },
  {
