  ...
  <div>
    <div>
      <p>
        ...
        Claim for Compensation, please call Veterans Benefits Assistance
        at <a href="tel:1-800-827-1000">1-800-827-1000</a>, Monday – Friday, 8:00
...
export const itfSuccess = (hasPreviousItf, expirationDate, prevExpirationDate) => {
  return (
    <div>
      <p>
        Thank you for submitting your Intent to File request for disability
        compensation. Your Intent to File will expire on {displayDate(expirationDate)}.
      </p>
      {hasPreviousItf &&
        <p>
          <strong>Please note:</strong> We found a previous Intent to File
          request in our records that expired on {displayDate(prevExpirationDate)}.
          This ITF might have been from an application you started, but didn’t
          finish before the ITF expired. Or, it could have been from a claim
  ...
  return (
    <div>
      <p>
        ...
        compensation. Your Intent to File will expire on {displayDate(expirationDate)}.
        You’ll need to submit your claim by this date in order to receive
