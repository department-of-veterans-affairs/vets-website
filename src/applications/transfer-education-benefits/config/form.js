...
// import fullSchema from 'vets-json-schema/dist/22-1990E-schema.json';
...
import fullSchema from '../22-1990E-schema.json';

// import fullSchema from 'vets-json-schema/dist/22-1990E-schema.json';

import manifest from '../manifest.json';

import IntroductionPage from '../containers/TOEIntroductionPage';
...
const formConfig = {
  ...
  trackingPrefix: 'transfer-education-benefits-',
  introduction: IntroductionPage,
  confirmation: ConfirmationPage,
  formId: '22-1990E',
  saveInProgress: {
    // messages: {
    //   inProgress: 'Your transfer education benefits application (22-1990E) is in progress.',
    //   expired: 'Your saved transfer education benefits application (22-1990E) has expired. If you want to apply for transfer education benefits, please start a new application.',
    //   saved: 'Your transfer education benefits application has been saved.',
    // },
  },
  version: 0,
  prefillEnabled: true,
  savedFormMessages: {
    notFound: 'Please start over to apply for transfer education benefits.',
    noAuth:
      'Please sign in again to continue your application for transfer education benefits.',
  },
  title: 'Complex Form',
  defaultDefinitions: {
    fullName,
