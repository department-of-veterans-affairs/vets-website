  ...
  return dispatch => {
    ...
    const response = {
      data: [
        ...
        //     ratingIssueProfileDate: '2025-10-17', // Today's date
        //     ratingIssueDiagnosticCode: '5260',
        //     ratingIssueSubjectText: 'Tinnitus (same day - blocked)',
        ...
        //       {
        //         id: null,
        //         approxDecisionDate: '2025-10-17', // TODAY - triggers blocking
        //       },
        //     ],
        ...
        //     ratingIssueSubjectText: 'Back condition (same day - blocked)',
        ...
        // PAST DATE ISSUE (selectable)
        {
          ...
          attributes: {
            ...
            ratingIssueSubjectText: 'Hypertension (selectable)',
        ...
        // YESTERDAY'S DATE ISSUE (selectable)
        {
          ...
          attributes: {
            ...
            ratingIssueProfileDate: '2025-10-16',
            ratingIssueDiagnosticCode: '6260',
            ratingIssueSubjectText: 'Hearing loss (selectable)',
            ...
            latestIssuesInChain: [
              {
                id: null,
                approxDecisionDate: '2025-10-16', // YESTERDAY - selectable
              },
            ],
    ...
    return apiRequest(apiUrl)
      .then(() => {
        ...
        console.log(
          '🔍 Supplemental Claims contestable issues response:',
          response,
        );
        // eslint-disable-next-line no-console
