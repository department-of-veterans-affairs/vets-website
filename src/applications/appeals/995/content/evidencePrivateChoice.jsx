  ...
  <div className="private-records-choice-help">
    <va-additional-info trigger="Which should I choose?">
      ...
      <p>
        ...
        a computer with a fast Internet connection. The digital file can only be
        uploaded as a {readableList(SUPPORTED_UPLOAD_TYPES, 'or')}.
      </p>
...
export const patientAcknowledgmentText = (
  <div className="patient-acknowldegment-help">
    <va-additional-info trigger="Read the full text.">
