    ...
    <Toggler toggleName={Toggler.TOGGLE_NAMES.scConfirmationUpdate}>
      ...
      <Toggler.Disabled>
        ...
        >
          ...
          <p>
            If we need more information, we’ll contact you to tell you what
            other information you’ll need to submit. We’ll also tell you if we
            need to schedule an exam for you.
          </p>
          <p>
          ...
          <p>
            If you requested a decision review and haven’t heard back from us
            yet, please don’t request another review. Call us instead.
          </p>
          <p>
          ...
          <p id="delay-note">
            <strong>Note</strong>: It may take 7 to 10 days for your
            Supplemental Claim request to appear online.
          </p>
        </ConfirmationDecisionReviews>
      </Toggler.Disabled>
    </Toggler>
