...
export const PrivacyActStatementContent = () => (
  <>
    <p>
      ...
      authorize to release personal information. In those cases, we may ask you
      to sign one authorization for each source and we may contact you again if
      we need you to sign more authorizations. We estimate that you will need an
      ...
      information unless a valid OMB control number is displayed. Valid OMB
      control numbers can be located on the{' '}
      <va-link
