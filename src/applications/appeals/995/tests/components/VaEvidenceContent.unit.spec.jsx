...
import { VaEvidenceContent } from '../../components/VAEvidenceContent';
...
describe('buildVaContent', () => {
  it('should render editable VA content', () => {
    ...
    const { container } = render(
      <VaEvidenceContent list={vaEvidence} showScNewForm testing />,
    );
  ...
  it('should render review-only VA content', () => {
    const vaEvidence = records().locations;
    const { container } = render(
      <VaEvidenceContent list={vaEvidence} showScNewForm reviewMode testing />,
    );
  ...
  it('should show missing location message with partial list', () => {
    const { container } = render(
      <div>
        <VaEvidenceContent list={['']} showScNewForm testing />
      </div>,
    );
