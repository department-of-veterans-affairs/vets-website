...
export const CONTESTABLE_ISSUES_API_NEW =
  '/supplemental_claims/contestable_issues/new';
// Evidence upload API - same endpoint as NOD
export const EVIDENCE_UPLOAD_API_NEW = '/v1/decision_review_evidence/new';
export const SUBMIT_URL_NEW = '/v1/supplemental_claims/new';
