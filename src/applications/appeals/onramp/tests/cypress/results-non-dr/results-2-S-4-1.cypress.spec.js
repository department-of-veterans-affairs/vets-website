...
const { RESULTS_2_S_4_1 } = RESULTS_NAME_MAP;

// Results 2.S.4.1: CUE / may have options outside of Decision Reviews (CFI)
// 1.1 - Yes
// 1.2 - Yes
// 1.3 - No
// 2.IS.1 - Yes
...
xdescribe('Decision Reviews Onramp', () => {
  describe('Results 2.S.4.1 (CFI)', () => {
    it('navigates through the flow forward and backward successfully', () => {
      ...
      h.selectRadio(Q_2_S_2_WITHIN_120_DAYS, 1);
      h.clickContinue();
