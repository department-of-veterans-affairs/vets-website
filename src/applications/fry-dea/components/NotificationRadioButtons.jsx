...
const NotificationRadioButtons = ({
  ...
  let informationSpan = '';
  let informationSpanId;
  if (informationMessage) {
    informationSpanId = `${id}-information-message`;
    informationSpan = (
      <MessageWrapper
        id={informationSpanId}
      ...
      >
        <div className="vads-u-background-color--primary-alt-lightest">
          <i
            ...
            aria-hidden="true"
          />{' '}
          <span className="sr-only">information</span> {informationMessage}
        </div>
      </MessageWrapper>
    );
  }
  ...
  const fieldsetClasses = classNames(
    ...
    'rb-input',
    {
      'rb-input-information': informationMessage,
...
NotificationRadioButtons.propTypes = {
  ...
  id: PropTypes.string,
  /**
   * Radio button group information message
   */
  informationMessage: PropTypes.string,
  /**
   * Radio button group loading message
   */
