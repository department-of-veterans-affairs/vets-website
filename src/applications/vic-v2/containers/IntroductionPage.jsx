  ...
  render() {
    ...
    const idProofed =
      ...
      user.profile.services.some(
        service => service === backendServices.IDENTITY_PROOFED,
      );
    const signedIn = user.login.currentlyLoggedIn;
    const accountBenefits = (
      <ul>
        <li>
          You can get your card sooner because we can confirm your Veteran
          status more quickly.
        </li>
        <li>
        ...
        <li>
          You can save your form in progress, and come back later to finish
          filling it out.
        </li>
      </ul>
    );
    const idProofingReqs = (
      <ul>
        <li>
          A smartphone (or a landline or mobile phone and a computer with an
          Internet connection)
        </li>
        <li>Your Social Security number</li>
        <li>
          Proof of your identity (which could be a driver’s license, a passport,
          or the ability to answer questions based on private and public data
          ...
          <ol>
            <li className="process-step list-one">
              ...
              <ul>
                <li>Your Social Security number</li>
                <li>
                  A digital copy of your DD214, DD256, DD257, or NGB22 that you
                  can upload. This could be a .pdf or other photo file format,
                  like a .jpeg or .png
                </li>
              ...
              <div className="vic-intro-indent">
                <div>
                  <h6>
                    The photo has to follow all the standards listed here. It
                    must:
                  </h6>
                </div>
                <ul>
                  <li>
                    Show a full front view of your face and neck (with no hat,
                    head covering, or headphones covering or casting shadows on
                    your hairline or face), <strong>and</strong>
                  </li>
                  <li>
                    Be cropped from your shoulders up (much like a passport
                    photo), <strong>and</strong>
                  </li>
                  <li>
                    Show you with your eyes open and a neutral expression,{' '}
                    <strong>and</strong>
                  </li>
                  <li>
                    Be taken in clothing you’d wear for a driver’s license
                    photo, <strong>and</strong>
                  </li>
                  <li>
                    Be a square size and have a white or plain-color background
                    (with no scenery or other people in the photo),{' '}
                    <strong>and</strong>
                  </li>
                  <li>
                    Show what you look like now (a photo taken sometime in the
                    last 10 years), <strong>and</strong>
                  </li>
                ...
                <img
                  ...
                  alt="placeholder"
                  src="/img/example-photo-1.png"
                />
                <img
                  className="example-photo"
                  alt="placeholder"
                  src="/img/example-photo-2.png"
                />
                <p>
                  <a
                    href="/veteran-id-card/how-to-upload-photo"
                    target="_blank"
                  >
            ...
            {!signedIn && (
              <li className="process-step list-two">
                ...
                <p>
                  When you’re signed in, we can verify your identity to make
                  sure you’re you. This also helps to keep your information
                  safe, and prevent fraud and identity theft.
                </p>
                <p>
                  Verifying your identity is a one-time process that’ll take
                  about 5-10 minutes. Once you’ve gone through the
                  identity-proofing process, you won't need to do it again. To
            ...
            <li className="process-step list-four">
              ...
              <p>
                We’ll review your application to check your eligibility. We may
                contact you if we have any questions or need more information.
              </p>
            </li>
            <li className="process-step list-five">
              ...
              <p>
                Once we approve your application, you should receive your
                Veteran ID Card by mail in about 60 days.
              </p>
            </li>
          </ol>
        </div>
