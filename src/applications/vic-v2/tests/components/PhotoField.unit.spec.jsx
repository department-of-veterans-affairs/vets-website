...
describe('<PhotoField>', () => {
  ...
  test('should render preview while processing', () => {
    const formContext = {};
    const uiSchema = {
      'ui:title': 'Title',
      'ui:options': {
  ...
  describe('onChange', () => {
    ...
    test('should set error for too small image', (done) => {
      const formContext = {};
      const uiSchema = {
        'ui:title': 'Title',
        'ui:options': {
    ...
    test('should set error for wrong type', (done) => {
      const formContext = {};
      const uiSchema = {
        'ui:title': 'Title',
        'ui:options': {
    ...
    test(
      'should set currentLayout state to crop_photo with valid file',
      (done) => {
        const formContext = {
  ...
  describe('screen reader path', () => {
    ...
    test('should set error for square image', (done) => {
      const formContext = {};
      const uiSchema = {
        'ui:title': 'Title',
        'ui:options': {
    ...
    test('should call uploadFile with valid image', (done) => {
      const formContext = {
        uploadFile: sinon.spy()
      };
      const uiSchema = {
  ...
  test('should render preview in review mode', () => {
    const formContext = {
      reviewMode: true
    };
    const uiSchema = {
  ...
  test('should revoke url on unmount', () => {
    const formContext = {};
    const uiSchema = {
      'ui:title': 'Title',
      'ui:options': {
  ...
  test('should recreate object url on blob change', () => {
    const formContext = {};
    const uiSchema = {
      'ui:title': 'Title',
      'ui:options': {
  ...
  test('should reset file on preview view', () => {
    const formContext = {};
    const uiSchema = {
      'ui:title': 'Title',
      'ui:options': {
