  ...
  describe('buildLevelOneLinks', () => {
            ...
            links: {
              ...
              columnThree: {
                ...
                img: {
                  alt: '',
                  src:
                    'https://www.va.gov/img/styles/3_2_medium_thumbnail/public/hub_promos/health-care.png',
                },
                link: {
                  href:
    ...
    it('should return the correct markup for a simple link section', () => {
      ...
      expect(buildLevelOneLinks(link)).to.deep.equal(
        '\n    <li>\n      <a class="vetnav-level1 medium-screen:vads-u-padding--2" data-e2e-id="find-a-va-location-undefined" href="https://www.va.gov/find-locations">Find a VA Location</a>\n    </li>\n  ',
      );
    });
  });
});
