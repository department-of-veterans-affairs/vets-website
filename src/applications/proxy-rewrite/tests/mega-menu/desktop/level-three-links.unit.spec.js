  ...
  describe('buildLinks', () => {
    it('should return the correct markup', () => {
      ...
      expect(buildLinks(links)).to.deep.equal([
        ...
        '\n        <li class="mm-link-container">\n          <a class="mm-links" data-e2e-id="refill-and-track-your-prescriptions-1" href="https://www.va.gov/health-care/refill-track-prescriptions" target="_self">Refill and track your prescriptions</a>\n        </li>\n      ',
      ]);
    });
  });
