...
import LevelThreeLinks from '../../../partials/mobile/header/mega-menu/level-three-links';
...
describe('mega menu - level three links', () => {
  describe('benefit hub links', () => {
    const sections = [headerFooterData.megaMenuData[0].menuSections[3]];
  ...
  describe('about va links', () => {
    const sections = headerFooterData.megaMenuData[1].menuSections;
