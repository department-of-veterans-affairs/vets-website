...
export const footerColumnData = {
  1: [
    ...
    {
      column: 1,
      href: '/centerforminorityveterans/',
      order: 3,
      target: '',
  ...
  bottom_rail: [
    ...
    {
      column: 'bottom_rail',
      href: 'https://department.va.gov/foia/',
      order: 3,
      target: null,
    ...
    {
      column: 'bottom_rail',
      href: '/veterans-portrait-project/',
      order: 12,
      target: null,
      ...
      menuSections: [
        {
          ...
          links: {
            ...
            columnThree: {
              img: {
                src:
                  '/img/styles/3_2_medium_thumbnail/public/hub_promos/health-care.png',
                alt: '',
              },
              link: {
                text: 'Coronavirus FAQs',
                href: '/coronavirus-veteran-frequently-asked-questions/',
              },
              description:
        ...
        },
        {
          ...
          links: {
            ...
            columnThree: {
              img: {
                src:
                  '/img/styles/3_2_medium_thumbnail/public/hub_promos/disability.png',
                alt: '',
              },
              link: {
        ...
        },
        {
          ...
          links: {
            ...
            columnThree: {
              img: {
                src:
                  '/img/styles/3_2_medium_thumbnail/public/hub_promos/education.png',
                alt: '',
              },
              link: {
        ...
        },
        {
          ...
          links: {
            ...
            columnThree: {
              img: {
                src:
                  '/img/styles/3_2_medium_thumbnail/public/hub_promos/careers.png',
                alt: '',
              },
              link: {
                text: 'VA for Vets',
        ...
        },
        {
          ...
          links: {
            ...
            columnThree: {
              img: {
                src:
                  '/img/styles/3_2_medium_thumbnail/public/hub_promos/pension.png',
                alt: '',
              },
              link: {
            ...
            columnTwo: {
              ...
              links: [
                ...
                },
                {
                  ...
                  href:
                    '/housing-assistance/disability-housing-grants/how-to-apply',
                },
              ],
            },
            columnThree: {
              img: {
                src:
                  '/img/styles/3_2_medium_thumbnail/public/hub_promos/housing.png',
                alt: '',
              },
              link: {
                text: 'National Call Center for Homeless Veterans',
                href: '/homeless/nationalcallcenter.asp',
              },
              description:
        ...
        },
        {
          ...
          links: {
            ...
            columnThree: {
              img: {
                src:
                  '/img/styles/3_2_medium_thumbnail/public/hub_promos/life-insurance.png',
                alt: '',
              },
              link: {
        ...
        },
        {
          ...
          links: {
            ...
            columnThree: {
              img: {
                src:
                  '/img/styles/3_2_medium_thumbnail/public/hub_promos/burials.png',
                alt: '',
              },
              link: {
        ...
        },
        {
          ...
          links: {
            ...
            columnThree: {
              img: {
                src:
                  '/img/styles/3_2_medium_thumbnail/public/hub_promos/records.png',
                alt: '',
              },
              link: {
        ...
        mainColumn: {
          ...
          links: [
            ...
            },
            {
              ...
              href: '/landing_organizations.htm',
            },
          ],
        },
        columnOne: {
