  ...
  if (seeAllLink) {
    return (
      <div className="panel-bottom-link">
        ...
        >
          {seeAllLink.text}
          <svg className="all-link-arrow" width="444.819" height="444.819" viewBox="0 0 444.819 444.819">
...
export const buildImageColumn = (
  ...
  if (!column) {
    return <div className="vads-u-display--block vetnav-panel vetnav-panel--submenu column-three"></div>;
  }
  ...
  return (
    ...
    >
      ...
      <ul id={`vetnav-${columnLabel}-col`}>
        <li className="panel-top-link"></li>
