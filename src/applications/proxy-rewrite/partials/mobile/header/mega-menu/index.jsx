        ...
        <Fragment key={index}>
          <li className="vads-u-background-color--primary-dark vads-u-margin--0 vads-u-margin-bottom--1 vads-u-width--full vads-u-font-weight--bold">
            <button
              ...
              className="header-menu-item-button level1 vads-u-background-color--primary-dark vads-u-display--flex vads-u-justify-content--space-between vads-u-width--full vads-u-text-decoration--none vads-u-margin--0 vads-u-padding--3 vads-u-color--white"
