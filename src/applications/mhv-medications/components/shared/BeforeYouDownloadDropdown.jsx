  ...
  const content = useMemo(() => {
    if (page === pageType.DETAILS) {
      return (
        <ul>
          <li>
            <strong>If you print or download this page,</strong> we’ll include a
    ...
    return (
      <>
        ...
        downloading saves a copy of your records to the computer you’re using.
      </>
    );
  }, [page]);
  ...
  return (
    <div className="before-you-download-dropdown" data-testid="before-download">
      <va-additional-info
        ...
        data-dd-action-name={`${dataDogActionNames.shared.WHAT_TO_KNOW_BEFORE_YOU_PRINT_OR_DOWNLOAD_BUTTON}${page}`}
        uswds
      >
        {content}
      </va-additional-info>
