...
const LandingPage = () => {
    ...
    return (
      <>
        <div className="main-content">
          <section className="vads-u-margin-bottom--3 desktop:vads-u-margin-bottom--4">
            <h1
              data-testid="landing-page-heading"
              className="desktop:vads-u-margin-bottom--0 vads-u-margin-bottom--1"
            >
              About medications
            </h1>
          ...
          <div className="no-print vads-u-margin-y--3 desktop:vads-u-margin-y--4 vads-u-border-bottom--2px vads-u-border-color--gray-light" />
          <section>
  ...
  return (
    ...
    >
      <div className="landing-page desktop:vads-u-margin-top--1 vads-u-margin-bottom--6">
        {content()}
      </div>
    </RequiredLoginView>
  );
