...
describe('Medications Details Page Empty Field Content', () => {
  it('visits Medications Details Empty Field Content', () => {
    ...
    detailsPage.verifyPharmacyPhoneNumberOnDetailsPage(
      Data.PHARMACY_PHONE_NUMBER_EMPTY,
    );
    detailsPage.verifyReasonForUseOnDetailsPage(Data.REASON_FOR_USE_EMPTY);
    detailsPage.verifyInstructionsOnDetailsPage(Data.INSTRUCTIONS_EMPTY);
  });
});
