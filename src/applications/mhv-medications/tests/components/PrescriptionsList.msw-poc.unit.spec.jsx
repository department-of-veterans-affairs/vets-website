...
describe('PrescriptionsList - MSW POC', () => {
  ...
  it('fetches and displays prescriptions using MSW', async () => {
    ...
    const response = await fetch('http://localhost/my_health/v1/prescriptions');
...
describe('MSW Benefits Demonstration', () => {
  ...
  it('demonstrates request inspection', async () => {
    ...
    await fetch('http://localhost/my_health/v1/prescriptions', {
  ...
  it('demonstrates sequential responses', async () => {
    ...
    const response1 = await fetch('http://localhost/my_health/v1/prescriptions');
    const data1 = await response1.json();
    expect(data1.data.length).to.equal(0);

    const response2 = await fetch('http://localhost/my_health/v1/prescriptions');
