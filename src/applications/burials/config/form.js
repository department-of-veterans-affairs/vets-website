...
import { validateBooleanGroup } from 'platform/us-forms-system/src/js/validation';
...
import FullNameField from 'platform/us-forms-system/src/js/fields/FullNameField';
import phoneUI from 'platform/us-forms-system/src/js/definitions/phone';
import ssnUI from 'platform/us-forms-system/src/js/definitions/ssn';
import currentOrPastDateUI from 'platform/us-forms-system/src/js/definitions/currentOrPastDate';
import toursOfDutyUI from '../definitions/toursOfDuty';
import fileUploadUI from 'platform/us-forms-system/src/js/definitions/file';
import currencyUI from 'platform/us-forms-system/src/js/definitions/currency';
import {
