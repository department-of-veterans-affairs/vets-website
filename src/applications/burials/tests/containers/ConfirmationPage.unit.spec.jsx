...
describe('<ConfirmationPage>', () => {
  it('should render', () => {
    ...
    expect(tree.subTree('.claim-list').text()).to.include(
      'Death certificate: 1 file',
    );
    expect(tree.subTree('.claim-list').text()).to.include(
      'Transportation documentation: 2 files',
    );
  ...
  it('should render', () => {
    ...
    expect(tree.subTree('.claim-list').text()).to.not.include(
      'Documents Uploaded',
    );
  });
});
