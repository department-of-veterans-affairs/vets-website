...
describe('Burials burial allowance', () => {
  ...
  test(
    'should show warning when ineligible for non-service connected death allowance',
    () => {
  ...
  test(
    'should not show vaMC option when neither vaMC nor nursing home selected as burial location',
    () => {
      const onSubmit = sinon.spy();
      const form = ReactTestUtils.renderIntoDocument(
        <DefinitionTester
  ...
  test('should show actual burial cost text field', () => {
    const form = ReactTestUtils.renderIntoDocument(
      <DefinitionTester
        definitions={formConfig.defaultDefinitions}
        schema={schema}
  ...
  test('should show previously received question', () => {
    const form = ReactTestUtils.renderIntoDocument(
      <DefinitionTester
        definitions={formConfig.defaultDefinitions}
        schema={schema}
  ...
  test('should show unclaimed question', () => {
    const form = ReactTestUtils.renderIntoDocument(
      <DefinitionTester
        definitions={formConfig.defaultDefinitions}
        schema={schema}
  ...
  test('should show page only if burialAllowance was chosen', () => {
    expect(depends({
