...
describe('Burials claimant information', () => {
  ...
  it('should show other text field', () => {
    ...
    ReactTestUtils.Simulate.change(
      formDOM.querySelector('#root_relationship_type_4'),
      {
        target: {
          value: 'other',
        },
  ...
  it('should submit when all required fields are filled in', () => {
    ...
    ReactTestUtils.Simulate.change(
      formDOM.querySelector('#root_claimantFullName_first'),
      {
        target: {
          value: 'Jane',
        },
    ...
    ReactTestUtils.Simulate.change(
      formDOM.querySelector('#root_claimantFullName_last'),
      {
        target: {
          value: 'Doe',
        },
    ...
    ReactTestUtils.Simulate.change(
      formDOM.querySelector('#root_relationship_other'),
      {
        target: {
          value: 'Friend',
        },
