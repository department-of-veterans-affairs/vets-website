...
describe('actions/personalInformation', () => {
  ...
  describe('fetchPersonalInformation', () => {
    ...
    it('redirects when showMebCh33SelfForm is false and showMebEnhancements08 is true', async () => {
    ...
    it('does not redirect when showMebCh33SelfForm is true and showMebEnhancements08 is true', async () => {
