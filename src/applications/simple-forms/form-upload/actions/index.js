...
function calcProgress(totalSize, filesComplete, bytesComplete) {
  const ratio = 0.8;

  return filesComplete * (1 - ratio) + (bytesComplete / totalSize) * ratio;
}
        ...
        const uploader = new FineUploaderBasic({
          ...
          callbacks: {
            onTotalProgress: bytes => {
              ...
              dispatch({
                type: SET_PROGRESS,
                progress: calcProgress(totalSize, filesComplete, bytesComplete),
              });
            },
