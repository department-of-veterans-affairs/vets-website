...
const expectedFieldTypesWebComponents =
  'va-text-input, va-select, va-textarea, va-radio, va-checkbox';
...
export const testNumberOfFieldsWebComponents = (
  formConfig,
  schema,
  uiSchema,
  expectedNumberOfFields,
...
export const testNumberOfErrorsOnSubmitWebComponents = (
  formConfig,
  schema,
  uiSchema,
  expectedNumberOfErrors,
