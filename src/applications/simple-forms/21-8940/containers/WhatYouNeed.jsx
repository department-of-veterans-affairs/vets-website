...
const WhatYouNeed = ({ formData, location, route, router }) => {
	...
	return (
		<div className="schemaform-intro">
			...
			<VaSummaryBox id="basic-info-summary" uswds class="vads-u-margin-bottom--3">
				<h4 slot="headline">Basic Information</h4>
			...
			<VaSummaryBox id="disability-info-summary" uswds class="vads-u-margin-bottom--3">
				<h4 slot="headline">Disability Information</h4>
				<ul className="usa-list vads-u-margin--0">
					<li>List of your service-connected disabilities</li>
					<li>Names and addresses of doctors who treated you in the past 12 months</li>
					<li>Dates of recent medical treatment</li>
                    <li>Hospital names and dates (if applicable)</li>
				</ul>
			</VaSummaryBox>
			<VaSummaryBox id="employment-history-summary" uswds class="vads-u-margin-bottom--3">
				<h4 slot="headline">Employment History</h4>
				<ul className="usa-list vads-u-margin--0">
					<li>Dates your disability began affecting your work</li>
					<li>Date you last worked full-time</li>
					<li>Employment details for the past 5 years (employer names, addresses, dates, job duties)</li>
					<li>Your highest annual earnings and what year</li>
					<li>Current income information (if working)</li>
				</ul>
			</VaSummaryBox>
			<VaSummaryBox id="education-training-summary" uswds class="vads-u-margin-bottom--3">
				<h4 slot="headline">Education and Training</h4>
				<ul className="usa-list vads-u-margin--0">
			...
			<VaSummaryBox id="job-search-summary" uswds class="vads-u-margin-bottom--3">
				<h4 slot="headline">Job Search Information</h4>
				<ul className="usa-list vads-u-margin--0">
