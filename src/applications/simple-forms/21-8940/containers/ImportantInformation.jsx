...
const ImportantInformation = ({ formData, location, route, router }) => {
	...
	return (
		<div className="schemaform-intro">
			...
			<VaSummaryBox id="important-information-summary" uswds class="vads-u-margin-bottom--3 vads-u-margin-top--3">
				<h4 slot="headline">Please read this important information before you start:</h4>
				<ul className="usa-list vads-u-margin--0">
                    ...
                    <li>This form is for claiming total disability if service-connected disabilities have prevented you from getting or keeping a job</li>
				</ul>
			</VaSummaryBox>
