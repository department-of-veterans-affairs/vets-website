      ...
      [employedByVAFields.hasUnderstoodSection2]: checkboxUI({
        ...
        description: (
          <div>
            ...
            <p className="vads-u-margin-top--0">
              The items completed on this form are true and correct to the best of my
              knowledge and belief. I believe that my service-connected disability(ies)
              has not improved and continues to prevent me from securing or following
              gainful employment.
            </p>
          </div>
        ),
