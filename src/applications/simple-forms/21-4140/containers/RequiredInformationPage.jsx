...
const RequiredInformationPage = ({
  ...
  return (
    <div className="schemaform-intro">
      ...
      <h1 id="main-content" className="vads-u-margin-bottom--2">Information We are Required to Share</h1>
      ...
      <VaSummaryBox id="required-information-summary" uswds class="vads-u-margin-bottom--3">
        <h2 className="vads-u-margin-top--0"><b>IMPORTANT</b></h2>
        <p className="vads-u-margin--0">
          You are receiving compensation at the 100 percent rate based on being unable to
          secure or follow a substantially gainful occupation as a result of your
          service-connected disabilities. Section I needs to be completed in order to
          identify the person filling out the form. If you were self-employed or employed
          by others, including the Department of Veterans Affairs, at any time during the
          past 12 months, complete Section II of this form. If you have not been employed
