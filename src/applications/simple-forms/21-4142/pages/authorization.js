...
export default {
  uiSchema: {
    ...titleUI({
      title:
        'Provide your authorization to request the private medical records',
      description: (
        <>
          <h4 className="vads-u-color--gray-dark vads-u-margin-top--4">
            Authorization
          </h4>
          <p>
          ...
          <p>
            I hereby authorize the medical facilities I list in this form, to
            release any information that may have been obtained in connection
            with a physical, psychological or psychiatric examination or
            treatment, with the understanding that VA will use this information
            in determining my eligibility to veterans benefits I have claimed.
          </p>
          <p>
