...
export default {
  uiSchema: environment.isProduction()
        ...
        'ui:description': (
          <>
            ...
            <p>
              ...
              no longer wish to disclose information about me.
            </p>
            <p>
    ...
    : {
        [schemaFields.acknowledgeToReleaseInformation]: checkboxGroupUI({
          title:
  ...
  schema: environment.isProduction()
    ...
    : {
        type: 'object',
        properties: {
          [schemaFields.acknowledgeToReleaseInformation]: checkboxGroupSchema([
            schemaFields.acknowledgeToReleaseInformation,
          ]),
        },
        required: [schemaFields.acknowledgeToReleaseInformation],
