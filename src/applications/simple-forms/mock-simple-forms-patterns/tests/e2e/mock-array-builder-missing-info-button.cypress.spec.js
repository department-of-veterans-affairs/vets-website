...
import sipGetMissingInfoButton from './fixtures/mocks/sip-get-missing-info-button.json';
...
const testConfig = createTestConfig(
  {
    ...
    dataPrefix: 'data',
    dataSets: ['arrayBuilderMissingInfoButton'],
    ...
    pageHooks: {
      ...
      [pagePaths.arrayMultiPageBuilderSummaryAddButton]: ({ afterHook }) => {
        ...
        afterHook(() => {
          cy.get('@testData').then(() => {
            const expectInitialLayout = () => {
              ...
              cy.get('va-button[name="employersAddButton"]').should('exist');
              cy.get(
