...
import {
  ...
  getIdentificationInfoChapterTitle,
  getMailingAddressChapterTitle,
...
const formConfig = {
  ...
  chapters: {
    ...
    identificationChapter: {
      title: ({ formData }) => getIdentificationInfoChapterTitle(formData),
      pages: {
    ...
    mailingAddressChapter: {
      title: ({ formData }) => getMailingAddressChapterTitle(formData),
      pages: {
        mailingAddressPage: {
