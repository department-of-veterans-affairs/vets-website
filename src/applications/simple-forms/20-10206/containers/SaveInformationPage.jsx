...
const SaveInformationPage = props => {
  ...
  return (
    <div className="usa-width-two-thirds columns">
      <h1>
        Your information will be saved automatically after every change you
        make.
      </h1>
      <p>
        If you want to take a break from filling out this form, you can stop
        anytime using the "Finish later" button.
      </p>
      <p>
        When you’re ready to resume the form, reopen it from My VA or visit the
