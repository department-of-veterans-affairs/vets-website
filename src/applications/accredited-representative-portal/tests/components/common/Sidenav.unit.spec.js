...
describe('Sidenav', () => {
  it('renders sidenav', () => {
    ...
    expect(getByTestId('dashboard-sidenav-item').textContent).to.equal(
      'Dashboard',
    );
    ...
    expect(getByTestId('poa-requests-sidenav-item').textContent).to.equal(
      'POA requests',
    );
    ...
    expect(getByTestId('permissions-sidenav-item').textContent).to.equal(
      'Permissions',
    );
