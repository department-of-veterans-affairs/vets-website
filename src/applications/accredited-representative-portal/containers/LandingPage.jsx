            ...
            <div className="home__content">
              <div className="home__content-copy">
                ...
                <p data-testid="landing-page-portal-text">
                  ...
                  requests for any of your accredited organizations. If you have
                  access to the Veterans Benefits Management System (VBMS),
                  you’ll be able to access a Veteran’s information in VBMS
                  within minutes of accepting their POA request in the portal.
                </p>
                <p>
              ...
              <div className="home__content-copy">
                ...
                <p data-testid="landing-page-portal-for-text">
                  ...
                  Organization (VSO) representatives who accept POA requests on
                  behalf of their organizations. In the future, the portal will
                  support accredited VSOs, attorneys, and claims agents.
                </p>
                <a
                  ...
                  rel="noreferrer"
                >
                  Learn more about accredited representatives (opens in a new
                  tab)
                </a>
              </div>
              ...
              >
                <p>
                  If you’re a Veterans Service Organization (VSO) manager, you
                  may be able to get early access to the portal for your
                  organization by joining our test program. Once you start using
                  the portal, we’ll ask you to give us feedback on your
                  experience.
                </p>
                <p>
            ...
            <div className="home__container">
              ...
              <div className="home__content">
                ...
                <p>
                  ...
                  sign up to be invited to future feedback sessions with our VA
                  research team.
                </p>
                <a
                  ...
                  rel="noreferrer"
                >
                  Sign up to participate in feedback sessions (opens in a new
                  tab)
                </a>
              </div>
            </div>
