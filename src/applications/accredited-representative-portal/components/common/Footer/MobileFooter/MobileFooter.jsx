          ...
          >
              ...
              <li>
                  ...
                  <div className="usa-accordion-content va-footer-accordion-content" aria-hidden="true" id="footer-veteran-programs">
                     <ul className="va-footer-links">
                        ...
                        <li><a href="https://www.patientcare.va.gov/lgbt/" target="" rel="noopener noreferrer">LGBTQ+ Veterans</a></li>
                        ...
                        <li><a href="https://department.va.gov/veteran-sports/" target="">Adaptive sports and special events</a></li>
                        <li><a href="/outreach-and-events/events/">VA outreach events</a></li>
            ...
            <div className="usa-grid usa-grid-full va-footer-links-bottom">
              <ul>
               ...
               <li><a href="/report-harassment/">Harassment</a></li>
               <li><a href="/oig/">Office of Inspector General</a></li>
               <li><a href="/opa/Plain_Language.asp">Plain language</a></li>
               <li><a href="/privacy-policy/">Privacy, policies, and legal information</a></li>
               <li><a href="https://www.oprm.va.gov/">VA Privacy Service</a></li>
               <li><a href="/ormdi/NOFEAR_Select.asp">No FEAR Act Data</a></li>
               <li><a href="https://www.usa.gov/" target="_blank" rel="noopener noreferrer">USA.gov</a></li>
               <li><a href="/performance-dashboard/" target="_blank" rel="noopener noreferrer">VA performance dashboard</a></li>
               <li><a href="/veterans-portrait-project/">Veterans Portrait Project</a></li>
              </ul>
            </div>
          </div>
