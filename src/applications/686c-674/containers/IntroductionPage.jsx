    ...
    <div className="schemaform-intro">
      ...
      <div className="omb-info--container vads-u-padding-left--0 vads-u-margin-top--2">
        ...
        >
          ...
          obligation to respond is required to obtain or retain benefits. Giving
          us your and your dependents' SSN account information is mandatory.
          Applicants are required to provide their SSN and the SSN of any
          dependents for whom benefits are claimed under Title 38 USC 5101
          (c)(1). The VA will not deny an individual benefits for refusing to
          provide his or her SSN unless the disclosure of the SSN is required by
          Federal Statute of law in effect prior to January 1, 1975, and still
          in effect. Information that you furnish may be utilized in computer
          matching programs with other Federal or state agencies for the purpose
          of determining your eligibility to receive VA benefits, as well as to
          collect any amount owed to the United States by virtue of your
          participation in any benefit program administered by the Department of
          Veterans Affairs. RESPONDENT BURDEN: We need this information to
          ...
          allows us to ask for this information. We estimate that you will need
          an average of 30 minutes to review the instructions, find the
      ...
      <div className="omb-info--container vads-u-padding-left--0 vads-u-margin-top--2">
        ...
        >
          ...
          programs with other agencies. RESPONDENT BURDEN: An agency may not
          conduct or sponsor, and a person is not required to respond to, a
          collection of information unless it displays a currently valid OMB
          control number. The OMB control number for this project is 2900-0049,
          and it expires November 30, 2027. Public reporting burden for this
          ...
          />
          . Please refer to OMB Control No. 2900-0049 in any correspondence. Do
          not send your completed VA Form 21-674 to this email address.
        </va-omb-info>
      </div>
    </div>
  );
