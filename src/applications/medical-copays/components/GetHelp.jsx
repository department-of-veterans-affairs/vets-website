  ...
  return (
    <div>
      ...
      <dl>
        ...
        <dd>
          <strong>Main number:</strong> <Telephone contact={'8139722000'} />
        </dd>
        <dt>
          <h4>San Diego VA Medical Center</h4>
        </dt>
        <dd>
          <strong>Main number:</strong> <Telephone contact={'8585528585'} />
        </dd>
        <dt>
          <h4>Philadelphia VA Medical Center</h4>
        </dt>
        <dd>
          <strong>Main number:</strong> <Telephone contact={'2158235800'} />
        </dd>
      </dl>
    </div>
  );
