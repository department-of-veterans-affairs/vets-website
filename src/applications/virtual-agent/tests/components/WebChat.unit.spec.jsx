...
import * as UnloadEventListenerModule from '../../event-listeners/unloadEventListener';
  ...
  describe('WebChat', () => {
    ...
    const stubFunctions = () => {
      return {
        ...
        unloadEventListenerStub: sandbox
          .stub(UnloadEventListenerModule, 'default')
          .callsFake(props => (
            <div data-testid="UnloadEventListener" {...props} />
          )),
    ...
    it('should render Composer with args and BasicWebChat', () => {
      ...
      expect(getByTestId('UnloadEventListener')).to.exist;
      expect(
