...
export default function ChatbotUnavailable() {
  return (
    <div className="vads-u-padding--2">
      <h1>VA chatbot</h1>
      <p>
        We closed our beta testing period for the VA.gov chatbot on January 12,
        2026. We're now using your feedback to improve the chatbot before we
        bring it back to the site later this year. Thank you for your patience
        as we work to improve your experience.
      </p>

      <h2>Continue to manage your benefits and health care on VA.gov</h2>
      <p>
        While we work to improve the chatbot, you can continue to manage your VA
        benefits and health care on VA.gov.
      </p>
