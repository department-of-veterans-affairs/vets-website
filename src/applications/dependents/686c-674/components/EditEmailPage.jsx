...
const EditEmailPage = ({
  ...
  const originalEmail = useRef(data.veteranContactInformation.emailAddress);
  const originalElectronicCorrespondence = useRef(
    data.veteranContactInformation.electronicCorrespondence,
  );
    ...
    onInput: inputData => {
      setFormData({
        ...
        veteranContactInformation: {
          ...
          electronicCorrespondence: inputData.electronicCorrespondence,
        },
      });
    },
    onUpdate: () => {
      saveEditContactInformation('emailAddress', 'update');
      returnToPath();
    },
    onCancel: event => {
  ...
  return (
    <>
      ...
      <SchemaForm
        ...
        idSchema={{}}
        schema={schema}
        data={data.veteranContactInformation}
        uiSchema={uiSchema}
