...
export default function alert(state = initialState, action) {
  ...
  switch (action.type) {
    case UPDATE_ROUTE: {
      ...
      const preserveAlert = _.get(
        action,
        'location.state.preserveAlert',
        false,
      );
    ...
    case CREATE_FOLDER_FAILURE:
      return createAlert(<b>Failed to create folder.</b>, alertStatus.ERROR);
    ...
    case DELETE_FOLDER_FAILURE:
      return createAlert(<b>Failed to delete folder.</b>, alertStatus.ERROR);
    ...
    case DELETE_MESSAGE_FAILURE:
      return createAlert(<b>Failed to delete message.</b>, alertStatus.ERROR);
    ...
    case MOVE_MESSAGE_FAILURE:
      return createAlert(<b>Failed to move message.</b>, alertStatus.ERROR);
    ...
    case SAVE_DRAFT_FAILURE:
      return createAlert(<b>Failed to save draft.</b>, alertStatus.ERROR);
    ...
    case SEND_MESSAGE_FAILURE:
      return createAlert(<b>Failed to send message.</b>, alertStatus.ERROR);
    ...
    case SEND_MESSAGE_SUCCESS: {
      ...
      const content = (
        <b>
          Your message has been sent. {link} Please allow up to three working
          days for a response from your health care team.
        </b>
      );
