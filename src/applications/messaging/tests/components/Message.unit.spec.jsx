...
describe('Message', () => {
  ...
  test('should show attachments when expanded', () => {
  ...
  test('should hide details when collapsed', () => {
  ...
  test('should hide attachments when collapsed', () => {
    const tree = SkinDeep.shallowRender(
      <Message
        {...props}
  ...
  test('should display as a draft when there is no sent date', () => {
    const tree = SkinDeep.shallowRender(
  ...
  test('should fetch attachments when they have not been loaded', () => {
  ...
  test(
    'should not fetch attachments after they have already been loaded',
    () => {
      const fetchMessage = sinon.spy();
