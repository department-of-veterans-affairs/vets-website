  ...
  it('should show or hide details when toggled', () => {
    ...
    expect(
      ReactTestUtils.scryRenderedDOMComponentsWithClass(
        details,
        'messaging-message-details--compact',
      ),
    ).to.be.empty;
    expect(
      ReactTestUtils.scryRenderedDOMComponentsWithClass(
        details,
        'messaging-message-details--full',
      ),
    ).to.be.empty;
