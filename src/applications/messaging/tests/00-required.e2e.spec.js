...
module.exports = E2eHelpers.createE2eTest(client => {
  ...
  client
    ...
    .axeCheck('.main')
    .expect.element('.msg-table-list td:nth-of-type(1) a:nth-of-type(1)')
    .text.to.equal('Clinician');
  ...
  client
    ...
    .axeCheck('.main')
    .expect.element(
      '.messaging-thread-messages .messaging-thread-message:last-of-type .messaging-message-body',
    )
    .text.to.equal('Reply 3');

  // Expand previous message in thread.
  client
    .click('.messaging-thread-messages .messaging-thread-message:first-of-type')
    .expect.element(
      '.messaging-thread-messages .messaging-thread-message:first-of-type .messaging-message-body',
    )
  ...
  client
    .click('.msg-send-buttons button:nth-of-type(1)')
