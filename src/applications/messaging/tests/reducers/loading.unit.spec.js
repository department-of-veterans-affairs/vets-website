...
describe('loading reducer', () => {
  ...
  it('should trigger a loader when fetching a folder', () => {
    const state = loadingReducer({ folder: false }, { type: LOADING_FOLDER });
  ...
  it('should trigger a loader when fetching folders', () => {
    const state = loadingReducer({ folders: false }, { type: LOADING_FOLDERS });
  ...
  it('should trigger a loader when fetching a thread', () => {
    const state = loadingReducer({ thread: false }, { type: LOADING_THREAD });
