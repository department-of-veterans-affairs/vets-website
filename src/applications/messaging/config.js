module.exports = {
    ...
    errors: {
      attachments: {
        tooLarge: {
          ...
          text:
            'The file(s) you are trying to attach exceed the 3MB attachment size limit and the total size of attachments cannot exceed 6MB',
        },
        tooMany: {
  ...
  createNewFolderSettings: {
    ...
    errorMessages: {
      ...
      exists:
        'The folder name you have chosen already exists. Please try another name.',
      patternMismatch:
        'Only the letters A through Z, numbers, and spaces are allowed in folder names.',
    },
  },
