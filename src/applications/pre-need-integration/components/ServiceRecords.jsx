...
export default class ServiceRecords extends React.Component {
  constructor(props) {
    super(props);
    ...
    if (!isReactComponent(this.props.uiSchema['ui:options'].viewField)) {
      throw new Error(
        `No viewField found in uiSchema for ServiceRecords ${
                ...
                >
                  ...
                  {uiOptions.confirmRemove && (
                    <VaModal
                      clickToClose
                      status="warning"
                      modalTitle="Are you sure you want to remove this service period?"
