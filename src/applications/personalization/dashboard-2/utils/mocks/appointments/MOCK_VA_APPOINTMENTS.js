...
export default [
  {
    ...
    attributes: {
      startDate: Date.now() + oneDayInMS * 35,
      sta6aid: null,
      clinicId: null,
      ...
      vvsAppointments: [
        {
          ...
          sourceSystem: 'PV',
          dateTime: Date.now() + oneDayInMS * 35,
          desiredDate: Date.now() + oneDayInMS * 35,
          duration: 30,
          status: {
            description: 'F',
            code: 'FUTURE',
  ...
  },
  {
    ...
    type: 'va_appointments',
    attributes: {
      startDate: Date.now() + oneDayInMS * 31,
      sta6aid: '983',
      clinicId: '848',
      ...
      vvsAppointments: [
        {
          ...
          sourceSystem: 'TMP',
          dateTime: Date.now() + oneDayInMS * 31,
  ...
  },
  {
    ...
    type: 'va_appointments',
    attributes: {
      startDate: Date.now() + oneDayInMS * 3,
      clinicId: '308',
      clinicFriendlyName: null,
      facilityId: '983',
      sta6aid: '983GC',
      ...
      vdsAppointments: [
        {
          ...
          appointmentTime: Date.now() + oneDayInMS * 3,
          clinic: {
            name: 'CHY OPT VAR1',
            askForCheckIn: false,
            facilityCode: '983',
  ...
  },
  {
    ...
    type: 'va_appointments',
    attributes: {
      startDate: Date.now() + oneDayInMS * 2,
      clinicId: '308',
      ...
      vdsAppointments: [
        {
          ...
          appointmentLength: '60',
          appointmentTime: Date.now() + oneDayInMS * 2,
          clinic: {
            name: 'CHY OPT VAR1',
            askForCheckIn: false,
            facilityCode: '983',
  ...
  },
  {
    ...
    type: 'va_appointments',
    attributes: {
      startDate: Date.now() - oneDayInMS * 5,
      clinicId: '308',
      clinicFriendlyName: null,
      facilityId: '983',
      sta6aid: '983',
      ...
      vdsAppointments: [
        {
          ...
          appointmentLength: '60',
          appointmentTime: Date.now() - oneDayInMS * 5,
          clinic: {
            name: 'CHY OPT VAR1',
            askForCheckIn: false,
            facilityCode: '983',
