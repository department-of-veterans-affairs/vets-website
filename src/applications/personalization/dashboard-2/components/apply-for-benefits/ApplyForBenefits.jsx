...
const ApplicationInProgress = ({
  ...
  return (
    <div className="vads-u-display--flex vads-l-col--12 medium-screen:vads-l-col--6 large-screen:vads-l-col--4 medium-screen:vads-u-padding-right--3 vads-u-padding-bottom--3">
      <div className="vads-u-display--flex  vads-u-flex-direction--column vads-u-justify-content--space-between vads-u-align-items--flex-start vads-u-background-color--gray-lightest vads-u-padding--2p5">
        <div>
    ...
    <div>
      ...
      {savedForms.length > 0 && (
        <div className="vads-u-display--flex vads-u-flex-wrap--wrap">
          {/* for each savedForm, pull off the correct data and pass it to a new ApplicationInProgress component */}
          {savedForms.map(form => {
            // blah...
      ...
      {!savedForms.length && <p>You have no forms in progress</p>}
    </div>
  );
};

// pull the applications off of the user object
// for each one, create an ApplicationInProgress
