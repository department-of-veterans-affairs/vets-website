...
const RatedDisabilitiesSidebar = () => (
  <div className="medium-screen:vads-u-padding-left--4">
    <div>
      <p className="vads-u-display--inline-block vads-u-font-family--serif vads-u-font-weight--bold vads-u-font-size--lg vads-u-border-bottom--3px vads-u-border-color--primary vads-u-margin-top--0 vads-u-padding-bottom--2p5">
        How did I get this rating?
      </p>
      <p className="vads-u-margin-top--0 vads-u-padding-top--1p5">
    ...
    <div className="vads-u-margin-top--2p5">
      <p className="vads-u-display--inline-block vads-u-font-family--serif vads-u-font-weight--bold vads-u-font-size--lg vads-u-border-bottom--3px vads-u-border-color--primary vads-u-padding-bottom--2p5">
