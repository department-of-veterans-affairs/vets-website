...
class TotalRatedDisabilities extends Component {
  componentDidMount() {
    console.log(this.props.totalDisabilityRating);
    this.props.fetchTotalDisabilityRating();
    console.log(this.props.totalDisabilityRating);
  }

  render() {
    if (!this.props.totalDisabilityRating) {
      return (
        ...
        <div className="feature vads-l-grid-container">
          <div className="vads-l-row">
            <div className="vads-l-col--12 medium-screen:vads-l-col--6 small-desktop-screen:vads-l-col--8">
              ...
              <p>
                Your final degree of disability is{' '}
                {this.props.totalDisabilityRating}
            ...
            <div className="vads-l-col--12 medium-screen:vads-l-col--6 small-desktop-screen:vads-l-col--4">
              <CircularProgress percentage={this.props.totalDisabilityRating} />
            </div>
          </div>
          <div className="vads-l-row">
            <div className="vads-l-col--12 medium-screen:vads-l-col--6 small-desktop-screen:vads-l-col--8">
