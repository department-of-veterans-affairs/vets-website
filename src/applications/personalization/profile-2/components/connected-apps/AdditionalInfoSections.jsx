...
export const AdditionalInfoSections = () => {
  return (
    <>
      <AdditionalInfo
      ...
      >
        ...
        <ol>
          <li>
            When the app (or website) prompts you to connect your VA account, it
            will ask you to sign in.
          </li>
          <li>
            Sign in with your preferred VA.gov account: DS Logon, My HealtheVet,
            or ID.me.
          </li>
      ...
      >
        ...
        <ul>
          <li>
            If your health records are missing: It can take up to 3 days for new
            health records to show in a connected app. If it’s been more than 3
            days since your last appointment, or if you need your information
            sooner,{' '}
            <a
          ...
          <li>
            If your information isn’t accurate: Call VA311 at 844-698-2311. If
            you have hearing loss, call TTY: 711. Or visit a VA health facility
            near you and ask a staff member for help.{' '}
            <a href="/find-locations">Find a VA health facility near you</a>
          </li>
          <li>
            If you’re getting an “unreadable data” message: This means the
            connected app has access to your information, but isn’t using it in
            its interface. It’s nothing to worry about. If you have questions
            about this, send feedback directly to the app.
          </li>
        </ul>
      </AdditionalInfo>
