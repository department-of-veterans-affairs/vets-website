...
const responses = {
  ...
  // 'GET /v0/profile/contacts': (_req, res) => res.status(403).json({}),
  // 'GET /v0/profile/contacts': (_req, res) => res.status(404).json({}),
  // 'GET /v0/profile/contacts': (_req, res) => res.status(500).json({}),
