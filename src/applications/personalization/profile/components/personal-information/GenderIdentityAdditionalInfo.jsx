...
export default function GenderIdentityAdditionalInfo() {
  return (
    <va-additional-info trigger="What to know before you decide to share your gender identity">
      <p>
        ...
        information you share in your VA.gov profile goes into you VA-wide
