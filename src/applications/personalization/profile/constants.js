...
export const NOTIFICATION_ITEM_IDS = Object.freeze({
  ...
  HEALTH_APPOINTMENT_REMINDERS: `item${RAW_IDS.APPEAL_HEARING_REMINDERS}`,
  PRESCRIPTION_SHIPMENT: `item${RAW_IDS.APPEAL_HEARING_REMINDERS}`,
  DISABILITY_PENSION_DEPOSIT: `item${RAW_IDS.APPEAL_HEARING_REMINDERS}`,
  APPEAL_STATUS_UPDATES: `item${RAW_IDS.APPEAL_HEARING_REMINDERS}`,
  RX_REFILL: `item${RAW_IDS.APPEAL_HEARING_REMINDERS}`,
  VA_APPOINTMENT_REMINDERS: `item${RAW_IDS.APPEAL_HEARING_REMINDERS}`,
  SECURE_MESSAGING: `item${RAW_IDS.APPEAL_HEARING_REMINDERS}`,
  MEDICAL_IMAGES: `item${RAW_IDS.APPEAL_HEARING_REMINDERS}`,
  BIWEEKLY_MHV_NEWSLETTER: `item${RAW_IDS.APPEAL_HEARING_REMINDERS}`,
  QUICK_SUBMIT: `item${RAW_IDS.APPEAL_HEARING_REMINDERS}`,
  BENEFIT_OVERPAYMENT_DEBT: `item${RAW_IDS.APPEAL_HEARING_REMINDERS}`,
  HEALTH_CARE_COPAY_BILL: `item${RAW_IDS.APPEAL_HEARING_REMINDERS}`,
});
