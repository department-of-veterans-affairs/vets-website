...
export const PROFILE_PATHS = Object.freeze({
  ...
  FINANCIAL_INFORMATION: '/profile/direct-deposit',
  DIRECT_DEPOSIT: '/profile/direct-deposit',
  DIRECT_DEPOSIT_INFORMATION: '/profile/direct-deposit',
  LETTERS_AND_DOCUMENTS: '/profile/veteran-status-card',
  VETERAN_STATUS_CARD: '/profile/veteran-status-card',
  COMMUNICATIONS_SETTINGS: '/profile/notifications',
  NOTIFICATION_SETTINGS: '/profile/notifications',
  EMAIL_AND_TEXT_NOTIFICATIONS: '/profile/notifications',
  MHV_SIGNATURE: '/profile/mhv-signature',
  ACCOUNT_SECURITY: '/profile/account-security',
  SIGNIN_INFORMATION: '/profile/signin-information',
