...
const ManageYourVAHealthCare = ({
  ...
  <>
    ...
    {isEnrolledInHealthCare &&
      !isCernerOnlyPatient && <ScheduleAnAppointmentWidget />}
    {isEnrolledInHealthCare &&
      isCernerOnlyPatient && <ScheduleAnAppointmentCernerWidget />}
  </>
);
...
const mapStateToProps = state => {
  ...
  const isCernerOnlyPatient = selectIsCernerOnlyPatient(state);
  const {
    applicationDate,
    enrollmentDate,
    preferredFacility,
