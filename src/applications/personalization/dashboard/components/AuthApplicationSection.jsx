      ...
      <div>
        <div className="profile-section medium-12 columns">
          ...
          <div className="medium-12 columns">
            ...
            <p key="claims">
              <a href="/track-claims">Check your claim and appeal status</a>
            </p>
            <p key="post-911">
            ...
            <p>
              ...
              <br />
              You can apply for an upgrade. If your application goes through and
              your discharge is upgraded, you'll be eligible for the VA benefits
