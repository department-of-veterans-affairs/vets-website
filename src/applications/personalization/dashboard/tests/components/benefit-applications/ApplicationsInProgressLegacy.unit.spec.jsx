...
import ApplicationsInProgressLegacy from '../../../components/benefit-application-drafts/ApplicationsInProgressLegacy';
  ...
  it('renders Draft forms', () => {
    const view = render(
      <Provider store={store}>
        <ApplicationsInProgressLegacy hideH3 savedForms />
      </Provider>,
    );
