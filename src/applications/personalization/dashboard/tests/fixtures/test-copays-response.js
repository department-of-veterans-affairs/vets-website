...
export const copaysSuccess = (hasRecentCopay = false) => {
  return {
    data: [
      {
        ...
        pSStatementDate: hasRecentCopay
          ? format(addDays(new Date(), 30), 'MMddyyyy')
          : '11152019',
        pSStatementDateOutput: hasRecentCopay
          ? format(addDays(new Date(), 30), 'MM/dd/yyyy')
          : '11/11/2019',
        pSProcessDate: hasRecentCopay
          ? format(new Date(), 'MMddyyyy')
          : '11152019',
        pSProcessDateOutput: hasRecentCopay
...
export const copaysSuccessEmpty = () => {
  return {
    data: [],
  };
};

export const copaysError = () => {
  return {
    errors: [
      {
        title: 'Server Error',
