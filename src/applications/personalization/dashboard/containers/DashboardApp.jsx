...
class DashboardApp extends React.Component {
  ...
  renderLOAPrompt() {
    ...
    return (
      <AlertBox
        content={<div>
          <h4 className="usa-alert-heading">Verify your identity to access more VA.gov tools and features</h4>
          <p>When you verify your identity, you can use VA.gov to do things like track your claims, refill your prescriptions, and download your VA benefit letters.</p>
