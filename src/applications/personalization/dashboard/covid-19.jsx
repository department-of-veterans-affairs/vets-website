...
/*
This list was created by taking the list of supported facilities from
...
This list was created on 2020-03-19. Future updates could be made by taking the
updated list of facilities from https://mobile.va.gov/app/va-health-chat,
determining which facilities have been added and removed, and updating this
array as needed
...
const eligibleFacilities = [
  { name: 'Alexandria Community Based Outpatient Clinic', id: '000' },
  { name: 'Arecibo VA Clinic', id: '672GC' },
  { name: 'Bay Pines VA Healthcare System', id: '000' },
  ...
  { name: 'Comerio Rural Outpatient Clinic', id: '000' },
  { name: 'Crossroads VA Clinic', id: '000' },
  ...
  { name: 'Eurípides Rubio VA Outpatient Clinic', id: '000' },
  { name: 'Fort Pierce VA Clinic', id: '548GA' },
  { name: 'Fort Snelling VA Clinic', id: '000' },
  ...
  { name: 'Maplewood VA Clinic', id: '000' },
  { name: 'Marianna VA Clinic', id: '573GK' },
  { name: 'Mayaguez VA Clinic', id: '672BZ' },
  { name: 'Miami Flagler VA Clinic', id: '000' },
  ...
  { name: 'North Florida/South Georgia Veterans Health System', id: '000' },
...
export const COVID19Alert = () => (
  ...
  >
    <p>
      ...
      Health chat is available at no-cost, 8:00 a.m. to 5:00 p.m. ET, Monday
      through Friday, to any Veteran whose VA facility is part of the pilot.
    </p>
    <a
