...
describe('<Vet360EditModalActionButtons/>', () => {
  ...
  test('renders correctly when delete enabled', () => {
    ...
    expect(component.find('.fa-trash'), 'renders delete icon').to.have.lengthOf(1);
  ...
  test('renders correctly when delete triggered', () => {
    ...
    expect(component.html(), 'renders alert contents').to.contain('Are you sure?');

    expect(component.html(), 'does not render children components after triggered').to.not.contain('Children');

    expect(component.find('.fa-trash'), 'hides delete icon correctly').to.have.lengthOf(0);
