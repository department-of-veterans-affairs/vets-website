              ...
              <div className="usa-width-two-thirds medium-8 small-12 columns">
                ...
                <div className="va-introtext">
                  <p>
                    ...
                    Vets.gov. Find out how to update your settings as needed to
                    access more site tools or add extra security to your
                    account.
                  </p>
                </div>
                <Announcement
                  dismiss={this.dismissAnnouncement}
                  isDismissed={this.props.announcementDismissed}
                />
                <AccountMain
...
const mapStateToProps = state => {
  ...
  return {
    ...
    user: userState,
    announcementDismissed: state.announcements.dismissed.includes(
      ANNOUNCEMENT_NAME,
    ),
  };
};
