...
export default function AccountVerification({ loa }) {
  ...
  if (loa.current !== 3) {
        ...
        content={
          <div>
            <h4 className="usa-alert-heading">
              Want to use Vets.gov to do things like track your disability claim
              ...
              <a
                ...
                onClick={() =>
                  recordEvent({
                    ...
                    'account-section': 'learn-more-identity',
                  })
                }
              >
    ...
    content = (
      <p>
        <i className="fa fa-check-circle" /> We’ve verified your identity.
      </p>
    );
  }
