    ...
    content = (
      <div>
        <div className="usa-alert usa-alert-info no-background-image">
          <p><strong>Want to use VA.gov health tools to do things like refill your VA prescriptions?</strong></p>
        ...
        <p>Once you agree to these Terms and Conditions, you’ll be able to use VA.gov health tools to:</p>
        <ul>
