...
describe('Pensions financial disclosure', () => {
  function runTests(page, namePath, fieldCount) {
    ...
    it('should render', () => {
      ...
      expect(formDOM.querySelectorAll('input').length).to.equal(fieldCount);
      expect(
    ...
    it('should add another source', () => {
      ...
      ReactTestUtils.Simulate.click(
        formDOM.querySelector('.pensions-sources-add-btn'),
      );
      submitForm(form);
      expect(onSubmit.called).to.be.false;

      expect(formDOM.querySelectorAll('input').length).to.equal(fieldCount + 2);
      ...
      expect(formDOM.querySelectorAll('input').length).to.equal(fieldCount + 1);
    ...
    it('should add and remove another source', () => {
      ...
      ReactTestUtils.Simulate.click(
        formDOM.querySelector('button.float-right'),
      );
