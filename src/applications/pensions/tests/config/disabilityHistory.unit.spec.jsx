...
xdescribe('Pensions disability history', () => {
  const {
    schema,
    uiSchema,
    depends,
  } = formConfig.chapters.workHistory.pages.disabilityHistory;
  it('should render', () => {
  ...
  it('should add another disability', () => {
    ...
    ReactTestUtils.Simulate.change(
      formDOM.querySelector('#root_disabilities_0_name'),
      {
        target: {
          value: 'Back pain',
        },
    ...
    ReactTestUtils.Simulate.change(
      formDOM.querySelector('#root_disabilities_0_disabilityStartDateMonth'),
      {
        target: {
          value: '1',
        },
    ...
    ReactTestUtils.Simulate.change(
      formDOM.querySelector('#root_disabilities_0_disabilityStartDateDay'),
      {
        target: {
          value: '1',
        },
    ...
    ReactTestUtils.Simulate.change(
      formDOM.querySelector('#root_disabilities_0_disabilityStartDateYear'),
      {
        target: {
          value: '2003',
        },
  ...
  it('should add another vamc', () => {
    ...
    ReactTestUtils.Simulate.click(
      formDOM.querySelectorAll('.va-growable-add-btn')[1],
    );
