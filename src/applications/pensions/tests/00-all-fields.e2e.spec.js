...
const runTest = E2eHelpers.createE2eTest(client => {
  ...
  client
    .openUrl(`${E2eHelpers.baseUrl}/pension/application/527EZ`)
    .waitForElementVisible('body', Timeouts.normal)
    .assert.title('Apply For Pension Benefits | Veterans Affairs')
  ...
  client.waitForElementVisible(
    'label[for="root_view:serveUnderOtherNamesYes"]',
    Timeouts.normal,
  );
  client.assert.cssClassPresent(
    '.progress-bar-segmented div.progress-segment:nth-child(1)',
  ...
  client.waitForElementVisible(
    'label[for="root_nationalGuardActivationYes"]',
    Timeouts.normal,
  );
  client.assert.cssClassPresent(
    '.progress-bar-segmented div.progress-segment:nth-child(1)',
  ...
  client.waitForElementVisible(
    'label[for="root_view:powStatusYes"]',
    Timeouts.normal,
  );
  client.assert.cssClassPresent(
    '.progress-bar-segmented div.progress-segment:nth-child(1)',
  ...
  client.waitForElementVisible(
    'label[for="root_disabilities_0_name"]',
    Timeouts.normal,
  );
  client.assert.cssClassPresent(
    '.progress-bar-segmented div.progress-segment:nth-child(1)',
  ...
  client.waitForElementVisible(
    'label[for="root_view:workedBeforeDisabledYes"]',
    Timeouts.normal,
  );
  client.assert.cssClassPresent(
    '.progress-bar-segmented div.progress-segment:nth-child(1)',
  ...
  // marriage info
  client.waitForElementVisible(
    'label[for="root_maritalStatus_0"]',
    Timeouts.normal,
  );
  client.assert.cssClassPresent(
    '.progress-bar-segmented div.progress-segment:nth-child(1)',
  ...
  // first marriage
  client.waitForElementVisible(
    'label[for="root_spouseFullName_first"]',
    Timeouts.normal,
  );
  client.assert.cssClassPresent(
    '.progress-bar-segmented div.progress-segment:nth-child(1)',
  ...
  // spouse info
  client.waitForElementVisible(
    'label[for="root_spouseDateOfBirthMonth"]',
    Timeouts.normal,
  );
  client.assert.cssClassPresent(
    '.progress-bar-segmented div.progress-segment:nth-child(1)',
  ...
  // spouse marriage
  client.waitForElementVisible(
    'label[for="root_dateOfMarriageMonth"]',
    Timeouts.normal,
  );
  client.assert.cssClassPresent(
    '.progress-bar-segmented div.progress-segment:nth-child(1)',
  ...
  // dependents
  client.waitForElementVisible(
    'label[for="root_view:hasDependentsYes"]',
    Timeouts.normal,
  );
  client.assert.cssClassPresent(
    '.progress-bar-segmented div.progress-segment:nth-child(1)',
  ...
  // dependent info
  client.waitForElementVisible(
    'label[for="root_childPlaceOfBirth"]',
    Timeouts.normal,
  );
  client.assert.cssClassPresent(
    '.progress-bar-segmented div.progress-segment:nth-child(1)',
  ...
  // monthly income info
  client.waitForElementVisible(
    'label[for="root_monthlyIncome_socialSecurity"]',
    Timeouts.normal,
  );
  client.assert.cssClassPresent(
    '.progress-bar-segmented div.progress-segment:nth-child(1)',
  ...
  client.waitForElementVisible(
    'label[for="root_expectedIncome_salary"]',
    Timeouts.normal,
  );
  client.assert.cssClassPresent(
    '.progress-bar-segmented div.progress-segment:nth-child(1)',
  ...
  // other expenses info
  client.waitForElementVisible(
    'label[for="root_view:hasOtherExpensesYes"]',
    Timeouts.normal,
  );
  client.assert.cssClassPresent(
    '.progress-bar-segmented div.progress-segment:nth-child(1)',
  ...
  client.waitForElementVisible(
    'label[for="root_spouseNetWorth_bank"]',
    Timeouts.normal,
  );
  client.assert.cssClassPresent(
    '.progress-bar-segmented div.progress-segment:nth-child(1)',
  ...
  client.waitForElementVisible(
    'label[for="root_spouseMonthlyIncome_socialSecurity"]',
    Timeouts.normal,
  );
  client.assert.cssClassPresent(
    '.progress-bar-segmented div.progress-segment:nth-child(1)',
  ...
  PageHelpers.completeMonthlyIncomeInfo(
    client,
  ...
  client.waitForElementVisible(
    'label[for="root_spouseExpectedIncome_salary"]',
    Timeouts.normal,
  );
  client.assert.cssClassPresent(
    '.progress-bar-segmented div.progress-segment:nth-child(1)',
  ...
  PageHelpers.completeExpectedIncomeInfo(
    client,
  ...
  client.waitForElementVisible(
    'label[for="root_view:spouseHasOtherExpensesYes"]',
    Timeouts.normal,
  );
  client.assert.cssClassPresent(
    '.progress-bar-segmented div.progress-segment:nth-child(1)',
  ...
  client.selectYesNo(
    'root_view:spouseHasOtherExpenses',
    testData.data['view:spouseHasOtherExpenses'],
  );
  PageHelpers.completeOtherExpensesInfo(
    client,
  ...
  PageHelpers.completeNetWorthInfo(
    client,
  ...
  client.selectYesNo(
    'root_view:hasOtherExpenses',
    testData.data.dependents[0]['view:hasOtherExpenses'],
  );
  client.assert.cssClassPresent(
    '.progress-bar-segmented div.progress-segment:nth-child(1)',
    'progress-segment-complete',
  ...
  client.selectYesNo(
    'root_view:hasOtherExpenses',
    testData.data.dependents[1]['view:hasOtherExpenses'],
  );
  PageHelpers.completeOtherExpensesInfo(
    client,
  ...
  // direct deposit
  client.waitForElementVisible(
    'label[for="root_view:noDirectDeposit"]',
    Timeouts.normal,
  );
  client.assert.cssClassPresent(
    '.progress-bar-segmented div.progress-segment:nth-child(1)',
  ...
  if (!process.env.SAUCE_ACCESS_KEY) {
    ...
    client.setValue(
      'input#root_files',
      require('path').resolve(`${__dirname}/test.png`),
    );
  ...
  // FDC page
  client.waitForElementVisible(
    'label[for="root_noRapidProcessingYes"]',
    Timeouts.normal,
  );
  client.assert.cssClassPresent(
    '.progress-bar-segmented div.progress-segment:nth-child(1)',
