          ...
          <ol>
            <li className="process-step list-one">
              ...
              <div>
                ...
                possible date that you can start getting benefits, you’ll need
                to complete an Intent to File a Claim for Compensation and/or
            ...
            <li className="process-step list-two">
                ...
                <div className="usa-alert-body">
                  ...
                  <div className="usa-alert-text">
                    <p>
                      ...
                      to get your claim processed, and there's no risk for you
                      to participate. With this program, you send in all the
              ...
              <p>
                <strong>
                  You might qualify for Aid and Attendance and Housebound
                  benefits
                </strong>
              </p>
