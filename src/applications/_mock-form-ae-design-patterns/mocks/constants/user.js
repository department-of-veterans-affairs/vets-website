...
const HOME_PHONE_FULL = `${USER.HOME_PHONE.AREA_CODE}${USER.HOME_PHONE.PHONE_NUMBER}`;
const MOBILE_PHONE_FULL = `${USER.MOBILE_PHONE.AREA_CODE}${USER.MOBILE_PHONE.PHONE_NUMBER}`;
