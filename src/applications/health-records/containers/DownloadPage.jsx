  ...
  renderMessageBanner = () => {
    ...
    if (!form.ready) {
      ...
      alertProps = {
        ...
        content: (
          <p>
            Unfortunately, we weren’t able to generate your most recent health
            records. You can try again in 24 hours or download an older version
            of your records below.
          </p>
        ),
        status: 'warning',
      };
      ...
      alertProps = {
        ...
        content: (
          <p>
            For security, your health records will only be available for
            download for 30 minutes. After that, or if you close this page,
            you’ll have to start a new request to get your records.
          </p>
        ),
        status: 'success',
      };
  ...
  renderConfirmModal() {
    const linkOnClick = e => {
      ...
      this.props.openModal(
        ...
        <div>
          <p>
            Generating a new health record will replace your most recent
            download request.
          </p>
    ...
    if (isMobile.any) {
      linkOnClick = e => {
        ...
        this.props.openModal(
          ...
          <div>
            <p>
              Health Records PDFs tend to be 1-2MB in size, but occasionally can
              be much larger. If this is downloaded over the cellular network,
              data charges may apply.
            </p>
            <div className="va-modal-actions">
              <button onClick={continueClick}>Yes, continue</button>
              <button
                onClick={this.props.closeModal}
                className="usa-button-secondary"
              >
  ...
  renderRequestDate() {
    ...
    return (
      <p>
        ...
        {moment(form.requestDate).format('MMMM Do YYYY')}
      </p>
    );
  }
