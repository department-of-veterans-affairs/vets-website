        ...
        return (
          <div>
            ...
            <ul>
              <li>
                Did you have{' '}
                {reasons[questionOneResponse].type === 'experience'
                  ? 'an'
                  : 'a'}{' '}
                {reasons[questionOneResponse].type} that may explain or
              ...
              <li>
                Why does the {reasons[questionOneResponse].type} directly
                explain or contribute to the discharge?
              </li>
              <li>
                Why does the {reasons[questionOneResponse].type} carry more
                weight than any other reasons you may have been discharged for?
              </li>
            </ul>
          </div>
        );
    ...
    const dd214Tips = (
      <ul>
        <li>
          ...
          change. Here you should explain why you need a new DD214, including
          any problems you face when you have to show both the DD214 and the
          DD215. You may want to consider attaching additional pages to fully
      ...
      <ul>
        ...
        {this.props.formValues['10_prevApplicationType'] === '3' && (
          <li>
            ...
            application, you’ll need to enter the previous application number in
            Item 6b. <strong>Note:</strong> You’re generally only eligible for
        ...
        {this.props.formValues['4_reason'] === '4' && (
          <li>
            Note: For upgrades related to sexual assault or harassment, you do
            not need to prove the original assault or harassment
            occurred—meaning if you didn’t file charges or report the incident,
            you can still apply for an upgrade. The important part of your
            application is where you explain the impact of the incident on your
            service. For example, detail how the incident caused a decrease in
            your productivity, or was the reason for PTSD.
          </li>
        )}
        ...
        {boardToSubmit.abbr === 'DRB' &&
          this.props.formValues['10_prevApplicationType'] !== '1' && (
            <li>
        ...
        {boardToSubmit.abbr === 'DRB' &&
          this.props.formValues['10_prevApplicationType'] === '1' && (
            <li>
              ...
              Appearance Review in Washington, DC. Note that you will have to
              pay your travel costs if you make a personal appearance.
            </li>
          )}
      </ul>
    );
    ...
    return (
      <li className="list-group-item">
        <div>
          ...
          {this.props.formValues['4_reason'] === '8'
            ? dd214Tips
            : nonDd2014Tips}
          <a
            target="_blank"
            ...
            content={
              <div>
                ...
                <p>
                  ...
                  Although many Veterans are successful on their own, you may
                  want to consider finding someone to advocate for you in this
                  process. Try a Veterans Service Organization (VSO), search
                  online for a lawyer who may provide services for low or no
    ...
    if (parseInt(this.props.formValues['2_dischargeYear'], 10) >= 1997) {
      ...
      militaryRecordInfo = (
        <p>
          ...
          personnel record (your Official Military Personnel File, or OMPF)
          mailed to you. If at first you get only some of the available records,
    ...
    return (
      <li className="list-group-item">
        <div>
          ...
          <p>
            To improve your chances of success, also include as many of the
            below documents as you can.
          </p>
          <ul>
            <li>
              ...
              access to your military records, especially if you served many
              years ago, so we strongly recommend you submit any relevant
              documents yourself.{' '}
              {boardToSubmit.abbr !== 'DRB' ? (
                <span>
              ...
              {specificTypeInstruction && (
                <p>
                  Remember, you should try to prove that{' '}
                  {specificTypeInstruction}. Submit any documents from this
                  record that help support your case for a discharge upgrade.
                </p>
              )}
            </li>
            ...
            <li>
              <strong>
                “Buddy Statements” or Other References From Service
              </strong>
              : On top of military records, you can attach statements from
              friends or colleagues you knew while in the service, or other
              individuals with direct knowledge of your time in the military.
              The content of the letter is more important than who it comes
              from, as long as the writer’s opinion is credible and they know
              you well. The writer should state how they learned about the facts
              or opinions they’re writing about. The letters may include
              statements about your achievements in the military, positive
              relationships you formed in the military, why your discharge may
              be unjust or incorrect, and your good deeds during that time.
            </li>
            <li>
              <strong>Testaments of Achievements Since Service</strong>: You may
              decide to add information about what you have achieved in your
              life since your discharge, particularly if your discharge involved
              any issues related to drugs, alcohol, or bad behavior. This can be
              in the form of a letter from an employer or community leader,
              evidence of successful drug treatment, or copies of certificates
              and degrees. The DoD will soon release more specific information
              about achievements since service, but, for now, add any
              achievements you would like to call out.
            </li>
          </ul>
        </div>
      </li>
  ...
  renderStepThree() {
    ...
    if (reasonCode === '8' && prevAppType !== '3') {
      ...
      boardExplanation = `the Discharge Review Board (DRB) for the ${
        this.props.formValues['1_branchOfService']
      ...
      this.props.formValues['11_failureToExhaust'] &&
      boardToSubmit.abbr === 'DRB'
    ) {
      boardExplanation = `the Discharge Review Board (DRB) for the ${
        this.props.formValues['1_branchOfService']
      ...
      reasonCode === '5' ||
      this.props.formValues['6_intention'] === '1'
    ) {
      boardExplanation = `the ${boardToSubmit.abbr} for the ${branchOfService(
        this.props.formValues['1_branchOfService'],
    ...
    if (
      boardToSubmit.abbr === 'DRB' &&
      this.props.formValues['1_branchOfService'] === 'army'
    ) {
      onlineSubmissionMsg = (
        <p>
      ...
      <li className="list-group-item">
        <div>
          ...
          <p>
            ...
            upgrades and corrections. Based on your answers on the previous
            page, you need to apply to {boardExplanation}
          </p>
          {prevAppYear === '1' &&
          ['BCNR', 'BCMR'].includes(board(this.props.formValues).abbr) ? (
            <p>
