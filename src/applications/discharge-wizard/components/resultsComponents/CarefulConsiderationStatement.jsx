        ...
        if (dischargeType === RESPONSES.DISCHARGE_DISHONORABLE) {
          return (
            <p>
              ...
              Veterans only because of their sexual orientation. If you apply
              for a discharge upgrade, DOD will apply "liberal consideration" to
              your case.
            </p>
          );
        }
        if (dischargeType === RESPONSES.DISCHARGE_HONORABLE) {
          return (
            <p>
              ...
              discharges only because of their sexual orientation. <br />{' '}
              <strong>Note:</strong> You’ll need to show that your discharge was
              solely due to your sexual orientation and related events. If the
              events weren’t related, you may still receive an upgrade. But
              you’ll have to prove your discharge was unjust punishment for
              those events.
            </p>
          );
        }
      ...
      case RESPONSES.REASON_SEXUAL_ASSAULT:
        return (
          <p>
            ...
            harassment. In 2017, the Defense Department (DOD) recognized that it
            discharged many Veterans due to sexual assault or harassment. And
            that many Veterans unfairly received discharges that weren’t
            ...
            specifically related to it. If the events leading to your discharge
            weren’t related to sexual assault or harassment, you may still
            receive an upgrade. But you’ll have to prove your discharge was
            unjust punishment for those events.
          </p>
        );
