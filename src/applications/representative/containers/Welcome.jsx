...
export default function Welcome() {
  ...
  return (
    <>
      <div className="welcome-page-container">
        ...
        <va-process-list>
          ...
          <li>
            ...
            <p>
              Contact the accredited representative you want to use to find out
          ...
          <li>
            ...
            <p>
              Please subit your form only after an accredited representative has
              agreed to help you.
            </p>
            <va-additional-info
      ...
      <a className="vads-c-action-link--green" href="/representative/search">
        Find an Accredited Representative
      </a>
      <h2>Learn more about accredited representatives</h2>
      <p>
        Appointing an accredited representative assigns power of attorney so you
        can get help with your VA claim or appeal. Find out how an accredited
        representative can help you.
      </p>
      <a href="/representative/welcome">Get help filing your claim or appeal</a>
