...
import { modernUrl } from 'platform/site-wide/mhv/utilities';
...
export const AuthContent = ({
  ...
  const useVaLinks = useToggleValue(TOGGLE_NAMES.mhvModernCtaLinks);
            ...
            <div itemProp="text">
              <div className="processed-content">
                ...
                <ul>
                  ...
                  <li>
                    Request VA referrals, test results, and prescription
                    renewals
                  </li>
            ...
            <div itemProp="text">
              <div className="processed-content">
                ...
                <p>
                  ...
                  the day or night. Your VA health care team should respond
                  within 3 business days (Monday through Friday, 8:00 a.m. to
                  5:00 p.m., except federal holidays). If you’d like, you can
                  set up your account to send a notification to your personal
                  email when you receive a new secure message.
                </p>
              </div>
            </div>
          </div>
            ...
            <div itemProp="text">
              <div className="processed-content">
                <p>
                  ...
                  secure messaging. It may take a few days for you to get a
                  reply.
                </p>
                <p>
                  <strong>If you think you have a medical emergency,</strong>{' '}
                  call 911 or go to the nearest emergency room.
                </p>
                <p>
                  <strong>
                    If you don’t have an emergency, but you’re not sure what
                ...
                <p>
                  ...
                  with—chronic pain, anxiety, depression, trouble sleeping,
                  anger, or even homelessness—we can support you. Our Veterans
                  Crisis Line is confidential (private), free, and available
                  24/7.
                </p>
                <p>
                  To connect with a Veterans Crisis Line responder anytime, day
                  or night:
                </p>
                <ul>
                  <li>
        ...
        <div itemScope itemType="http://schema.org/Question">
          ...
          >
            <div itemProp="text">
              <div className="processed-content">
                <p>
                  Yes. Our health management portals are secure. We follow
                  strict security policies and practices to protect your
                  personal health information. And only you and your VA health
                  care team will have access to your secure messages.
                </p>
                <p>
