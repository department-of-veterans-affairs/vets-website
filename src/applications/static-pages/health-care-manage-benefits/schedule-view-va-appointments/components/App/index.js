...
const App = () => (
  <article className="usa-content">
    ...
    <div className="va-introtext">
      <p>
        With our VA appointments tools, you can schedule some VA health care
        appointments online. You can also view details about upcoming
        appointments and organize your health calendar. Find out if you’re
        eligible, and how to sign up to begin using these tools.
      </p>
    </div>
    <div
    ...
    <CallToActionWidget appId="view-appointments" />
