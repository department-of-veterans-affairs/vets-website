  ...
  return (
    <>
      <h1 className="vads-u-font-size--h1">
        Download your 1095-B tax document
      </h1>
      <p className="va-introtext">
        The 1095-B is an IRS tax document that shows the period that you had
        health coverage through the VA for the tax year. Due to changes in the{' '}
        <a href="http://wwww.link.com">Affordable Care Act</a>, this document is
        no longer required to file your federal taxes; however some states may
        still require proof of health coverage.
      </p>
      <p className="vads-u-margin-bottom--5">
        <strong>Note:</strong> Some states may still require proof of health
        coverage. States requiring proof of coverage as of January 2022:
      ...
      <p className="vads-u-margin-top--3">
        ...
        <a href="http://wwww.link.com">1-877-222-VETS (8387)</a> Monday through
        Friday, 8:00 am until 8:00 pm (EST). Changes may take up to 10 business
        days to process and for you to receive your updated document.
      </p>
      <p className="vads-u-margin-top--3 vads-u-margin-bottom--5">
        <span className="vads-u-font-weight--bold">
          If you’re having trouble viewing your 1095-B.
        </span>{' '}
        To view your 1095-B after download, you may need the latest version of
        Adobe Acrobat Reader. It’s free to download.{' '}
