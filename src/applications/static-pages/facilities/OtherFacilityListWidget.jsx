    ...
    const facilitiesList = sortFacilitiesByName(this.state.facilities).map(
      facility => {
        ...
        return (
          <div
            key={facility.id}
            className="usa-width-one-whole vads-u-display--flex vads-u-flex-direction--column small-screen:vads-u-flex-direction--row facility vads-u-margin-bottom--2p5 small-screen:vads-u-margin-bottom--4 medium-screen:vads-u-margin-bottom--5"
          >
