...
Provider notes: ${vital.notes}\n\n`,
  ...
  if (records?.length) {
    ...
    return (
      <>
        <PrintHeader />
        <h1 className="vads-u-margin-bottom--3 desktop:vads-u-margin-bottom--4 no-print">
          {vitalDisplayName}
        </h1>
        ...
        <h2
          className="vads-u-font-size--base vads-u-font-weight--normal vads-u-font-family--sans vads-u-padding-y--1 
            ...
            vads-u-margin-top--3 desktop:vads-u-margin-top--4"
          id="showingRecords"
        >
            ...
            currentVitals?.map((vital, idx) => (
              ...
              >
                <h3
                  ...
                  className="vads-u-font-size--md vads-u-margin-top--0 vads-u-margin-bottom--2 desktop:vads-u-margin-bottom--3"
