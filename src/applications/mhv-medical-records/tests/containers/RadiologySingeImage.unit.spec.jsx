...
const radiologyDetails = {
  ...
  imagingLocation: '01 DAYTON, OH VAMC 4100 W. THIRD STREET , DAYTON, OH 45428',
...
const runRadiologySingleImageTests = ({
  basePath,
  pagePath,
  stateKey,
  detailsKey,
  ...
  const setup = (state = initialState) => {
    return renderWithStoreAndRouter(
      <RadiologySingleImage basePath={basePath} />,
      {
        initialState: state,
        reducers: reducer,
        path: pagePath,
...
describe('Radiology Single Image container', () => {
  describe('Labs and Tests path', () => {
    runRadiologySingleImageTests({
      basePath: '/labs-and-tests',
      pagePath: '/labs-and-tests/122/images/2',
  ...
  describe('Imaging Results path', () => {
    runRadiologySingleImageTests({
      ...
      pagePath: '/imaging-results/122/images/2',
      stateKey: 'radiology',
      detailsKey: 'radiologyDetails',
    });
  });
