...
export const vitalTypes = {
  ...
  PULSE: ['PULSE', 'HEART_RATE', 'PERIPHERAL_PULSE_RATE'],
  ...
  TEMPERATURE: [
    'TEMPERATURE',
    'BODY_TEMPERATURE',
    'TEMPERATURE_TEMPORAL_ARTERY',
  ],
  WEIGHT: ['WEIGHT', 'BODY_WEIGHT', 'WEIGHT_DOSING'],
...
export const vitalTypeDisplayNames = {
  ...
  PERIPHERAL_PULSE_RATE: 'Heart rate',
  ...
  SP_O_2: 'Blood oxygen level (pulse oximetry)',
  TEMPERATURE: 'Temperature',
  BODY_TEMPERATURE: 'Temperature',
  TEMPERATURE_TEMPORAL_ARTERY: 'Temperature',
  BODY_WEIGHT: 'Weight',
  WEIGHT: 'Weight',
  WEIGHT_DOSING: 'Weight',
  BODY_HEIGHT: 'Height',
  HEIGHT: 'Height',
...
export const vitalUnitDisplayText = {
  ...
  PERIPHERAL_PULSE_RATE: ' beats per minute',
