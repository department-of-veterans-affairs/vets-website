const sample = [
  // EKG with valid date
  {
    ...
    attributes: {
      ...
      observations: [
        ...
        {
          testCode: 'QRS_DURATION',
          value: { text: '88 ms', type: 'Quantity' },
  ...
  // EKG with undefined date - should also display "None recorded"
  {
    id: 'EKG-003-UNDEFINED-DATE',
    type: 'DiagnosticReport',
    attributes: {
      display: 'EKG (ELECTROCARDIOGRAM)',
      testCode: 'EKG',
      // dateCompleted is intentionally omitted (undefined)
      sampleTested: null,
      bodySite: null,
      location: 'EMERGENCY DEPARTMENT',
      orderedBy: 'Dr. Emily Chen',
      comments: 'Atrial fibrillation with rapid ventricular response.',
      source: 'oracle-health',
      observations: [
        {
          testCode: 'HEART_RATE',
          value: { text: '125 bpm', type: 'Quantity' },
          referenceRange: '60 - 100 bpm',
          status: 'final',
