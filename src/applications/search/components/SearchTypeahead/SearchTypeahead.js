...
class SearchTypeahead extends React.Component {
  static propTypes = {
    ...
    formatSuggestions: PropTypes.bool, // A boolean value for whether or not suggestions are formatted to have the suggested values highlighted
  ...
  render() {
    ...
    const isMobileClass = isMobile ? 'shrink-to-column' : '';
    ...
    return (
      <div
        id={`${id}-component`}
        className={`search-input vads-u-display--flex vads-u-width--full ${isMobileClass} ${
