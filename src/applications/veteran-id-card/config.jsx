...
module.exports = {
  ...
  messages: {
    VIC002: (<p>We're sorry. We're having trouble finding your records in our system right now. Please go to <a href="https://pint.access.va.gov/accessva/">AccessVA</a> to request a Veteran ID Card.</p>),
    ...
    VICV5: (<p>We're sorry. We're having trouble finding your records in our system right now. Please go to <a href="https://pint.access.va.gov/accessva/">AccessVA</a> to request a Veteran ID Card.</p>),
    VICV2: (<p>We’re sorry. We can’t confirm your eligibility for a Veteran ID card right now. To qualify for a Veteran ID Card, both of these must be true:
      <ul>
        ...
        <li>You separated under honorable or general (under honorable conditions)</li>
      </ul>
    </p>),
