 ...
 */
const extractLocation = (allergy, helpers, emptyField) => {
 ...
 *
 * @param {Object} allergy - FHIR AllergyIntolerance resource
 * @param {Object} helpers - Helper functions { isArrayAndHasItems }
 ...
 */
const extractObservedReported = (allergy, helpers, emptyField) => {
  const { isArrayAndHasItems } = helpers;
...
export const convertAllergy = (allergy, helpers, options = {}) => {
  ...
  const result = {
    ...
    location: extractLocation(
      allergy,
      { isArrayAndHasItems, extractContainedResource },
      emptyField,
    ),
    observedOrReported: extractObservedReported(
      allergy,
      { isArrayAndHasItems },
      emptyField,
    ),
 ...
 * @returns {Object} Normalized allergy object
 */
export const convertUnifiedAllergy = (allergy, helpers, options = {}) => {
  const { isArrayAndHasItems } = helpers;
