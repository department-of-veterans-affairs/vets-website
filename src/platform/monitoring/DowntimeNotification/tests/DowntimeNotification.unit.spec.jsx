...
describe('mapStateToProps', () => {
  ...
  test(
    'should set shouldSendRequest to true when scheduled downtime is not ready and a request is not pending',
    () => {
  ...
  test(
    'should have properties of a downtime object if downtime is found',
    () => {
...
describe('<DowntimeNotification/>', () => {
  ...
  test('calls getScheduledDowntime when rendered', () => {
  ...
  describe('No impending downtime', () => {
    ...
    test(
      'should render the children components when there are no dependencies',
      () => {
    ...
    test(
      'should render the children components when dependencies have no downtime',
      () => {
  ...
  describe('Approaching downtime', () => {
    test(
      'should render the children and a Modal when downtime is approaching',
      () => {
  ...
  describe('In downtime', () => {
    test(
      'should not render the children when we are in downtime and instead show an AlertBox',
      () => {
        const wrapper = getComponent([externalServices.mhv]);
  ...
  describe('custom render', () => {
    test('allows a custom render property', () => {
