...
const excludedForms = new Set([
  ...
  'HLR-CREATE-REQUEST-BODY-example',
  'HLR-CREATE-REQUEST-BODY-schema',
  'HLR-CREATE-REQUEST-HEADERS-example',
  'HLR-CREATE-REQUEST-HEADERS-schema',
  'HLR-CREATE-RESPONSE-200-example',
  'HLR-CREATE-RESPONSE-200-schema',
  'HLR-CREATE-RESPONSE-422-example',
  'HLR-CREATE-RESPONSE-422-schema',
  'HLR-GET-CONTESTABLE-ISSUES-REQUEST-BENEFIT-TYPE-schema',
  'HLR-GET-CONTESTABLE-ISSUES-REQUEST-HEADERS-example',
  'HLR-GET-CONTESTABLE-ISSUES-REQUEST-HEADERS-schema',
  'HLR-GET-CONTESTABLE-ISSUES-RESPONSE-200-example',
  'HLR-GET-CONTESTABLE-ISSUES-RESPONSE-200-schema',
  'HLR-GET-CONTESTABLE-ISSUES-RESPONSE-404-example',
  'HLR-GET-CONTESTABLE-ISSUES-RESPONSE-404-schema',
  'HLR-GET-CONTESTABLE-ISSUES-RESPONSE-422-example',
  'HLR-GET-CONTESTABLE-ISSUES-RESPONSE-422-schema',
  'HLR-SHOW-RESPONSE-200-example',
  'HLR-SHOW-RESPONSE-200-schema',
  'HLR-SHOW-RESPONSE-404-example',
  'HLR-SHOW-RESPONSE-404-schema',
]);
