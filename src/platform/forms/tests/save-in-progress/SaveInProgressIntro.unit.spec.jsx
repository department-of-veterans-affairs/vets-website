...
describe('Schemaform <SaveInProgressIntro>', () => {
  ...
  test('should render in progress message', () => {
    const user = {
      profile: {
        savedForms: [
  ...
  test('should pass prefills available prop', () => {
    const user = {
      profile: {
        savedForms: [
          { form: '1010ez', metadata: { lastUpdated: 3000, expiresAt: moment().unix() + 2000 } }
  ...
  test('should render sign in message', () => {
    const user = {
      profile: {
        savedForms: [
          { form: '1010ez', metadata: { lastUpdated: 3000, expiresAt: moment().unix() + 2000 } }
  ...
  test(
    'should render prefill Notification when prefill enabled and not signed in',
    () => {
  ...
  test('should render message if signed in with no saved form', () => {
    const user = {
      profile: {
        savedForms: [],
        prefillsAvailable: []
  ...
  test(
    'should render prefill notification if signed in with no saved form and prefill available',
    () => {
      const user = {
        profile: {
          savedForms: [],
  ...
  test(
    'should over-ride the default retentionPeriod prop when one supplied',
    () => {
      const prefillEnabled = true;
      const user = {
        profile: {
  ...
  test('should render loading indicator while profile is loading', () => {
    const user = {
      profile: {
        savedForms: [
          { form: '1010ez', metadata: { lastUpdated: 3000, expiresAt: moment().unix() + 2000 } }
  ...
  test('should render message if signed in with an expired form', () => {
    const user = {
      profile: {
        savedForms: [
  ...
  test('should render sign in message from render prop', () => {
    const user = {
      profile: {
        savedForms: [
          { form: '1010ez', metadata: { lastUpdated: 3000, expiresAt: moment().unix() + 2000 } }
  ...
  test('should render downtime notification', () => {
    const user = {
      profile: {
        savedForms: [
          { form: '1010ez', metadata: { lastUpdated: 3000, expiresAt: moment().unix() + 2000 } }
  ...
  test('should not render downtime notification when logged in', () => {
    const user = {
      profile: {
        savedForms: [
          { form: '1010ez', metadata: { lastUpdated: 3000, expiresAt: moment().unix() + 2000 } }
