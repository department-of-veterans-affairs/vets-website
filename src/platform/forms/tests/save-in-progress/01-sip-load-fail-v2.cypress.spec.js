...
import mockUser from '../fixtures/mocks/mockUserv2';
import mock1010Get from '../fixtures/mocks/mock1010Getv2';
import mock1010Put from '../fixtures/mocks/mock1010Putv2';
...
describe('SIP Load Fail Test', () => {
  it('Behaves accordingly when the load fails', () => {
    ...
    cy.intercept('GET', '/v0/in_progress_forms/XX-123', mock1010Get);
    cy.intercept('PUT', '/v0/in_progress_forms/XX-123', mock1010Put);
    cy.login();
