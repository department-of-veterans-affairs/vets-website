...
describe('Schemaform <RoutedSavableApp>', () => {
  ...
  test('should route when prefill unfilled', () => {
    const formConfig = {
      title: 'Testing'
    };
    const currentLocation = {
  ...
  test('should route and reset fetch status on success', () => {
    const formConfig = {
      title: 'Testing'
    };
    const currentLocation = {
  ...
  test('should route to error when failed', () => {
    const formConfig = {
      title: 'Testing'
    };
    const currentLocation = {
  ...
  test(
    'should route to the first page if started in the middle and not logged in',
    () => {
      const formConfig = {
        title: 'Testing'
      };
  ...
  test(
    'should load a saved form when starting in the middle of a form and logged in',
    () => {
      const formConfig = {
        title: 'Testing',
        formId: 'testForm'
  ...
  test(
    'should load a pre-filled form when starting in the middle of a form and logged in',
    () => {
      const formConfig = {
        title: 'Testing',
        formId: 'testForm'
  ...
  test('should skip pre-fill when skipPrefill is true', () => {
    const formConfig = {
      title: 'Testing',
      formId: 'testForm'
    };
