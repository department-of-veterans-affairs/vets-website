...
export default function EducationModalContent({ resBurden, ombNumber }) {
  return (
    <>
      ...
      <p>
        ...
        Section 3471. We need this information to determine your eligibility for
        education benefits.
      </p>
      ...
      <p>
        We may send educational forms or letters with a Veteran’s identifying
        ...
        to obtain further information as may be necessary from the school for VA
        to properly process the Veteran’s education claim or to monitor their
        progress during training. (Systems of Record Notices 58VA21, 58VA22,
        58VA28)
      </p>
      ...
      <p>
        ...
        denial of your request for education benefits. Failure to furnish the
      ...
      <p>
        ...
        disclosure of the SSN is required by a Federal Statute of law before
