...
describe('static <Footer> minimal-footer with various options', () => {
  ...
  it('should render minimal footer if boolean true', () => {
  ...
  it('should not render minimal footer if boolean true but on an excluded path', () => {
    const { container } = setup({
      footerHTML: '<div id="footerNav" data-minimal-footer="true"></div>',
      path: '/introduction',
    });
  ...
  it('should not render minimal footer if boolean false', () => {
    const { container } = setup({
  ...
  it('should render minimal footer if excluded paths are provided and not on an excluded path', () => {
    const { container } = setup({
      footerHTML:
        '<div id="footerNav" data-minimal-footer="{&quot;excludePaths&quot;:[&quot;/introduction&quot;,&quot;/confirmation&quot;]}"></div>',
      path: '/',
    });
  ...
  it('should render minimal footer if excluded paths are provided', () => {
    const { container } = setup({
      footerHTML:
        '<div id="footerNav" data-minimal-footer="{&quot;excludePaths&quot;:[&quot;/introduction&quot;,&quot;/confirmation&quot;]}"></div>',
      path: '/introduction',
  ...
  it('should not render minimal footer if enabled is specifically false', () => {
    const { container } = setup({
      footerHTML:
        '<div id="footerNav" data-minimal-footer="{&quot;enabled&quot;:false,&quot;excludePaths&quot;:[&quot;/introduction&quot;,&quot;/confirmation&quot;]}"></div>',
      path: '/',
    });
