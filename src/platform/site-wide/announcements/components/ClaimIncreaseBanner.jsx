...
export default function ClaimIncreaseBanner({ dismiss, isLoggedIn, profile }) {
  ...
  return (
    <div className="personalization-announcement">
      <span className="usa-label va-label-primary">New</span> <a onClick={dismiss} href="/beta-enrollment/claim-increase">Check out our new beta tool for filing a claim for increased disability compensation online.</a>
