...
const CATEGORY_NAME = 'Education and training';
    ...
    it('should correctly load the elements', () => {
      ...
      header()
        ...
        .within(() => {
          ...
          const viewAllSelector = '[data-e2e-id="view-all-in-education"]';
  ...
  describe('mobile menu', () => {
    it('should correctly load the elements', () => {
      ...
      headerNav().within(() => {
        ...
        h.verifyMenuItemsForMobile(educationAndTrainingButton, columnLinks);
      });
    });
  });
});
