    ...
    it('should correctly load the elements', () => {
      ...
      header()
        ...
        .within(() => {
          ...
          const viewAllSelector = '[data-e2e-id="view-all-in-records"]';
          const burialsAndMemorialsButton =
            '[data-e2e-id="vetnav-level2--records"]';
  ...
  describe('mobile menu', () => {
    it('should correctly load the elements', () => {
      ...
      headerNav().within(() => {
        ...
        h.verifyMenuItemsForMobile(recordsButton, columnLinks);
      });
    });
  });
});
