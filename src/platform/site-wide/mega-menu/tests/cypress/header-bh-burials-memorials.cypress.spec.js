...
const CATEGORY_NAME = 'Burials and memorials';
      ...
      header()
        ...
        .within(() => {
          ...
          const viewAllSelector =
            '[data-e2e-id="view-all-in-burials-and-memorials"]';
  ...
  describe('mobile menu', () => {
    it('should correctly load the elements', () => {
      ...
      headerNav().within(() => {
        ...
        h.verifyMenuItemsForMobile(burialsAndMemorialsButton, columnLinks);
      });
    });
  });
});
