...
As you can see we pass in a data argument located at `window.VetsGov.headerFooter.megaMenuData`. This data is derived from a YAML file located in the **_vagov-content_** repo at **_vagov-content/fragments/megamenu/index.yaml_**. There is a MetalSmith plugin that we created to add this to the global window. This is done in the build process. You can find the plugin code at _/src/site/stages/build/plugins/create-header-footer.js_
