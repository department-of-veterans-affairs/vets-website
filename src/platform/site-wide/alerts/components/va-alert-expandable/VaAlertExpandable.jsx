...
const VaAlertExpandable = props => {
  ...
  const handleOnclick = e => {
    ...
    recordEvent({
      ...
      'expandable-supplemental-status-heading': props.statusLabel,
    });
  };
  ...
  return (
    <div className="expandable-supplemental-status">
      <button
        type="button"
        className={`collapsible ${props.expandableSupplementalStatus}`}
      ...
      <div
        className={`content ${props.expandableSupplementalStatus} ${
...
VaAlertExpandable.propTypes = {
  expandableSupplementalStatus: PropTypes.string,
  extraInfo: PropTypes.string,
  iconType: PropTypes.string,
  statusLabel: PropTypes.string,
};

export default VaAlertExpandable;
