...
describe('<NavItem>', () => {
  ...
  test(
    'should render child nav items when it has children and it is expanded.',
    () => {
      const noop = () => {};
  ...
  test(
    'should render the ending line when nav item is first level and not the last nav item.',
    () => {
      const noop = () => {};
