...
class FeedbackForm extends React.Component {
  ...
  componentDidMount() {
    ...
    const descriptionId =
      this.descriptionComp && `#${this.descriptionComp.inputId}`;
    focusElement(descriptionId);
  }

  componentDidUpdate(prevProps) {
    if (
      !prevProps.formValues.shouldSendResponse &&
  ...
  sendFeedback = event => {
    ...
    if (this.props.formIsSubmittable)
      this.props.sendFeedback(this.props.formValues);
  };

  descriptionErrorMessage = () =>
    !this.state.suppressDescriptionErrors
      ? this.props.formErrors.description
      : '';

  emailErrorMessage = () =>
    !this.state.suppressEmailErrors ? this.props.formErrors.email : '';
          ...
          <div className="feedback-widget-form-container">
            <div className="feedback-widget-desc-container">
              <ErrorableTextArea
                ...
                ref={component => {
                  this.descriptionComp = component;
                }}
                required
              />
            </div>
            <ErrorableCheckbox
              ...
              onValueChange={shouldSendResponse =>
              ...
              <div className="usa-width-two-thirds">
                ...
                <div className="feedback-submit-container">
                  <button
                    type="submit"
                    disabled={
                      this.props.requestPending || !this.props.formIsSubmittable
                    }
