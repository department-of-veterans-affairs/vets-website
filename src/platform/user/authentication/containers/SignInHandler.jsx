...
export class SignInHandler extends React.Component {
  componentDidMount() {
  ...
  render() {
    return (
      <div>
        {this.props.children(this.props.login, this.props.profile)}
        <SignInModal
...
export default connect(mapStateToProps, mapDispatchToProps)(SignInHandler);
