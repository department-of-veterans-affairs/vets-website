        ...
        <div className="row">
          <div className="columns">
            <p>
              ...
              sign in. You’ll need to use a verified <strong>Login.gov</strong>{' '}
              or <strong>ID.me</strong> account that meets our new, stronger
              security requirements. With <strong>Login.gov</strong> or{' '}
              <strong>ID.me</strong>, you’ll still have access to all the same
              information and services you use today.
            </p>
            {canTransferMHVAccount ? (
              <p>
                We can help you transfer your account to{' '}
                <strong>Login.gov</strong> now. This process should take about
                [X] minutes. You’ll need access to your email account and your
                phone to transfer your account.
              </p>
            ) : (
              <p>
