...
describe('selectors', () => {
  ...
  describe('selectVet360Field', () => {
    beforeEach(hooks.beforeEach);
    test('looks up a field from the user vet360 data', () => {
  ...
  describe('selectVet360FailedTransactions', () => {
    beforeEach(hooks.beforeEach);
    test('returns only failed transactions from a list of transactions', () => {
      const failed = [
        {
          data: {
            attributes: {
  ...
  describe('selectEditedFormField', () => {
    beforeEach(hooks.beforeEach);
    test('looks up the form value in state for a given field name', () => {
      const fieldName = 'someField';
...
describe('vaProfileUseAddressValidation', () => {
  test('returns `true` if the feature flag is set', () => {
    expect(
  ...
  test('returns `undefined` if the feature flag is not set', () => {
    expect(
      selectors.vaProfileUseAddressValidation({
        featureToggles: {
