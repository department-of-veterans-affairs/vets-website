...
const CopyMailingAddress = ({
  ...
  const homeMailingAddressesEqual = areAddressesEqual(
    mailingAddress,
    residentialAddress,
  );
  ...
  const onChange = useCallback(
    () => {
      ...
      if (areAddressesEqual(mailingAddress, residentialAddress)) {
    ...
    [copyMailingAddress, mailingAddress, residentialAddress],
  );

  if (emptyMailingAddress) {
    return <div />;
  }
  ...
  return (
    <div className="copy-mailing-address-to-residential-address">
      <div className="form-checkbox-buttons form-checkbox">
        <input
          checked={homeMailingAddressesEqual}
...
CopyMailingAddress.propTypes = {
  copyMailingAddress: PropTypes.func,
