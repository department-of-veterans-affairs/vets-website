...
export const VAP_SERVICE_TRANSACTION_INTERVAL_ID_UPDATED =
  'VAP_SERVICE_TRANSACTION_INTERVAL_ID_UPDATED';
export const VAP_SERVICE_TRANSACTION_INTERVAL_ID_CLEARED =
...
export const clearTransactionIntervalId = id => {
  return {
    type: VAP_SERVICE_TRANSACTION_INTERVAL_ID_CLEARED,
    id,
  };
};

export const updateTransactionIntervalId = id => {
  return {
    type: VAP_SERVICE_TRANSACTION_INTERVAL_ID_UPDATED,
    id,
  };
};
