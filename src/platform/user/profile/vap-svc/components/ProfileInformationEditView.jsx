...
//     // Convert the field value to the correct payload format
//     const payload = convertCleanDataToPayload
//       ? convertCleanDataToPayload(field.value, field.name)
//       : field.value;

//     return onSubmit(payload)
//       .then(transaction => {
//         // If we got a form-only update flag from a 500 error
//         if (transaction?.formOnlyUpdate) {
//           // Only try to save to form if we have the form config
//           if (contactInfoFormAppConfig?.formData) {
//             const updatedFormAppData = {
//               ...contactInfoFormAppConfig.formData,
//               data: {
//                 ...contactInfoFormAppConfig.formData.data,
//                 [field.name]: field.value,
//               },
//             };

//             // Save to the form's data
//             dispatch(setData(updatedFormAppData));

//             // Save to the in-progress forms endpoint if we have the required data
//             if (
//               contactInfoFormAppConfig.formId &&
//               contactInfoFormAppConfig.version
//             ) {
//               dispatch(
//                 autoSaveForm(
//                   contactInfoFormAppConfig.formId,
//                   updatedFormAppData,
//                   contactInfoFormAppConfig.version,
//                   contactInfoFormAppConfig.returnUrl,
//                 ),
//               );
//             }
//           }

//           // Close the modal in all form-only update cases
//           this.props.onClose();
//           return;
//         }
...
//     return this.onSubmit(this.props.field.value);
//   };
