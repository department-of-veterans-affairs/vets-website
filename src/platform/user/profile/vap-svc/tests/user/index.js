...
const mockUserWithUpdatedHomePhone = set(
  cloneDeep(mockUser),
  'data.attributes.vet360ContactInformation.homePhone.phoneNumber',
  '8985555',
);

const mockUserWithUpdatedHomePhoneTimeStamp = set(
  cloneDeep(mockUserWithUpdatedHomePhone),
  'data.attributes.vet360ContactInformation.homePhone.updatedAt',
  '2023-03-11T16:31:56.000Z',
);

const mockUserWithUpdatedMailingAddress = set(
  set(
    cloneDeep(mockUser),
...
const mockUserWithNoEmail = set(
  cloneDeep(mockUser),
  'data.attributes.vet360ContactInformation.email',
  {},
);

const mockUserWithNoContactInfo = set(
  cloneDeep(mockUser),
  'data.attributes.vet360ContactInformation',
  {
    email: {
      ...mockUser.data.attributes.vet360ContactInformation.email,
      emailAddress: '',
    },
    homePhone: {
      ...mockUser.data.attributes.vet360ContactInformation.homePhone,
      phoneNumber: '',
      areaCode: '',
      countryCode: '',
      phoneType: '',
    ...
    mobilePhone: {
      ...mockUser.data.attributes.vet360ContactInformation.mobilePhone,
      phoneNumber: '',
      areaCode: '',
      countryCode: '',
      phoneType: '',
    ...
    mailingAddress: {
      ...mockUser.data.attributes.vet360ContactInformation.mailingAddress,
      addressLine1: '',
      addressLine2: '',
      addressLine3: '',
      city: '',
...
module.exports = {
  mockUser,
  mockUserWithUpdatedHomePhoneTimeStamp,
  mockUserWithUpdatedMailingAddress,
  mockUserWithNoEmail,
  mockUserWithNoContactInfo,
};
