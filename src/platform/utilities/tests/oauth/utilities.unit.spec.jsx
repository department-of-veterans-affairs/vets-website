...
describe('OAuth - Utilities', () => {
  ...
  describe('access token expiration helpers', () => {
    ...
    it('isAccessTokenExpiringSoon returns true when within threshold', () => {
      ...
      expect(oAuthUtils.isAccessTokenExpiringSoon(60)).to.be.true;
    });
    ...
    it('isAccessTokenExpiringSoon returns false when outside threshold', () => {
      ...
      sandbox
        .stub(Date, 'now')
        .returns(new Date('2025-06-29T20:39:00.000Z').getTime());

      expect(oAuthUtils.isAccessTokenExpiringSoon(60)).to.be.false;
    });
