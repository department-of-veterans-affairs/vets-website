 ...
 * @property {(formData: any) => UISchemaOptions} [updateUiSchema] Update the uiSchema based on formData. The function should return a partial uiSchema of only the properties you want to update, including 'ui:options' if desired. Does not work inside of an array. Recalculates on every formData change.
