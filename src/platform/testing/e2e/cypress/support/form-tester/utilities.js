...
/**
 * Fills individual fields that aren't part of pattern groups.
 * @param {jQuery} $form - The form element
 * @param {string} fieldSelector - Selector for form fields
 * @param {function} processFieldObject - Function to process individual fields
 * @param {function} createFieldObject - Function to create field objects
 * @returns {Cypress.Chainable} Cypress chain for proper async handling
 */
export const fillIndividualFields = (
  $form,
  fieldSelector,
  processFieldObject,
  createFieldObject,
  ...
  return cy.wrap(fields).each(element => {
    cy.wrap(createFieldObject(element), { log: false }).then(
      processFieldObject,
    );
  });
};
...
/**
 * Handles adding new array items if needed.
 * @param {jQuery} $form - The form element
 * @param {string} fieldSelector - Selector for form fields
 * @param {Object} snapshot - Object containing field counts for comparison
 * @param {function} addNewArrayItem - Function to add new array items
 */
export const handleArrayItemAddition = (
  $form,
  fieldSelector,
  snapshot,
  addNewArrayItem,
