...
const MAX_NUM_DISABILITY_SUGGESTIONS = 10;
...
class ComboBox extends Component {
  ...
  drawFreeTextOption(option) {
    ...
    return (
      <li key={-1} className={'usa-combo-box__list-option'} onClick={() => {this.selectOption(option)}} style={{ cursor: 'pointer' }}>
        {liText}
      </li>
    )
  }
  ...
  render() {
    ...
    return (
      ...
      <div className="usa-combo-box prototype-combobox-class" data-enhanced="true">
        ...
        <ul className={'usa-combo-box__list'} style={{ maxHeight: '480px' }}>
          {filteredOptions.map((option, index) => (
            <li key={index} className={'usa-combo-box__list-option'} onClick={() => {this.selectOption(option)}} style={{ cursor: 'pointer' }}>
              {option}
            </li>
          ))}
                    ...
                    <div class="input-section">
                          ...
                          <div class="schemaform-field-template schemaform-first-field">
                            ...
                            <div class="schemaform-widget-wrapper">
                              ...
                              {/* This is where we want to embed the new Combo-Box*/}
                                ...
                                {/* onChange={(value) => this.handleChange({ name: value })} */}
                                {/*  */}
                                <div style={{backgroundColor: 'red'}}>this.state.editMode:{this.state.editMode}</div>
                                <div style={{backgroundColor: 'red'}}>current.name:{current.name}</div>
                                <ComboBox
                      ...
                      <div class="row small-collapse">
                        ...
                        
                        {
                          ...
                          <div class="small-6 right columns"><button id="removeNewConditionButton" type="button" class="usa-button-secondary float-right" aria-label="Remove incomplete Condition" onclick="hideAddNewConditionSection()">Remove</button> 
                          </div> :
                        <div></div>
                         }
                      </div>
