...
export function fileHelp({ formData }) {
  ...
  return (
    <div>
      ...
      <ul>
        {hasSchoolChild &&
          <li>A completed Request for Approval of School Attendance (<a href="https://www.vba.va.gov/pubs/forms/VBA-21-674-ARE.pdf" target="_blank"><span className="usa-sr-only"></span>VA Form 21-674</a>)</li>}
        {hasDisabledChild &&
      ...
      <ul>
        <li>A completed Examination for Housebound Status or Permanent Need for Regular Aid and Attendance (<a href="https://www.vba.va.gov/pubs/forms/VBA-21-2680-ARE.pdf" target="_blank"><span className="usa-sr-only"></span>VA Form 21-2680</a>)</li>
        <li>A completed Request for Nursing Home Information in Connection with Claim for Aid and Attendance (<a href="https://www.vba.va.gov/pubs/forms/VBA-21-0779-ARE.pdf" target="_blank"><span className="usa-sr-only"></span>VA Form 21-0779</a>)</li>
      </ul>
...
export const schoolAttendanceWarning = (
  <div className="usa-alert usa-alert-warning">
    <div className="usa-alert-body">
      Since your child is between 18 and 23 years old, you’ll need to fill out a Request for Approval of School Attendance (<a href="https://www.vba.va.gov/pubs/forms/VBA-21-674-ARE.pdf" target="_blank"><span className="usa-sr-only"></span>VA Form 21-674</a>). <strong>You can send us this form later.</strong>
    </div>
  </div>
);
...
export const marriageWarning = (
  <div className="usa-alert usa-alert-warning">
    <div className="usa-alert-body">
      ...
      <p>Additional information on VA-recognized marriage is at <a href="http://www.va.gov/opa/marriage"><span className="usa-sr-only"></span>www.va.gov/opa/marriage</a>.</p>
    </div>
  </div>
);
