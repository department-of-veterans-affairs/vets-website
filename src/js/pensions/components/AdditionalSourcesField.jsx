...
export default class AdditionalSourcesField extends React.Component {
  constructor(props) {
    ...
    if (typeof this.props.uiSchema['ui:options'].viewField !== 'function') {
      throw new Error(`No viewField found in uiSchema for AdditionalSourcesField ${this.props.idSchema.$id}.`);
    }
      ...
      <div className={containerClassNames}>
        ...
        <div className="va-growable">
          ...
          {items.map((item, index) => {
            // This is largely copied from the default AdditionalSourcesField
