      ...
      case 'navComponent': {
        ...
        return (
          <div>
            ...
            <Modal cssClass="va-modal-large" visible={this.props.login.showModal}           focusSelector="button" onClose={this.handleCloseModal} id="signin-signup-modal" title="Sign in to Vets.gov">
              {modalContent}
            </Modal>
          </div>
        );
