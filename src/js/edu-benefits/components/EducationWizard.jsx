              ...
              sponsorTransferredBenefits === 'no' &&
                <div className="usa-alert usa-alert-warning">
                  <div className="usa-alert-body">
                    ...
                    <a target="_blank" href="https://www.dmdc.osd.mil/milconnect/public/faq/Education_Benefits-How_to_Transfer_Benefits"><span className="usa-sr-only">This will open a new website.</span>Instructions for your sponsor to transfer education benefits.</a>
                  </div>
                </div>}
