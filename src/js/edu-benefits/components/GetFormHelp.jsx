  ...
  return (
    <div>
      ...
      <p className="help-phone-number">
        ...
        <a className="help-phone-number-link" href="https://gibill.custhelp.com/app/utils/login_form/redirect/ask"><span className="usa-sr-only">This will open a new website.</span>Submit a question to Education Service</a>
      </p>
    </div>
  );
}
