...
const relinquishableBenefits = [
  ...
  { label: 'Montgomery GI Bill (MGIB-AD, Chapter 30)', additional: 'If you choose to give up MGIB-AD, you’ll get benefits only for the number of months you had left left under MGIB-AD.', value: 'chapter30' },
