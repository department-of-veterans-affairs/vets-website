...
export const benefitsLabels = {
  chapter33: <p>Post-9/11 GI Bill (Chapter 33)<br/><AdditionalInfo triggerText="Learn more.">
      If you served on active duty after September 10, 2001, you may qualify for Post-9/11 GI Bill education benefits—like money for tuition, housing, books, and supplies.
  </AdditionalInfo>
  </p>,
  chapter30: <p>Montgomery GI Bill (MGIB-AD, Chapter 30)<br/>
    <AdditionalInfo triggerText="Learn more.">
       If you served at least 2 years on active duty, you may qualify for MGIB-AD benefits—like money for tuition or training.
    </AdditionalInfo>
  </p>,
  chapter1606: <p>Montgomery GI Bill Selected Reserve (MGIB-SR, Chapter 1606)<br/>
    <AdditionalInfo triggerText="Learn more.">
      If you served in the Select Reserve for at least 6 years, you may qualify for up to 36 months of education and training benefits under the MGIB-SR program.
    </AdditionalInfo>
  </p>,
  chapter32: <p>Post-Vietnam Era Veterans’ Educational Assistance Program<br/>(VEAP, Chapter 32)<br/>
    <AdditionalInfo triggerText="Learn more.">
    You can continue your education by contributing part of your military pay to help cover the cost of school. The government will match $2 for every $1 you contribute.
    </AdditionalInfo>
  </p>,
  chapter1607: <p>Reserve Educational Assistance Program (REAP, Chapter 1607)<br/>
    <AdditionalInfo triggerText="Learn more.">
      REAP ended on November 25, 2015, but some REAP benefits will remain in place until November 2019. The Post-9/11 GI Bill has replaced REAP for Reserve and National Guard members called to active duty on or after September 11, 2001. If you’d like to stop using REAP and use the Post-9/11 GI Bill instead, call 1-888-GI-BILL-1 (1-888-442-4551).
    </AdditionalInfo>
  </p>,
  transferOfEntitlement: <p>Transfer of Entitlement Program (TOE)<br/>
    <AdditionalInfo triggerText="Learn more.">
      If you don’t use all of your GI Bill education benefits, you can transfer some of your unused benefits to your spouse or dependent children. You must request to transfer benefits while on active duty.
    </AdditionalInfo>
  </p>
};
...
export const survivorBenefitsLabels = {
  chapter35: <p>Survivors’ and Dependents’ Educational Assistance<br/>(DEA, Chapter 35)<br/>
    <AdditionalInfo triggerText="Learn more.">
      If you’re the child or spouse of a Veteran who has died or is disabled, you can get help paying for school or job training.
    </AdditionalInfo>
  </p>,
  chapter33: <p>The Fry Scholarship (Chapter 33)<br/>
    <AdditionalInfo triggerText="Learn more.">
      If you’re the child or surviving spouse of an active-duty Servicemember who died in the line of duty on or after September 11, 2001, you may be able to get benefits under the Fry Scholarship.
    </AdditionalInfo>
  </p>,
};
