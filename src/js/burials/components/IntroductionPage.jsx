        ...
        <div className="process schemaform-process schemaform-process-sip">
          ...
          <ol>
            ...
            <li className="process-step list-two">
              ...
              <p>Mail the application and other paperwork to your local regional benefit office.<br/><a href="/?facilityType=benefits&page=1&zoomLevel=4">Find your local regional benefit office</a>.</p>
            </li>
