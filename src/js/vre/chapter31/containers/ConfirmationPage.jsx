    ...
    return (
      <div>
        ...
        <div className="confirmation-guidance-container">
          ...
          <p className="confirmation-guidance-message">If you have questions, please call 1-877-222-VETS (1-877-222-8387) and press 2, Monday — Friday, 8:00 a.m. — 8:00 p.m. (ET).</p>
        </div>
