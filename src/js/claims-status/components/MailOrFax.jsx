  ...
  return (
    <div>
      ...
      <ol>
        ...
        <li>Mail or fax them to the <a target="_blank" href="http://www.benefits.va.gov/COMPENSATION/mailingaddresses.asp"><span className="usa-sr-only">This will open a new website.</span>VA Claims Intake Center.</a></li>
      </ol>
    </div>
  );
}
