...
export default function NoClaims() {
  return (
    <div className="usa-alert usa-alert-info claims-alert no-background-image claims-alert-status">
      ...
      <p>This page shows only completed claim applications. If you started a claim but haven’t finished it yet, go to <a href="https://www.ebenefits.va.gov/"><span className="usa-sr-only"></span>eBenefits</a> to work on it.</p>
    </div>
  );
}
