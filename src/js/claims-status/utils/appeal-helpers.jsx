...
export const hearingDescriptions = {
  video: {
    ...
    description: <p className="next-action-text">You will get a letter in the mail at least 30 days before your hearing is scheduled letting you know the date, time, and location of the hearing.</p>
  },
  ...
  central_office: { // eslint-disable-line camelcase
    ...
    description: <p className="next-action-text">You’ll get a letter in the mail at least 30 days before your hearing is scheduled. It will let you know the date and time of the hearing. The Board’s central office hearings take place at 425 Eye Street, NW, Washington, DC, 20001.</p>
  },
};

export function appealStatusDescriptions(lastEvent, previousHistory = [], style) {
  ...
  const contentMap = {
    hearing_held: { // eslint-disable-line camelcase
      status: {
        ...
        description: <p className={style}>Your hearing was held on {eventDateString} with a Veterans Law Judge in Washington, DC / through videoconference / at your local VA with the Traveling Board. The transcript of your hearing will be added to your appeal.</p>
      }
    },
    ...
    withdrawn: {
      status: {
        ...
        description: <p className={style}>Your appeal was withdrawn (canceled) by you or your representative. Your appeal is now closed.</p>
      }
    },
    form9: {
      status: {
        ...
        description: <div>
          <p className={style}>You submitted the Form 9, and the Veterans Benefits Administration (VBA) RO has received it. The RO is now processing your appeal to be sent to the Board.
          </p>
          <ul>
    ...
    ssoc: {
      status: {
        soc: {
          ...
          description: <div>
            <p className={style}>The Veterans Benefits Administration (VBA) RO has prepared the SSOC for your appeal. An SSOC was created because:</p>
            <ul>
            ...
            <p className={style}>When you receive a copy of the SSOC in the mail, you need to <a href="https://www.va.gov/vaforms/va/pdf/VA9.pdf">complete the Form 9</a>. This form asks you to review the SSOC and confirm the issues you want to appeal and why you want to appeal them. If you’d like VBA to certify your appeal to the Board, you need to complete and send back the Form 9 by (date). If you do not send back the Form 9, your appeal will be closed.</p>
            <p className={style}>On the Form 9, you can also let the Board know if you’d like a hearing for your appeal. <a href="/disability-benefits/claim-appeals/hearings/">Learn more about hearings</a>.</p>
            <p className={style}>If new evidence is added to your appeal, the RO will review the evidence and another SSOC will be developed.</p>
          </div>,
        },
        form9: {
          title: 'Your Supplemental Statement of the Case (SSOC) Was Prepared by the Regional Office (RO)',
          description: <div>
            <p className={style}>The Veterans Benefits Administration (VBA) RO has prepared an SSOC for your appeal. An SSOC was created because:</p>
            <ul>
              <li>You, your legal representative, your health care provider, or VA added new evidence to your appeal, and/or</li>
              <li>VA found it had further duty to assist you in developing your appeal, such as helping you get treatment records or providing a physical exam if needed.</li>
            </ul>
            <p className={style}>Your appeal is now ready for the RO to certify it to the Board. <strong>On average, this step takes 3 months.</strong>
            </p>
            <p className={style}>Note: If new evidence was added to your appeal, the RO will review the evidence and another SSOC will be developed. There isn’t an average time for this step because the complexity of the new evidence can vary.
            </p>
          </div>,
        },
        activated: {
          title: 'Your Supplemental Statement of the Case (SSOC) Was Prepared by the Regional Office (RO)',
          description: <p className={style}>VBA has completed the Board’s remand instructions to obtain additional evidence for your appeal, but was not able to grant some or all of your appeal based on that evidence. VBA completed an SSOC with the new evidence included. The SSOC has been sent to the Board, and you’ll get a copy of it in the mail.</p>
        },
      },
      nextAction: {
        title: `To continue with your appeal, we need your Form 9 by ${moment(lastEvent.date).add(60, 'days').format('MMMM DD, YYYY')}`,
        description: <div>
          <p className={style}>The Form 9 asks you to review the SOC and confirm the issues you would like to appeal and why you want to appeal them. You can also let the Board know if you would like a hearing for your appeal.</p>
          <p className={style}><a href="/disability-claims/claim-appeals/hearings">Learn more about hearings.</a></p>
        </div>,
      }
    },
    remand_ssoc: { // eslint-disable-line camelcase
      status: {
        ...
        description: <p className={style}>VBA has followed the Board’s remand instructions to find additional evidence for your appeal. VBA completed an SSOC with the new evidence included. The SSOC has been sent to the Board, and you will get a copy of it in the mail.</p>
      }
    },
    soc: {
      status: {
        ...
        description: <div>
          <p className={style}>The Veterans Benefits Administration (VBA) RO has mailed you the SOC for your appeal. Included with your SOC is the Form 9, which you can use to ask for your appeal to continue.</p>
          <p className={style}>
      ...
      nextAction: {
        title: `To continue with your appeal, we need your Form 9 by ${moment(lastEvent.date).add(60, 'days').format('MMMM DD, YYYY')}`,
        description: <div>
          <p className={style}>The Form 9 asks you to review the SOC and confirm the issues you want to appeal and why you want to appeal them. You can also let the Board know if you’d like a hearing for your appeal.</p>
          <p className={style}><a href="#">Learn more about hearings.</a></p>
        </div>,
      }
    },
    nod: {
      status: {
        ...
        description: <p className={style}>Your NOD has been received by the RO. The RO will make a decision or develop the Statement of the Case (SOC) for your appeal. This means they review all of the evidence related to your appeal, including any new evidence you submit. When the SOC is prepared, you will receive a copy of it in the mail.</p>,
      },
    },
    bva_final_decision: { // eslint-disable-line camelcase
      status: {
        ...
        description: <div>
          <p className={style}>The Board has made a decision on each issue within your appeal. You’ll receive a copy of the Board’s decision in the mail.</p>
          <h5>What if I don’t agree with the Board’s decision?</h5>
          <p className={style}>If you disagree with any part of the Board’s decision, you can appeal it by filing a Notice of Appeal with the United States Court of Appeals for Veterans Claims (CAVC), which is a federal court. You have 120 days to file an appeal with CAVC, if you decide to do so. <a href="https://www.uscourts.cavc.gov/appeal.php">Learn how to file an appeal with the CAVC.</a></p>
        </div>,
      },
    },
    certified: {
      status: {
        ...
        description: <div>
          <p className={style}>The Veterans Benefits Administration (VBA) RO has certified your appeal to the Board. This means your appeal is now waiting for the Board to receive it and place it in line for review by a Veterans Law Judge. You’ll be notified when your appeal is activated by the Board.</p>
          <p className={style}>The average time it takes for the Board to activate your appeal is 9 months.</p>
          <h5>Note:</h5>
          <ul>
    ...
    bva_remand: { // eslint-disable-line camelcase
      status: {
        ...
        description: <div>
          <p className={style}>The Board has made a decision on each issue within your appeal, and all or some of the issues have been remanded. This means the Veterans Law Judge who reviewed your appeal needs more information before making a decision on all or some of the issues.</p>
          <p className={style}>On average, about 62% of issues in appeals get remanded. The Board has sent your appeal to the Veterans Benefits Administration (VBA) to add any relevant information to your case. If a physical exam was requested, VBA will reach out to you. If your appeal is not granted during the VBA review, a Supplemental Statement of the Case (SSOC) will be developed and sent to the Board. You’ll also receive a copy of the SSOC in the mail.</p>
          <p className={style}><strong>On average, Veterans with appeals in the Remand stage wait about 14 months for VBA to complete the necessary action.</strong></p>
        </div>
      }
    },
    merged: {
    ...
    cavc_decision: { // eslint-disable-line camelcase
      status: {
        ...
        description: <div>
          <p className={style}>The CAVC has made a decision on your appeal. You’ll receive a copy of the CAVC’s decision in the mail.</p>
          <ul>
    ...
    activated: {
      status: {
        defaultStatus: {
          ...
          description: <div>
            <p className={style}>Your appeal has been activated by the Board. It is now in line for review by a Veterans Law Judge.</p>
            <p className={style}><strong>Note:</strong> At this point in the process, if you or your legal representative add new evidence, the evidence will be reviewed only by the Board and not by the RO. If someone other than you or your representative submits evidence, the Board will have to remand the appeal to the RO to consider the evidence. The RO will then either make a decision or, if some or all issues in your appeal can’t be granted, will prepare and send you a Supplemental Statement of the Case (SSOC). Sending the case back to the RO for this type of consideration can add years to the time it takes to decide your appeal, but you can avoid this additional delay if you send a letter to the Board that says you want the Board to consider the new evidence without sending it back to the RO.</p>
            <p className={style}>
        ...
        bva_remand: { // eslint-disable-line camelcase
          title: 'The Board Has Activated Your Appeal',
          description: <div>
            <p className={style}>The Veterans Benefits Administration (VBA) sent the Board the evidence asked for in the remand of your appeal. Your appeal has been activated by the Board and will be reviewed by a Veterans Law Judge.</p>
            <p className={style}><strong>Note:</strong> At this point in the process, if you or your legal representative adds new evidence, the evidence will be reviewed only by the Board and not by the RO. If someone other than you or your representative submits evidence, the Board will have to remand the appeal to the RO to consider the evidence. The RO will then either make a decision or, if some or all issues in your appeal can’t be granted, will prepare and send you a Supplemental Statement of the Case (SSOC). Sending the case back to the RO for this type of consideration can add years to the time it takes to decide your appeal, but you can avoid this additional delay if you send a letter to the Board that says you want the Board to consider the new evidence without sending it back to the RO.</p>
            <p className={style}>
              <strong>
        ...
        cavc_decision: { // eslint-disable-line camelcase
          ...
          description: <div>
            <p className={style}>Your appeal has been returned to the Board from the CAVC. It’s been activated by the Board and will be reviewed by a Veterans Law Judge.</p>
            <p className={style}>If you have additional evidence you would like the Board to review, you can add it within 90 days from the CAVC decision. You’ll receive a letter from the Board about how to submit new evidence during this time period.</p>
            <p className={style}>
              <strong>
