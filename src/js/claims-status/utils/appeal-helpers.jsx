...
export function appealStatusDescriptions(lastEvent, previousHistory = [], styles = 'claims-first-paragraph') {
  ...
  const contentMap = {
    hearing_held: { // eslint-disable-line camelcase
      status: {
        ...
        description: <p className={styles}>Your hearing was held on {eventDateString} with a Veterans Law Judge in Washington, DC / through videoconference / at your local VA with the Traveling Board. The transcript of your hearing will be added to your appeal.</p>
      }
    },
    hearing_cancelled: { // eslint-disable-line camelcase
      status: {
        ...
        description: <div>
          <p className={styles}>Your hearing was scheduled for {eventDateString}.</p>
    ...
    hearing_no_show: { // eslint-disable-line camelcase
      status: {
        ...
        description: <div>
          <p className={styles}>Your hearing was scheduled for {eventDateString} with a Veterans Law Judge in Washington, DC / through videoconference / at your local VA with the Traveling Board. Because you missed the date, your hearing has been canceled. The Judge will make a decision based on the information you have provided.</p>
    ...
    withdrawn: {
      status: {
        ...
        description: <p className={styles}>Your appeal was withdrawn (canceled) by you or your representative. Your appeal is now closed.</p>
      }
    },
    form9: {
      status: {
        ...
        description: <div>
          <p className={styles}>You submitted the Form 9, and the Veterans Benefits Administration (VBA) RO has received it. The RO is now processing your appeal to be sent to the Board.
          </p>
          <ul>
    ...
    ssoc: {
      status: {
        soc: {
          ...
          description: <div>
            <p className={styles}>The Veterans Benefits Administration (VBA) RO has prepared the SSOC for your appeal. An SSOC was created because:</p>
            <ul>
        ...
        form9: {
          title: 'Your Supplemental Statement of the Case (SSOC) Was Prepared by the Regional Office (RO)',
          description: <div>
            <p className={styles}>The Veterans Benefits Administration (VBA) RO has prepared an SSOC for your appeal. An SSOC was created because:</p>
            <ul>
    ...
    remand_ssoc: { // eslint-disable-line camelcase
      status: {
        ...
        description: <p className={styles}>VBA has followed the Board’s remand instructions to find additional evidence for your appeal. VBA completed an SSOC with the new evidence included. The SSOC has been sent to the Board, and you will get a copy of it in the mail.</p>
      }
    },
    soc: {
      status: {
        ...
        description: <div>
          <p className={styles}>The Veterans Benefits Administration (VBA) RO has mailed you the SOC for your appeal. Included with your SOC is the Form 9, which you can use to ask for your appeal to continue.</p>
          <p>
      ...
      nextAction: {
        title: `To continue with your appeal, we need your Form 9 by ${moment(lastEvent.date).add(60, 'days').format('MMMM DD, YYYY')}`,
        description: <div>
          <p className={styles}>The Form 9 asks you to review the SOC and confirm the issues you want to appeal and why you want to appeal them. You can also let the Board know if you’d like a hearing for your appeal.</p>
    ...
    nod: {
      status: {
        ...
        description: <p className={styles}>Your NOD has been received by the RO. The RO will make a decision or develop the Statement of the Case (SOC) for your appeal. This means they review all of the evidence related to your appeal, including any new evidence you submit. When the SOC is prepared, you will receive a copy of it in the mail.</p>,
      },
    },
    bva_final_decision: { // eslint-disable-line camelcase
      status: {
        ...
        description: <div>
          <p className={styles}>The Board has made a decision on each issue within your appeal. You’ll receive a copy of the Board’s decision in the mail.</p>
          <h5>What if I don’t agree with the Board’s decision?</h5>
          <p className={styles}>If you disagree with any part of the Board’s decision, you can appeal it by filing a Notice of Appeal with the United States Court of Appeals for Veterans Claims (CAVC), which is a federal court. You have 120 days to file an appeal with CAVC, if you decide to do so. <a href="https://www.uscourts.cavc.gov/appeal.php">Learn how to file an appeal with the CAVC.</a></p>
        </div>,
      },
    },
    certified: {
      status: {
        ...
        description: <div>
          <p className={styles}>The Veterans Benefits Administration (VBA) RO has certified your appeal to the Board. This means your appeal is now waiting for the Board to receive it and place it in line for review by a Veterans Law Judge. You’ll be notified when your appeal is activated by the Board.</p>
    ...
    bva_remand: { // eslint-disable-line camelcase
      status: {
        ...
        description: <div>
          <p className={styles}>The Board has made a decision on each issue within your appeal, and all or some of the issues have been remanded. This means the Veterans Law Judge who reviewed your appeal needs more information before making a decision on all or some of the issues.</p>
    ...
    cavc_decision: { // eslint-disable-line camelcase
      status: {
        ...
        description: <div>
          <p className={styles}>The CAVC has made a decision on your appeal. You’ll receive a copy of the CAVC’s decision in the mail.</p>
          <ul>
    ...
    activated: {
      status: {
        defaultStatus: {
          ...
          description: <div>
            <p className={styles}>Your appeal has been activated by the Board. It is now in line for review by a Veterans Law Judge.</p>
        ...
        bva_remand: { // eslint-disable-line camelcase
          title: 'The Board Has Activated Your Appeal',
          description: <div>
            <p className={styles}>The Veterans Benefits Administration (VBA) sent the Board the evidence asked for in the remand of your appeal. Your appeal has been activated by the Board and will be reviewed by a Veterans Law Judge.</p>
        ...
        cavc_decision: { // eslint-disable-line camelcase
          ...
          description: <div>
            <p className={styles}>Your appeal has been returned to the Board from the CAVC. It’s been activated by the Board and will be reviewed by a Veterans Law Judge.</p>
