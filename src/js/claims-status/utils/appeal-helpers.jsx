    ...
    bva_final_decision: { // eslint-disable-line camelcase
      status: {
        ...
        description: <div>
          ...
          <p className="claims-first-paragraph">If you disagree with any part of the Board’s decision, you can appeal it by filing a Notice of Appeal with the United States Court of Appeals for Veterans Claims (CAVC), which is a federal court. You have 120 days to file an appeal with CAVC, if you decide to do so. <a href="https://www.uscourts.cavc.gov/appeal.php"><span className="usa-sr-only"></span>Learn how to file an appeal with the CAVC.</a></p>
        </div>,
      },
    },
    certified: {
