          ...
          onAllComplete: () => {
            if (!hasError) {
              ...
              dispatch(setNotification({
                ...
                body:
                  <span>Thank you for sending us {trackedItem ? trackedItem.displayName : 'additional evidence'}. We’ll let you know when we’ve reviewed it.<br/>
                  Note: It may take a few minutes for your uploaded file to show here. If you don’t see your file, please try refreshing the page.</span>
              }));
            } else {
              window.dataLayer.push({
