  ...
  if (unregistered) {
    view = (
      <h4>
        ...
        If you think you should be able to access these health tools, please call the Vets.gov Help Desk at 1-855-574-7286 (TTY: 800-877-8339). We’re here Monday–Friday, 8:00 a.m.–8:00 p.m. (ET).
      </h4>
    );
  } else {
    view = children;
      ...
      const alertContent = (
        <div>
          ...
          <p>
            ...
            If you need more help, please call the Vets.gov Help Desk at 1-855-574-7286 (TTY: 800-877-8339). We’re here Monday–Friday, 8:00 a.m.–8:00 p.m. (ET).
          </p>
        </div>
      );
