    ...
    <div className="usa-alert usa-alert-warning usa-content not-qualified">
      <div className="usa-alert-body">
        ...
        <ul>
          ...
          <li>If you’re enrolled in education benefits through another chapter (Montgomery GI Bill (MGIB) or Reservists Educational Assistance Program (REAP)), check our <a target="_blank" href="https://www.gibill.va.gov/wave/index.do"><span className="usa-sr-only"></span>Web Automated Verification of Enrollment (W.A.V.E)</a></li>
        </ul>
      </div>
    </div>
  );
