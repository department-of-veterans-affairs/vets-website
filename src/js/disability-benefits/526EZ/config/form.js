...
const formConfig = {
  ...
  chapters: {
    reviewVeteranDetails: {
      ...
      //         _.get(`disabilities.${pagePerItemIndex}.diagnosticText`, formData),
      ...
      //         _.get(`disabilities.${index}.view:vaMedicalRecords`, formData),
      //       uiSchema: {
      //         disabilities: {
      //           items: {
      //             'ui:title': disabilityNameTitle,
      ...
      //                     'ui:widget': 'date',
      //                     'ui:title':
      //                       'Approximate date of first treatment since you received your rating'
      //                   },
      //                   endTreatment: {
      //                     'ui:widget': 'date',
      ...
      //       arrayPath: 'disabilities',
      //       depends: (formData, index) =>
      //         _.get(`disabilities.${index}.view:privateMedicalRecords`, formData),
      //       uiSchema: {
      //         disabilities: {
      //           items: {
      //             'ui:title': disabilityNameTitle,
      ...
      //           `disabilities.${index}.view:privateMedicalRecords`,
      //           formData
      //         );
      ...
      //           items: {
      //             'ui:description':
      //               'Please let us know where and when you received treatment. We’ll request your private medical records for you. If you have your private medical records available, you can upload them later in the application',
      ...
      //                   privateMedicalRecordsReleaseAccepted: {
      //                     'ui:title':
      //                       'I give my consent, or permission, to my doctor to only release records related to this condition'
      //                   },
      //                   'view:privateMedicalRecordsReleasePermissionRestricted': {
      ...
      //                   },
      //                   treatmentCenterCountry: {
      //                     // TODO: need to update schema to use default def
      //                     'ui:title': 'Country'
      //                   },
      //                   treatmentCenterStreet1: {
      //                     'ui:title': 'Street'
      ...
      //       depends: (formData, index) =>
      //         _.get(`disabilities.${index}.view:otherEvidence`, formData),
