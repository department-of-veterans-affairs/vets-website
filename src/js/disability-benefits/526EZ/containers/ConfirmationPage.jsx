  ...
  render() {
    ...
    return (
      <div>
        ...
        <p><strong>If you need us to get your private medical records from your doctor,</strong> you’ll need to fill out an Authorization to Disclose Information to the VA (VA Form 21-4142). If you didn’t upload this form to your application, you can download it here and mail it in.<br>  <a href="https://www.vba.va.gov/pubs/forms/VBA-21-4142-ARE.pdf">Download VA Form 21-4142</a>.</p><br/>

        Please print the form, fill it out, and send it to:<br/>
        <dl className="va-address-block">
