  ...
  render() {
    ...
    return (
      <div className="claim-decision-is-ready usa-alert usa-alert-info claims-no-icon claims-alert-status">
        ...
        <p>If we decided that an issue you claimed wasn’t service connected, and you have new evidence that you haven’t submitted yet, you can ask VA to reopen your claim. <a href="/disability-benefits/claims-process/claim-types/reopened-claim/" target="_blank">Find out how to reopen your claim</a>.</p>
        <p>Has your condition gotten worse since you filed your claim? You can file a new claim for an increase in disability compensation. <a href="/disability-benefits/claims-process/claim-types/new-claim/" target="_blank">Find out how to file a new claim</a>.</p>
        ...
        <p>Are you enrolled in VA health care? If not, you can apply now. <a href="/healthcare/apply" target="_blank">Apply for VA health care</a>.</p>
      </div>
    );
  }
}
