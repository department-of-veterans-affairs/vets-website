  ...
  render() {
    ...
    return (
      <div className="claim-decision-is-ready usa-alert usa-alert-info claims-no-icon claims-alert-status">
        ...
        <p>If you have new evidence to support your claim and have not yet appealed, you can ask us to <a href="/disability-benefits/claims-process/claim-types/reopened-claim">Reopen your claim</a></p>
      </div>
    );
  }
}
