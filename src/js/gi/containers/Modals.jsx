    ...
    return (
      <span>
        ...
        <Modal onClose={this.props.hideModal} visible={this.shouldDisplayModal('accredited')}>
          ...
          <p>Accreditation matters if you plan to start school at one institution and transfer to another to complete your degree. Be sure to ask any potential school about their credit transfer policy. The U.S. Department of Education (ED) maintains a&nbsp;<a href="http://ope.ed.gov/accreditation/" id="anch_384" target="_blank"><span className="usa-sr-only"></span>database</a>&nbsp;of accredited postsecondary institutions and programs. Accreditation is a recognized credential for schools and some programs. As stated by the ED, the goal of accreditation is to ensure that the education provided by institutions of higher education meets acceptable levels of quality.</p>
          <p>To learn more about accreditation, visit the <a href="http://www.benefits.va.gov/gibill/comparison_tool/about_this_tool.asp#accreditation" target="_blank"><span className="usa-sr-only"></span> about this tool</a> page. </p>
        </Modal>
    ...
    return (
      <span>
        <Modal onClose={this.props.hideModal} visible={this.shouldDisplayModal('cautionInfo')}>
          ...
          <p><a href="https://studentaid.ed.gov/sa/about/data-center/school/hcm" target="_blank"><span className="usa-sr-only"></span>Heightened Cash Monitoring</a></p>
          <p><a href="http://ope.ed.gov/accreditation/" target="_blank"><span className="usa-sr-only"></span>Accreditation</a></p>
          <p><a href="https://www.dodmou.com/Home/Faq" target="_blank"><span className="usa-sr-only"></span>DoD Probation For Military Tuition Assistance</a></p>
          <p><a href="https://www.ftc.gov/news-events/press-releases/2016/01/ftc-brings-enforcement-action-against-devry-university" target="_blank"><span className="usa-sr-only"></span>Federal Trade Commission Filed Suit for Deceptive Advertising</a></p>
          <p><a href="http://www.justice.gov/opa/pr/profit-college-company-pay-955-million-settle-claims-illegal-recruiting-consumer-fraud-and" target="_blank"><span className="usa-sr-only"></span>Settlement reached with the Federal Trade Commission (FTC)</a></p>
          <p><a href="http://www.benefits.va.gov/gibill/comparison_tool/about_this_tool.asp#caution" target="_blank"><span className="usa-sr-only"></span>Suspended for 85/15 violation – Flight Program</a></p>
          <p><a href="http://www.benefits.va.gov/gibill/comparison_tool/about_this_tool.asp#caution" target="_blank"><span className="usa-sr-only"></span>Denial of Recertification Application to Participate in the Federal Student Financial Assistance Programs</a></p>
          <p><a href="http://www.benefits.va.gov/gibill/comparison_tool/about_this_tool.asp#ACICS" target="_blank"><span className="usa-sr-only"></span>School operating under provisional accreditation (previously accredited by ACICS)</a></p>
          <p>
    ...
    return (
      <span>
        <Modal onClose={this.props.hideModal} visible={this.shouldDisplayModal('calcTuition')}>
          ...
          <p>When you select some schools, we import the average tuition/fees for an undergraduate student as reported by the school to the Department of Education through <a href="http://nces.ed.gov/ipeds/datacenter/" id="anch_442" target="blank"><span className="usa-sr-only"></span>IPEDS</a>. This is the same information that is published on <a href="http://nces.ed.gov/collegenavigator/" id="anch_443" target="blank"><span className="usa-sr-only"></span>College Navigator</a>.</p>
        ...
        <Modal onClose={this.props.hideModal} visible={this.shouldDisplayModal('calcInStateTuition')}>
          ...
          <p>Generally, in-state residents are charged a discounted rate of tuition and fees. VA pays the in-state tuition & fee rate at public schools. <a href="http://www.benefits.va.gov/gibill/resources/benefits_resources/rate_tables.asp#ch33#TUITION" target="_blank"><span className="usa-sr-only"></span>Click here for more information.</a></p>
        </Modal>
    ...
    return (
      <span>
        ...
        <Modal onClose={this.props.hideModal} visible={this.shouldDisplayModal('cumulativeService')}>
          ...
          <p>
            For detailed information about Cumulative Post-9/11 Service, visit <a href="http://www.benefits.va.gov/gibill/comparison_tool/about_this_tool.asp#cumulativeservice" target="_blank"><span className="usa-sr-only"></span>this page</a>.
          </p>
        </Modal>
