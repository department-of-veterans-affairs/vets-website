...
export class Modals extends React.Component {
  ...
  renderProfilePageModals() {
    return (
      <span>
        ...
        <Modal onClose={() => this.props.hideModal()} visible={!!this.props.giModals.gradrates}>
        ...
        <Modal onClose={() => this.props.hideModal()} visible={!!this.props.giModals.salaries}>
        ...
        <Modal onClose={() => this.props.hideModal()} visible={!!this.props.giModals.repayment}>
  ...
  renderProfileSchoolHeaderModals() {
    return (
      <span>
        <Modal onClose={() => this.props.hideModal()} visible={!!this.props.giModals.gibillstudents}>
          <h2>GI Bill Beneficiaries</h2>
  ...
  renderProfileVeteranSummaryModals() {
    return (
      <span>
        <Modal onClose={() => this.props.hideModal()} visible={!!this.props.giModals.vetgroups}>
        ...
        <Modal onClose={() => this.props.hideModal()} visible={!!this.props.giModals.yribbon}>
          <h2>Yellow Ribbon</h2>
        ...
        <Modal onClose={() => this.props.hideModal()} visible={!!this.props.giModals.poe}>
        ...
        <Modal onClose={() => this.props.hideModal()} visible={!!this.props.giModals.tool}>
          <h2>GI Bill Comparison Tool: About This Tool</h2>
        ...
        <Modal onClose={() => this.props.hideModal()} visible={!!this.props.giModals.eightKeys}>
          <h2>8 Keys to {'Veterans\''} Success Sites</h2>
  ...
  renderProfileSummaryModals() {
    return (
      <span>
        ...
        <Modal onClose={() => this.props.hideModal()} visible={!!this.props.giModals.accredited}>
        ...
        <Modal onClose={() => this.props.hideModal()} visible={!!this.props.giModals.typeAccredited}>
        ...
        <Modal onClose={() => this.props.hideModal()} visible={!!this.props.giModals.tuitionPolicy}>
        ...
        <Modal onClose={() => this.props.hideModal()} visible={!!this.props.giModals.singleContact}>
        ...
        <Modal onClose={() => this.props.hideModal()} visible={!!this.props.giModals.creditTraining}>
  ...
  renderProfileHistoryModals() {
    return (
      <span>
        <Modal onClose={() => this.props.hideModal()} visible={!!this.props.giModals.facilityCode}>
          <h2>VA Facility Code</h2>
          <p>Unique identifier for VA approved facilities.</p>
        </Modal>

        <Modal onClose={() => this.props.hideModal()} visible={!!this.props.giModals.ipedsCode}>
          <h2>ED IPEDS Code</h2>
        ...
        <Modal onClose={() => this.props.hideModal()} visible={!!this.props.giModals.opeCode}>
          <h2>ED OPE Code</h2>
  ...
  renderProfileCautionFlagModals() {
    return (
      <span>
        <Modal onClose={() => this.props.hideModal()} visible={!!this.props.giModals.cautionInfo}>
          <h2>Caution Flag</h2>
  ...
  renderProfileCalculatorModals() {
    return (
      <span>
        <Modal onClose={() => this.props.hideModal()} visible={!!this.props.giModals.calcTuition}>
          <h2>Tuition / Fees (/year)</h2>
        ...
        <Modal onClose={() => this.props.hideModal()} visible={!!this.props.giModals.calcYr}>
          <h2>Yellow Ribbon amount from school (/year)</h2>
          <p>Enter the total tuition/fees, you will be charged for the academic year.</p>
        ...
        <Modal onClose={() => this.props.hideModal()} visible={!!this.props.giModals.calcScholarships}>
          <h2>Scholarships (not Pell)</h2>
        ...
        <Modal onClose={() => this.props.hideModal()} visible={!!this.props.giModals.calcEnrolled}>
          <h2>Enrolled</h2>
        ...
        <Modal onClose={() => this.props.hideModal()} visible={!!this.props.giModals.calcSchoolCalendar}>
          <h2>School Calendar:</h2>
          <p>Is your school on a semester, quarter or non-traditional calendar system?</p>
        </Modal>

        <Modal onClose={() => this.props.hideModal()} visible={!!this.props.giModals.calcKicker}>
          <h2>Eligble for Kicker?</h2>
