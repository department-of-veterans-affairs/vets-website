...
class ProfileCalculator extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      spouse_active_duty: 'yes',
      elig_for_post_gi_bill: 'yes',
      online: 'yes',
      in_state: 'yes',
      tuition_fees: '234234234',
      in_state_tuition_fees: '234234234',
      books: '234234',
      yellow_ribbon: 'yes',
      yellow_ben: '234234234',
      scholar: '234234234',
      tuition_assist: '234234234',
      kicker_elig: 'yes',
      buy_up_elig: 'yes',
    };
      ...
      <div className="calc-questions large-6 columns nopadding">
        <div id="tuition-fees-section">
          <div id="in-state" className="form-group">
            ...
            <input onChange={(e) => { this.setState({in_state: e.target.value}) }} id="in-state-yes" name="in_state" type="radio" value="yes" className="filter-item filter-in-state"/>
            <label className="radio" htmlFor="in-state-yes">Yes</label>
            <input onChange={(e) => { this.setState({in_state: e.target.value}) }} id="in-state-no" name="in_state" type="radio" value="no" defaultChecked className="filter-item filter-in-state"/>
          ...
          <div id="tuition-fees-form" className="form-group top-aligned">
            ...
            <input onChange={(e) => { this.setState({tuition_fees: e.target.value}) }} id="tuition-fees-input" type="text" defaultValue="$0" name="Tuition Fees" alt="Tuition Fees" className="filter-item"/>
          </div>
          ...
          <div id="in-state-tuition-fees-form" className="form-group top-aligned">
            ...
            <input onChange={(e) => { this.setState({in_state_tuition_fees: e.target.value}) }} id="in-state-tuition-fees" type="text" defaultValue="$0" name="In-state Tuition Fees" alt="In-state Tuition Fees" className="filter-item"/>
          </div>
          ...
          <div id="yellow-ribbon-recipient-form">
            ...
            <input onChange={(e) => { this.setState({yellow_ribbon: e.target.value}) }} id="yellow-ribbon-recipient-yes" name="receiving_yellow_ribbon" type="radio" value="yes" className="filter-item"/>
            <label className="radio" htmlFor="yellow-ribbon-recipient-yes">Yes</label>
            <input onChange={(e) => { this.setState({yellow_ribbon: e.target.value}) }} id="yellow-ribbon-recipient-no" name="receiving_yellow_ribbon" type="radio" value="no" defaultChecked className="filter-item"/>
          ...
          <div id="yellow-ribbon-amount-form" className="form-group top-aligned">
            ...
            <input onChange={(e) => { this.setState({yellow_ribbon_ben: e.target.value}) }} id="yellow-ribbon-amount" type="text" defaultValue="$0" name="Yellow Ribbon Amount From School" alt="Yellow Ribbon Amount From School" className="filter-item" />
        ...
        <div id="tuition-assist-form" className="form-group top-aligned">
          ...
          <input onChange={(e) => { this.setState({tuition_assist: e.target.value}) }} id="tuition-assist" type="text" defaultValue="$0" name="Military Tuition Assistance" alt="How much are you receiving in military tuition assistance" className="filter-item" />
        </div>
        ...
        <div id="enrollment-section">
          ...
          <div id="enrolled-form-old-gi-bill">
            ...
            <div>
              <select onChange={(e) => { this.setState({old_rop: e.target.value}) }} id="enrolled-old" name="Enrolled" alt="Select your enrollment level" className="filter-item">
          ...
          <div id="working-form" className="form-group top-aligned">
            ...
            <select onChange={(e) => { this.setState({ojt_working: e.target.value}) }} id="working" name="Will be working" alt="Select how much you will be working" className="filter-item">
          ...
          <div id="number-non-traditional-terms-form" className="form-group top-aligned">
            ...
            <select defaultValue="2" onChange={(e) => { this.setState({number_nontrad_terms: e.target.value}) }} id="number-non-traditional-terms" name="How many terms / year?" alt="Select how many terms / year?" className="filter-item">
          ...
          <div id="length-non-traditional-terms-form" className="form-group top-aligned">
            ...
            <select defaultValue="3" onChange={(e) => { this.setState({length_nontrad_terms: e.target.value}) }} id="length-non-traditional-terms" name="How long is each term?" alt="Select how long is each term?" className="filter-item">
          ...
          <div id="kicker-elig-form">
            ...
            <input onChange={(e) => { this.setState({kicker_elig: e.target.value}) }} id="kicker-elig-yes" name="kicker_eligible" type="radio" value="yes" className="filter-item"/>
            <label className="radio" htmlFor="kicker-elig-yes">Yes</label>
            <input onChange={(e) => { this.setState({kicker_elig: e.target.value}) }} id="kicker-elig-no" name="kicker_eligible" type="radio" value="no" defaultChecked className="filter-item"/>
          ...
          <div id="buy-up-form">
            ...
            <input onChange={(e) => { this.setState({buy_up_elig: e.target.value}) }} id="buy-up-yes" name="buy-up" type="radio" value="yes" className="filter-item" />
            <label className="radio" htmlFor="buy-up-yes">Yes</label>
            <input onChange={(e) => { this.setState({buy_up_elig: e.target.value}) }} id="buy-up-no" name="buy-up" type="radio" value="no" defaultChecked className="filter-item" />
          ...
          <div id="buy-up-rate-form" className="form-group top-aligned">
            ...
            <select onChange={(e) => { this.setState({buy_up: e.target.value}) }} id="buy-up-rate" name="How much did you pay?" alt="Select how much you paid" className="filter-item">
