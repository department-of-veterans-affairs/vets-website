    ...
    if (this.props.success) {
      ...
      view = (
        <div>
          ...
          <h4>If you'd like us to let you know when the application is working again, please enter your email address here. Note: We'll use your email only to contact you about the Veteran Identification Card. See our privacy policy.</h4>
