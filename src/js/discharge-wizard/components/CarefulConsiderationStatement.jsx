    ...
    case '2':
      return (
        <div>
          ...
          <p>
            You do not need a DD214 to make this application—you only need to specifically mention this period of honorable service when you apply for VA benefits. (We may do a Character of Discharge review to confirm your eligibility.) If you want a DD214 for your period of honorable service for other reasons, you can request one. <Link to="/request-dd214" target="_blank">Get instructions on how to request a DD214 for your period of honorable service</Link>
          </p>
          <p>
            If you'd like to apply to upgrade your final discharge, follow the instructions below.
          </p>
