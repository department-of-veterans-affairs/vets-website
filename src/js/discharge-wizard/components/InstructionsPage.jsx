                      ...
                      <div className="usa-accordion">
                        <ul className="usa-unstyled-list">
                          <li itemScope itemType="http://schema.org/Question">
                            <button className="usa-button-unstyled usa-accordion-button" aria-controls="dbq1" itemProp="name">What if I already applied for an upgrade or correction?</button>
                          ...
                          <li itemScope itemType="http://schema.org/Question">
                            <button className="usa-button-unstyled usa-accordion-button" aria-controls="dbq2" itemProp="name">What if I have multiple discharges of varying characters?</button>
                          ...
                          <li itemScope itemType="http://schema.org/Question">
                            <button className="usa-button-unstyled usa-accordion-button" aria-controls="dbq4" itemProp="name">Can I apply for VA benefits in the meantime?</button>
