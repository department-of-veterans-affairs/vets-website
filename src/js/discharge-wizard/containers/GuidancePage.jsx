    ...
    return (
      <li className="list-group-item">
        <div>
          ...
          <a target="_blank" href={form.link} className="usa-button-primary va-button" ref={(el) => { this.downloadFormBtn = el; }}>Download Form {form.num}<span className="exit-icon"></span></a>
          <AlertBox
            content={<div>
