...
class GuidancePage extends React.Component {
        ...
        <div>
          ...
          <AlertBox
            content={<div>
              ...
              <p>The process of preparing a discharge upgrade or correction application can sometimes be a lot of work and take a long time. Although many Veterans are successful by themselves, it may be helpful to find someone to advocate for you in this process. Try a <a href="https://www.va.gov/vso/"><span className="usa-sr-only">This will open a new website.</span>VSO</a>, search online for a lawyer who may provide services for low or no cost, or ask other Veterans for recommendations.</p>
            </div>}
            isVisible
            status="warning"/>
        </div>
  ...
  renderStepTwo() {
    ...
    if (parseInt(this.props.formValues['2_dischargeYear'], 10) >= 1997) {
      militaryRecordInfo = <p>You can <a target="_blank" href="https://www.dpris.dod.mil/veteranaccess.html"><span className="usa-sr-only">This will open a new website.</span>retrieve your complete military personnel record</a> (your Official Military Personnel File, or OMPF) online.</p>;
    } else {
      militaryRecordInfo = <p>You can make a <a target="_blank" href="https://www.archives.gov/veterans/military-service-records"><span className="usa-sr-only">This will open a new website.</span>request online or by mail to receive your complete military personnel record</a> (your Official Military Personnel File, or OMPF) in the mail. You may at first only receive a portion of the available records; you will want to request the full set of records.</p>;
    }
    ...
    if (['1', '2', '4'].indexOf(this.props.formValues['4_reason']) > -1) {
      ...
      return (
        <li>
          ...
          <ul>
            <li>You can request your VA medical records by submitting <a target="_blank" href="https://www.va.gov/vaforms/medical/pdf/vha-10-5345-fill.pdf"><span className="usa-sr-only">This will open a new website.</span>VA Form 10-5345</a> to your local VA Medical Center.</li>
  ...
  renderStepThree() {
    ...
    if (boardToSubmit.abbr === 'DRB' && this.props.formValues['1_branchOfService'] === 'army') {
      onlineSubmissionMsg = <p>You can also submit this information online at <a target="_blank" href="http://actsonline.army.mil/"><span className="usa-sr-only">This will open a new website.</span>ACTSOnline</a>. </p>;
    } else {
