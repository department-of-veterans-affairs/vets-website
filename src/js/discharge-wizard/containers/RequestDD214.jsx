      ...
      <div>
        ...
        <div className="medium-8">
          <div className="va-introtext">
            <p>
              To receive a second DD214 reflecting <strong>only</strong> your period of honorable service, you'll need to complete Department of Defense (DoD) Form 149 and send it to the {board(formValues, true).abbr}—<strong>do not</strong> send it to the Discharge Review Board (DRB)] for the {branchOfService(formValues['1_branchOfService'])}.
            </p>
          </div>
          <ul className="vertical-list-group more-bottom-cushion numbered">
            <li className="list-group-item">
              <div>
                ...
                <ul>
                  <li>Pay special attention to item 6, which asks for the reason for your change. Be clear that you want a DD214 for your honorable period of service, and include the dates of that period.</li>
