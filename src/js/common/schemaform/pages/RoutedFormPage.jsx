...
class RoutedFormPage extends React.Component {
  componentDidMount() {
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(RoutedFormPage));

export { RoutedFormPage };
