...
class Pagination extends React.Component {
  ...
  next() {
    ...
    if (this.props.pages > this.props.page) {
      nextPage = (
        <a aria-labelledby="Next page" onClick={() => {this.props.onPageSelect(this.props.page + 1);}}>
          Next
        </a>
      );
    }
  ...
  prev() {
    ...
    if (this.props.page > 1) {
      prevPage = (
        <a aria-labelledby="Previous page" onClick={() => {this.props.onPageSelect(this.props.page - 1);}}>
