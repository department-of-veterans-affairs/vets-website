    ...
    if (this.props.authRequired === 1) {
      ...
      if (this.props.userProfile.accountType === 3) {
        ...
        if (this.props.userProfile.status === 'SERVER_ERROR' && !attemptingAppealsAccess) {
          ...
          // in our system.
          return <SystemDownView messageLine1="We couldn’t find your records with that information." messageLine2="Please call the Vets.gov Help Desk at 1-855-574-7286, TTY: 1-800-877-8339, Monday &#8211; Friday, 8:00 a.m. &#8211; 8:00 p.m. (ET)."/>;
        }
