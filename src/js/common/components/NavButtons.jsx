...
export default class NavButtons extends React.Component {
  ...
  render() {
    ...
    let buttons;
    if (path.endsWith('review-and-submit') || path.endsWith('review-and-submit/')) {
      let submitButton;
      let submitMessage;
    ...
    } else if (path.endsWith('submit-message') || path.endsWith('submit-message/')) {
      buttons = (
        <div className="row form-progress-buttons">
          <div className="small-6 medium-5 columns">
            <a href="/">
    ...
    } else if (path.endsWith('introduction') || path.endsWith('introduction/')) {
      buttons = (
        <div className="row form-progress-buttons">
          <div className="small-6 medium-5 columns">
            <ProgressButton
