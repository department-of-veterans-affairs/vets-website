...
export const letterContent = {
  ...
  proof_of_service: 'This card shows that you served honorably in the Armed Forces. This card can also be used in place of a VA identification card.',
  ...
  service_verification: 'This letter shows your branch of service, the date you started active duty, and the date you were discharged from active duty.',
