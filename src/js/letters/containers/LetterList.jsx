  ...
  render() {
    ...
    return (
      <div className="step-content" aria-live="polite">
        ...
        <p>
          To download a letter, you’ll need the latest version of Adobe Reader. It’s free to download. <a href="https://get.adobe.com/reader/otherversions/" target="_blank"><span className="usa-sr-only">This will open a new website.</span>Get Adobe Reader</a>
        </p>
        <p>
