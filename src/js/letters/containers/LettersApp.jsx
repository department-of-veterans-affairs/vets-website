  ...
  if (unregistered) {
    view = (
      <h4>
        ...
        If you think you should be able to access this information, please call the Vets.gov Help Desk at <a href="tel:855-574-7286">1-855-574-7286</a> (TTY: 1-800-877-8339). We’re here Monday–Friday, 8:00 a.m.–8:00 p.m. (ET).
      </h4>
    );
  } else {
    view = children;
