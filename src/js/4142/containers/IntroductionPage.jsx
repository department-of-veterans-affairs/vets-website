  ...
  render() {
    return (
      <div className="schemaform-intro">
        <FormTitle title="Authorization to disclose information"/>
        <p>Equal to VA Form 21-4142 (Authorization to disclose information).</p>
        <SaveInProgressIntro
          ...
          Please complete the 21-4142 form to apply for authorization to disclose information.
        </SaveInProgressIntro>
        <h4>Follow the steps below to apply for authorization to disclose information.</h4>
        <div className="process schemaform-process">
          <ol>
            ...
            <li className="process-step list-two">
              <div><h5>Apply</h5></div>
              <p>Complete this authorization to disclose information form.</p>
        ...
        <div className="omb-info--container" style={{ paddingLeft: '0px' }}>
          <OMBInfo resBurden={5} ombNumber="2900-0001" expDate="8/31/2017"/>
        </div>
      </div>
    );
  }
