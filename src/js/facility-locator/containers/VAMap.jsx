            ...
            <TabPanel>
              <Map ref="map" center={position} zoom={parseInt(currentQuery.zoomLevel, 10)} style={{ width: '100%', maxHeight: '55vh' }} scrollWheelZoom={false} zoomSnap={0.5} zoomDelta={0.5} onMoveEnd={this.handleBoundsChanged} onLoad={this.handleBoundsChanged} onViewReset={this.handleBoundsChanged}>
                <TileLayer
                  ...
                  attribution='Map data &copy; <a href="http://openstreetmap.org"><span className="usa-sr-only"></span>OpenStreetMap</a> contributors, <a href="http://creativecommons.org/licenses/by-sa/2.0/"><span className="usa-sr-only"></span>CC-BY-SA</a>, Imagery © <a href="http://mapbox.com"><span className="usa-sr-only"></span>Mapbox</a>'/>
