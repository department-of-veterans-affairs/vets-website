    ...
    return (
      <div className="usa-alert usa-alert-warning schemaform-prefill-message">
        <div className="usa-alert-body">
          ...
          We’ve already filled in some of this form based on information you gave us. To protect your identity, we will do an additional review of your application if you change or edit your name, date of birth, or Social Security number on this page. This means it could take us longer to approve your Veteran ID Card application.
        </div>
      </div>
    );
