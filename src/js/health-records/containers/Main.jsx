...
import ErrorableRadioButtons from '../components/ErrorableRadioButtons';
        ...
        { label: 'Last year', value: '1yr' },
        {
          label: (
            <div aria-live="assertive" className={customDateOptionClass}>
              ...
              {/* The span class="usa-sr-only" is invisible to sighted users, but will offer additional instruction for screen readers */}
