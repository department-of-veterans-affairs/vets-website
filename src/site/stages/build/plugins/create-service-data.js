        ...
        for (const healthItem of services.fieldLocalHealthCareService) {
          if (healthItem.entity && healthItem.entity.fieldAbout) {
            const opStatus = {
              ...
              service:
                healthItem.entity.fieldRegionalHealthService.entity
                  .fieldServiceNameAndDescripti.entity.name,
              status: healthItem.entity.fieldAbout.entity
                ? healthItem.entity.fieldAbout.entity.fieldOperatingStatus
                : '',
              notes: healthItem.entity.fieldAbout.entity
                ? healthItem.entity.fieldAbout.entity.fieldOperatingStatusNotes
                    .value
                : '',
            };
            bufferData.push({
