...
const transform = entity => {
  return {
    ...
    fieldClpEventsReferences: entity.fieldClpEventsReferences?.[0],
    fieldClpFaqCta: entity.fieldClpFaqCta?.[0],
    fieldClpFaqPanel: getDrupalValue(entity.fieldClpFaqPanel),
    fieldClpFaqParagraphs: entity.fieldClpFaqParagraphs?.[0],
    fieldClpResources: entity.fieldClpResources?.[0],
    ...
    fieldClpSpotlightLinkTeasers: entity.fieldClpSpotlightLinkTeasers?.[0],
    ...
    fieldClpStoriesTeasers: entity.fieldClpStoriesTeasers?.[0],
    ...
    fieldClpWhatYouCanDoPromos: entity.fieldClpWhatYouCanDoPromos?.[0],
