...
describe('<SaveInProgressErrorPage>', () => {
  ...
  it('should render the unrecoverable failure error', () => {
    ...
    expect(findDOM.querySelector('.usa-alert').textContent).to.contain('We’re sorry, but something went wrong. We can’t find your application');
  ...
  it('should render the recoverable failure error', () => {
    ...
    expect(findDOM.querySelector('.usa-button-outline').textContent).to.contain('Back');
    expect(findDOM.querySelector('.usa-button-primary').textContent).to.contain('Continue Application');
  });
  it('should go back', () => {
