...
describe('Schemaform <SaveInProgressIntro>', () => {
  ...
  it('should render in progress message', () => {
    ...
    expect(tree.find('Connect(FormStartControls)').exists()).to.be.true;
    expect(tree.find('Connect(FormStartControls)').props().prefillAvailable).to.be.false;
    expect(tree.find('Connect(FormStartControls)').props().startPage).to.equal('testing');
  });
  it('should pass prefills available prop', () => {
    ...
    expect(tree.find('Connect(FormStartControls)').props().prefillAvailable).to.be.true;
  });
  ...
  it('should render loading indicator while profile is loading', () => {
    ...
    expect(tree.find('Connect(FormStartControls)').exists()).to.be.false;
  });
