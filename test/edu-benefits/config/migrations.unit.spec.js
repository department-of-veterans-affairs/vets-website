  ...
  describe('first migration', () => {
    it('should remove urlPrefix from returnUrl', () => {
      const data1990 = {
        ...
        metadata: {
          returnUrl: '/1990/abc/' // eslint-disable-line camelcase
        }
      };
      ...
      const data1990e = {
        ...
        metadata: {
          returnUrl: '/1990E/abc/' // eslint-disable-line camelcase
        }
      };
      ...
      const data1990n = {
        ...
        metadata: {
          returnUrl: '/1990n/abc/' // eslint-disable-line camelcase
        }
      };
      ...
      const data1995 = {
        ...
        metadata: {
          returnUrl: '/1995/abc/' // eslint-disable-line camelcase
        }
      };
      ...
      const data5490 = {
        ...
        metadata: {
          returnUrl: '/5490/abc/' // eslint-disable-line camelcase
        }
      };
      ...
      const data5495 = {
        ...
        metadata: {
          returnUrl: '/5495/abc/' // eslint-disable-line camelcase
        }
      };
      ...
      expect(migrations1990[0](data1990)).to.eql({
        formId: formConfig1990.formId,
        metadata: {
          returnUrl: '/abc/' // eslint-disable-line camelcase
        }
      });
