...
import AdditionalMilitaryInformationSection from '../../src/js/hca/components/military-service/AdditionalMilitaryInformationSection';
import AnnualIncomeSection from '../../src/js/hca/components/household-information/AnnualIncomeSection';
import BirthInformationSection from '../../src/js/hca/components/veteran-information/BirthInformationSection';
import ChildInformationSection from '../../src/js/hca/components/household-information/ChildInformationSection';
...
import DemographicInformationSection from '../../src/js/hca/components/veteran-information/DemographicInformationSection';
import FinancialDisclosureSection from '../../src/js/hca/components/household-information/FinancialDisclosureSection';
import InsuranceInformationSection from '../../src/js/hca/components/insurance-information/InsuranceInformationSection';
import IntroductionSection from '../../src/js/hca/components/IntroductionSection.jsx';
import PersonalInfoSection from '../../src/js/hca/components/veteran-information/PersonalInfoSection';
import ReviewAndSubmitSection from '../../src/js/hca/components/ReviewAndSubmitSection.jsx';
import ServiceInformationSection from '../../src/js/hca/components/military-service/ServiceInformationSection';
import SpouseInformationSection from '../../src/js/hca/components/household-information/SpouseInformationSection';
import VAInformationSection from '../../src/js/hca/components/va-benefits/VAInformationSection';
...
import veteran from '../../src/js/hca/reducers/veteran';
