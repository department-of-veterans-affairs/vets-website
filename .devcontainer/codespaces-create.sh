...
set -e
cd ../vets-website && yarn cache clean && yarn install --production=false --prefer-offline && yarn build -- --host="${CODESPACE_NAME}-3001.githubpreview.dev/" --api=--host="${CODESPACE_NAME}-3000.githubpreview.dev/"
