...
const coveragePath = `NODE_ENV=test nyc --all ${coverageInclude} --reporter=lcov --reporter=spec --reporter=json-summary mocha --reporter mocha-junit-reporter --no-color --retries 5`;
