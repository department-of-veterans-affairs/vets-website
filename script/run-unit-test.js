...
const command = `mocha src/applications/appeals/995/tests/components/EvidenceVaRecords.unit.spec.jsx src/applications/check-in/hooks/tests/useSendTravelPayClaim/useSendTravelPayClaim.unit.spec.jsx
`;
