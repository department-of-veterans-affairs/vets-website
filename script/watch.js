...
const watchCommand = `NODE_OPTIONS=--max-old-space-size=${memory} webpack-dev-server --config config/webpack/webpack.config.js --env.scaffold --env.watch ${process.argv
  .slice(2)
  .join(' ')}`;
