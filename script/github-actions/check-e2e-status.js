    ...
    return {
      ...
      message:
        daysSinceWarned > 60
          ...
          : 'Code in this PR is associated with this test spec which is currently under a warning due to being disabled for at least 45 days. If this warning is not cleared, merging will be blocked when the time passes 90 days. See the E2E Allow List for full details',
