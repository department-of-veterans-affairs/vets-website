...
DOCKER_ARGS = "-v ${WORKSPACE}/vets-website:/application -v ${WORKSPACE}/content-build:/content-build -v ${WORKSPACE}/vagov-content:/vagov-content --ulimit nofile=8192:8192"
