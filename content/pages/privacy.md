...
#### Privacy Act Rights
VA follows the requirements of the Privacy Act, which protects your personal information that VA maintains in “systems of records”.  A system of records is a file, database, or program from which personal information is retrieved by name or other personal identifier.  The Privacy Act provides a number of protections for your personal information.  These typically include how information is collected, used, disclosed, stored, and disposed.  VA System of Records Notices are available at:  Department of Veterans Affairs Privacy Act Systems of Records [LINK TO http://www.oprm.va.gov/ers/].  Vets.gov is a platform that uses your data from VA Systems of Record and is itself not a system of record.
...
Vets.gov  will not disclose your personal information to third parties outside VA without your consent, except to facilitate the transaction, to act on your behalf at your request, or as authorized by law. 
...
You are always welcome to use Vets.gov without registering or logging in for certain services such as general content browsing, finding VA facilities, and completing forms to apply for healthcare (10-10EZ) and education benefits (22-1990).  Other areas of the site that use your personal information and VA records, such as prescription refills, secure messaging with your healthcare provider, and checking the status of disability claims will require an email address, password, and additional methods for identification.
