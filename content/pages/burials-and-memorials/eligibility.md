...
**Please note:** The pre-need eligibility determination is only for national cemeteries. If you want to be buried in a state or tribal Veterans cemetery, check the site you want ahead of time, since some state Veterans cemeteries require that you live in that state or have other rules around eligibility. <a href="https://www.cem.va.gov/cem/cems/listcem.asp"><span class="usa-sr-only">This will open a new website.</span>Find a state Veterans cemetery</a>.
