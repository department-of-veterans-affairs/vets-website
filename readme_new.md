...
| ------------ | ------------------ |
| check out the site | `git clone https://github.com/department-of-veterans-affairs/vets-website.git` followed by `npm install`. Run `npm install` anytime `package.json` changes. | 
