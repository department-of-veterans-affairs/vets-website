  ...
  const baseConfig = {
    ...
    plugins: [
      new webpack.DefinePlugin({
        ...
        __VIC_RATE_LIMIT_ENABLED__: (JSON.stringify(options.buildtype) === 'development' || JSON.stringify(options.buildtype) === 'staging' || process.env.VIC_RATE_LIMIT_ENABLED === 'true'),
        'process.env': {
